...
/**
 * PostApiV1PushTokenRequest Class Doc Comment
 *
 * @category Class
 * @package  WebMIRocketChatApiClientNotificationsApi
 * @author   OpenAPI Generator team
 ...
 */
class PostApiV1PushTokenRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'post_api_v1_push_token_request';
    ...
    */
     ...
     * Sets type
     *
     * @param string $type The possible values are `apn` or `gcm`.
     *
     * @return self
     */
     ...
     * Sets app_name
     *
     * @param string $app_name The name of the application to associate the token with
     *
     * @return self
     */
