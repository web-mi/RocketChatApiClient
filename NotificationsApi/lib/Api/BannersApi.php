...
class BannersApi
{
     ...
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['getApiV1BannersGetNew'] to see the possible values for this operation
     *
     * @throws \WebMI\RocketChatApiClient\NotificationsApi\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return \WebMI\RocketChatApiClient\NotificationsApi\Model\GetApiV1BannersId200Response
     * @deprecated
     */
    public function getApiV1BannersGetNew($x_auth_token, $x_user_id, $platform, $bid, string $contentType = self::contentTypes['getApiV1BannersGetNew'][0])
    {
        list($response) = $this->getApiV1BannersGetNewWithHttpInfo($x_auth_token, $x_user_id, $platform, $bid, $contentType);
        return $response;
    }
     ...
     * @throws \WebMI\RocketChatApiClient\NotificationsApi\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array of \WebMI\RocketChatApiClient\NotificationsApi\Model\GetApiV1BannersId200Response, HTTP status code, HTTP response headers (array of strings)
     * @deprecated
     */
    public function getApiV1BannersGetNewWithHttpInfo($x_auth_token, $x_user_id, $platform, $bid, string $contentType = self::contentTypes['getApiV1BannersGetNew'][0])
    {
        $request = $this->getApiV1BannersGetNewRequest($x_auth_token, $x_user_id, $platform, $bid, $contentType);
     ...
     * @deprecated
     */
    public function getApiV1BannersGetNewAsync($x_auth_token, $x_user_id, $platform, $bid, string $contentType = self::contentTypes['getApiV1BannersGetNew'][0])
    {
        return $this->getApiV1BannersGetNewAsyncWithHttpInfo($x_auth_token, $x_user_id, $platform, $bid, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @deprecated
     */
    public function getApiV1BannersGetNewAsyncWithHttpInfo($x_auth_token, $x_user_id, $platform, $bid, string $contentType = self::contentTypes['getApiV1BannersGetNew'][0])
    {
        $returnType = '\WebMI\RocketChatApiClient\NotificationsApi\Model\GetApiV1BannersId200Response';
        $request = $this->getApiV1BannersGetNewRequest($x_auth_token, $x_user_id, $platform, $bid, $contentType);
     ...
     * @deprecated
     */
    public function getApiV1BannersGetNewRequest($x_auth_token, $x_user_id, $platform, $bid, string $contentType = self::contentTypes['getApiV1BannersGetNew'][0])
    {
     ...
     * @param  string $x_auth_token The authorization token of the user. (required)
     * @param  string $x_user_id The user ID of the user. (required)
     * @param  \WebMI\RocketChatApiClient\NotificationsApi\Model\PostApiV1BannersDismissRequest|null $post_api_v1_banners_dismiss_request post_api_v1_banners_dismiss_request (optional)
     ...
     * @param  string $x_auth_token The authorization token of the user. (required)
     * @param  string $x_user_id The user ID of the user. (required)
     * @param  \WebMI\RocketChatApiClient\NotificationsApi\Model\PostApiV1BannersDismissRequest|null $post_api_v1_banners_dismiss_request (optional)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['postApiV1BannersDismiss'] to see the possible values for this operation
     *
     * @throws \WebMI\RocketChatApiClient\NotificationsApi\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
