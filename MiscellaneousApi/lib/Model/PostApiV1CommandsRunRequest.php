...
/**
 * PostApiV1CommandsRunRequest Class Doc Comment
 *
 * @category Class
 * @package  RocketChatMiscellaneousApi
 * @author   OpenAPI Generator team
 ...
 */
class PostApiV1CommandsRunRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'post_api_v1_commands_run_request';
    ...
    */
     ...
     * Sets tmid
     *
     * @param string|null $tmid The ID of the thread to run the command.
     *
     * @return self
     */
