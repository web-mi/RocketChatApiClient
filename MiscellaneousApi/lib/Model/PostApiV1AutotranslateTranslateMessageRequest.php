<?php
/**
 * PostApiV1AutotranslateTranslateMessageRequest
 *
 * PHP version 7.4
 *
 * @category Class
...
/**
 * PostApiV1AutotranslateTranslateMessageRequest Class Doc Comment
 *
 * @category Class
 * @package  RocketChatMiscellaneousApi
 * @author   OpenAPI Generator team
 ...
 */
class PostApiV1AutotranslateTranslateMessageRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'post_api_v1_autotranslate_translateMessage_request';
    ...
    */
     ...
     * Sets message_id
     *
     * @param string $message_id The message's id to be translated.
     *
     * @return self
     */
     ...
     *
     * @param string|null $target_language The target language that the message will be translated.
     *
     * @return self
     */
