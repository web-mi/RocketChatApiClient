...
class MailerApi
{
     ...
     * @param  \RocketChatMiscellaneousApi\Model\PostApiV1MailerRequest $post_api_v1_mailer_request post_api_v1_mailer_request (optional)
     ...
     * @return \RocketChatMiscellaneousApi\Model\PostApiV1AutotranslateSaveSettings200Response|\RocketChatMiscellaneousApi\Model\PostApiV1Mailer400Response|\RocketChatMiscellaneousApi\Model\GetApiV1AutotranslateGetSupportedLanguages401Response
     */
    ...
    {
        list($response) = $this->postApiV1MailerWithHttpInfo($x_auth_token, $x_user_id, $post_api_v1_mailer_request, $contentType);
        return $response;
    }

    /**
     * Operation postApiV1MailerWithHttpInfo
     *
     * Send Mailer Endpoint
     *
     * @param  string $x_auth_token The &#x60;authToken&#x60; of the authenticated user. (required)
     * @param  string $x_user_id The &#x60;userId&#x60; of the authenticated user. (required)
     * @param  \RocketChatMiscellaneousApi\Model\PostApiV1MailerRequest $post_api_v1_mailer_request (optional)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['postApiV1Mailer'] to see the possible values for this operation
     *
     * @throws \RocketChatMiscellaneousApi\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array of \RocketChatMiscellaneousApi\Model\PostApiV1AutotranslateSaveSettings200Response|\RocketChatMiscellaneousApi\Model\PostApiV1Mailer400Response|\RocketChatMiscellaneousApi\Model\GetApiV1AutotranslateGetSupportedLanguages401Response, HTTP status code, HTTP response headers (array of strings)
     */
    public function postApiV1MailerWithHttpInfo($x_auth_token, $x_user_id, $post_api_v1_mailer_request = null, string $contentType = self::contentTypes['postApiV1Mailer'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                ...
                case 400:
                    if ('\RocketChatMiscellaneousApi\Model\PostApiV1Mailer400Response' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\RocketChatMiscellaneousApi\Model\PostApiV1Mailer400Response' !== 'string') {
                            try {
                                $content = json_decode($content, false, 512, JSON_THROW_ON_ERROR);
                            } catch (\JsonException $exception) {
                                throw new ApiException(
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\RocketChatMiscellaneousApi\Model\PostApiV1Mailer400Response', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                case 401:
            ...
            switch ($e->getCode()) {
                ...
                case 400:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\RocketChatMiscellaneousApi\Model\PostApiV1Mailer400Response',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
    ...
    /**
     * Operation postApiV1MailerAsync
     *
     * Send Mailer Endpoint
     *
     * @param  string $x_auth_token The &#x60;authToken&#x60; of the authenticated user. (required)
     ...
     */
    public function postApiV1MailerAsync($x_auth_token, $x_user_id, $post_api_v1_mailer_request = null, string $contentType = self::contentTypes['postApiV1Mailer'][0])
    {
        return $this->postApiV1MailerAsyncWithHttpInfo($x_auth_token, $x_user_id, $post_api_v1_mailer_request, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation postApiV1MailerAsyncWithHttpInfo
     *
     * Send Mailer Endpoint
     *
     * @param  string $x_auth_token The &#x60;authToken&#x60; of the authenticated user. (required)
    ...
    /**
     * Create request for operation 'postApiV1Mailer'
     *
     * @param  string $x_auth_token The &#x60;authToken&#x60; of the authenticated user. (required)
     * @param  string $x_user_id The &#x60;userId&#x60; of the authenticated user. (required)
     * @param  \RocketChatMiscellaneousApi\Model\PostApiV1MailerRequest $post_api_v1_mailer_request (optional)
     ...
     */
    public function postApiV1MailerRequest($x_auth_token, $x_user_id, $post_api_v1_mailer_request = null, string $contentType = self::contentTypes['postApiV1Mailer'][0])
    {

        // verify the required parameter 'x_auth_token' is set
        if ($x_auth_token === null || (is_array($x_auth_token) && count($x_auth_token) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $x_auth_token when calling postApiV1Mailer'
            );
        }
        ...
        if ($x_user_id === null || (is_array($x_user_id) && count($x_user_id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $x_user_id when calling postApiV1Mailer'
            );
        }



        $resourcePath = '/api/v1/mailer';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
        ...
        // for model (json/xml)
        if (isset($post_api_v1_mailer_request)) {
            if (stripos($headers['Content-Type'], 'application/json') !== false) {
                # if Content-Type contains "application/json", json_encode the body
                $httpBody = \GuzzleHttp\Utils::jsonEncode(ObjectSerializer::sanitizeForSerialization($post_api_v1_mailer_request));
            } else {
                $httpBody = $post_api_v1_mailer_request;
            }
    ...
    /**
     * Operation postApiV1MailerUnsubscribe
     *
     * Mailer Unsubscribe Endpoint
     *
     * @param  string $x_auth_token The &#x60;authToken&#x60; of the authenticated user. (required)
     * @param  string $x_user_id The &#x60;userId&#x60; of the authenticated user. (required)
     * @param  \RocketChatMiscellaneousApi\Model\PostApiV1MailerUnsubscribeRequest $post_api_v1_mailer_unsubscribe_request post_api_v1_mailer_unsubscribe_request (optional)
    ...
    {
        list($response) = $this->postApiV1MailerUnsubscribeWithHttpInfo($x_auth_token, $x_user_id, $post_api_v1_mailer_unsubscribe_request, $contentType);
        return $response;
    }

    /**
     * Operation postApiV1MailerUnsubscribeWithHttpInfo
     *
     * Mailer Unsubscribe Endpoint
     *
     * @param  string $x_auth_token The &#x60;authToken&#x60; of the authenticated user. (required)
     * @param  string $x_user_id The &#x60;userId&#x60; of the authenticated user. (required)
     * @param  \RocketChatMiscellaneousApi\Model\PostApiV1MailerUnsubscribeRequest $post_api_v1_mailer_unsubscribe_request (optional)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['postApiV1MailerUnsubscribe'] to see the possible values for this operation
     *
     * @throws \RocketChatMiscellaneousApi\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
    ...
    /**
     * Operation postApiV1MailerUnsubscribeAsync
     *
     * Mailer Unsubscribe Endpoint
     *
     * @param  string $x_auth_token The &#x60;authToken&#x60; of the authenticated user. (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function postApiV1MailerUnsubscribeAsync($x_auth_token, $x_user_id, $post_api_v1_mailer_unsubscribe_request = null, string $contentType = self::contentTypes['postApiV1MailerUnsubscribe'][0])
    {
        return $this->postApiV1MailerUnsubscribeAsyncWithHttpInfo($x_auth_token, $x_user_id, $post_api_v1_mailer_unsubscribe_request, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation postApiV1MailerUnsubscribeAsyncWithHttpInfo
     *
     * Mailer Unsubscribe Endpoint
     *
     * @param  string $x_auth_token The &#x60;authToken&#x60; of the authenticated user. (required)
    ...
    /**
     * Create request for operation 'postApiV1MailerUnsubscribe'
     *
     * @param  string $x_auth_token The &#x60;authToken&#x60; of the authenticated user. (required)
     * @param  string $x_user_id The &#x60;userId&#x60; of the authenticated user. (required)
     * @param  \RocketChatMiscellaneousApi\Model\PostApiV1MailerUnsubscribeRequest $post_api_v1_mailer_unsubscribe_request (optional)
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function postApiV1MailerUnsubscribeRequest($x_auth_token, $x_user_id, $post_api_v1_mailer_unsubscribe_request = null, string $contentType = self::contentTypes['postApiV1MailerUnsubscribe'][0])
    {

        // verify the required parameter 'x_auth_token' is set
        if ($x_auth_token === null || (is_array($x_auth_token) && count($x_auth_token) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $x_auth_token when calling postApiV1MailerUnsubscribe'
            );
        }
        ...
        if ($x_user_id === null || (is_array($x_user_id) && count($x_user_id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $x_user_id when calling postApiV1MailerUnsubscribe'
            );
        }



        $resourcePath = '/api/v1/mailer.unsubscribe';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
        ...
        // for model (json/xml)
        if (isset($post_api_v1_mailer_unsubscribe_request)) {
            if (stripos($headers['Content-Type'], 'application/json') !== false) {
                # if Content-Type contains "application/json", json_encode the body
                $httpBody = \GuzzleHttp\Utils::jsonEncode(ObjectSerializer::sanitizeForSerialization($post_api_v1_mailer_unsubscribe_request));
            } else {
                $httpBody = $post_api_v1_mailer_unsubscribe_request;
            }
        } elseif (count($formParams) > 0) {
            if ($multipart) {
                $multipartContents = [];
