...
class MailerApi
{
     ...
     * @param  \WebMI\RocketChatApiClient\MiscellaneousApi\Model\PostApiV1MailerRequest|null $post_api_v1_mailer_request post_api_v1_mailer_request (optional)
     ...
     * @param  string $x_auth_token The &#x60;authToken&#x60; of the authenticated user. (required)
     * @param  string $x_user_id The &#x60;userId&#x60; of the authenticated user. (required)
     * @param  \WebMI\RocketChatApiClient\MiscellaneousApi\Model\PostApiV1MailerRequest|null $post_api_v1_mailer_request (optional)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['postApiV1Mailer'] to see the possible values for this operation
     *
     * @throws \WebMI\RocketChatApiClient\MiscellaneousApi\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     ...
     * @param  string $x_auth_token The &#x60;authToken&#x60; of the authenticated user. (required)
     * @param  string $x_user_id The &#x60;userId&#x60; of the authenticated user. (required)
     * @param  \WebMI\RocketChatApiClient\MiscellaneousApi\Model\PostApiV1MailerUnsubscribeRequest|null $post_api_v1_mailer_unsubscribe_request post_api_v1_mailer_unsubscribe_request (optional)
     ...
     * @param  string $x_auth_token The &#x60;authToken&#x60; of the authenticated user. (required)
     * @param  string $x_user_id The &#x60;userId&#x60; of the authenticated user. (required)
     * @param  \WebMI\RocketChatApiClient\MiscellaneousApi\Model\PostApiV1MailerUnsubscribeRequest|null $post_api_v1_mailer_unsubscribe_request (optional)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['postApiV1MailerUnsubscribe'] to see the possible values for this operation
     *
     * @throws \WebMI\RocketChatApiClient\MiscellaneousApi\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
