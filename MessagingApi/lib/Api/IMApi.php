...
class IMApi
{
     ...
     * @param  string|null $user_id The user ID to provide counters for. (optional)
     ...
     * @param  string|null $room_id The roomId of the DM. It is required if &#x60;username&#x60; is not provided. (optional)
     * @param  string|null $username The username of the user in the DM. It is required if &#x60;roomId&#x60; is not provided. (optional)
     ...
     * @param  int|null $offset Number of items to \&quot;skip\&quot; in the query, i.e. requests return count items, skipping the first offset items. (optional)
     * @param  int|null $count The number of items to return. (optional)
     * @param  string|null $latest The end of time range of messages to retrieve. (optional)
     * @param  string|null $oldest The start of the time range of messages to retrieve. (optional)
     * @param  string|null $inclusive Whether messages which land on the &#x60;latest&#x60; and &#x60;oldest&#x60; dates should be included. (optional)
     * @param  bool|null $unreads Whether the number of unread messages should be included. (optional)
     ...
     * @param  int|null $count The number of items to return. (optional)
     * @param  mixed|null $sort List of fields to order by, and in which direction. This is a JSON object, with properties listed in desired order, with values of 1 for ascending, or -1 for descending. For example, &#x60;{ \&quot;value\&quot;: -1, \&quot;_id\&quot;: 1 }&#x60; (optional)
     * @param  string|null $room_id The room ID of the DM. It is required if &#x60;username&#x60; is not provided. (optional)
     * @param  string|null $username The username of the user in the DM. It is required if &#x60;roomId&#x60; is not provided. (optional)
     ...
     */
    public function getApiV1ImMessages($x_auth_token, $x_user_id, $offset = null, $count = null, $sort = null, $fields = null, $room_id = null, $username = null, $mention_ids = null, $starred_ids = null, $pinned = null, string $contentType = self::contentTypes['getApiV1ImMessages'][0])
    {
        list($response) = $this->getApiV1ImMessagesWithHttpInfo($x_auth_token, $x_user_id, $offset, $count, $sort, $fields, $room_id, $username, $mention_ids, $starred_ids, $pinned, $contentType);
        return $response;
    }
     ...
     */
    public function getApiV1ImMessagesWithHttpInfo($x_auth_token, $x_user_id, $offset = null, $count = null, $sort = null, $fields = null, $room_id = null, $username = null, $mention_ids = null, $starred_ids = null, $pinned = null, string $contentType = self::contentTypes['getApiV1ImMessages'][0])
    {
        $request = $this->getApiV1ImMessagesRequest($x_auth_token, $x_user_id, $offset, $count, $sort, $fields, $room_id, $username, $mention_ids, $starred_ids, $pinned, $contentType);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getApiV1ImMessagesAsync($x_auth_token, $x_user_id, $offset = null, $count = null, $sort = null, $fields = null, $room_id = null, $username = null, $mention_ids = null, $starred_ids = null, $pinned = null, string $contentType = self::contentTypes['getApiV1ImMessages'][0])
    {
        return $this->getApiV1ImMessagesAsyncWithHttpInfo($x_auth_token, $x_user_id, $offset, $count, $sort, $fields, $room_id, $username, $mention_ids, $starred_ids, $pinned, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getApiV1ImMessagesAsyncWithHttpInfo($x_auth_token, $x_user_id, $offset = null, $count = null, $sort = null, $fields = null, $room_id = null, $username = null, $mention_ids = null, $starred_ids = null, $pinned = null, string $contentType = self::contentTypes['getApiV1ImMessages'][0])
    {
        $returnType = '\WebMI\RocketChatApiClient\MessagingApi\Model\GetApiV1ImMessages200Response';
        $request = $this->getApiV1ImMessagesRequest($x_auth_token, $x_user_id, $offset, $count, $sort, $fields, $room_id, $username, $mention_ids, $starred_ids, $pinned, $contentType);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function getApiV1ImMessagesRequest($x_auth_token, $x_user_id, $offset = null, $count = null, $sort = null, $fields = null, $room_id = null, $username = null, $mention_ids = null, $starred_ids = null, $pinned = null, string $contentType = self::contentTypes['getApiV1ImMessages'][0])
    {
     ...
     * @param  string $x_auth_token The &#x60;authToken&#x60; of the authenticated user. (required)
     * @param  string $x_user_id The &#x60;userId&#x60; of the authenticated user. (required)
     * @param  \WebMI\RocketChatApiClient\MessagingApi\Model\PostApiV1ImCloseRequest|null $post_api_v1_im_close_request post_api_v1_im_close_request (optional)
     ...
     * @param  string $x_auth_token The &#x60;authToken&#x60; of the authenticated user. (required)
     * @param  string $x_user_id The &#x60;userId&#x60; of the authenticated user. (required)
     * @param  \WebMI\RocketChatApiClient\MessagingApi\Model\PostApiV1ImCloseRequest|null $post_api_v1_im_close_request (optional)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['postApiV1ImClose'] to see the possible values for this operation
     *
     * @throws \WebMI\RocketChatApiClient\MessagingApi\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     ...
     * @param  string $x_auth_token The &#x60;authToken&#x60; of the authenticated user. (required)
     * @param  string $x_user_id The &#x60;userId&#x60; of the authenticated user. (required)
     * @param  \WebMI\RocketChatApiClient\MessagingApi\Model\PostApiV1ImCreateRequest|null $post_api_v1_im_create_request post_api_v1_im_create_request (optional)
     ...
     * @param  string $x_auth_token The &#x60;authToken&#x60; of the authenticated user. (required)
     * @param  string $x_user_id The &#x60;userId&#x60; of the authenticated user. (required)
     * @param  \WebMI\RocketChatApiClient\MessagingApi\Model\PostApiV1ImCreateRequest|null $post_api_v1_im_create_request (optional)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['postApiV1ImCreate'] to see the possible values for this operation
     *
     * @throws \WebMI\RocketChatApiClient\MessagingApi\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     ...
     * @param  string $x_auth_token The &#x60;authToken&#x60; of the authenticated user. (required)
     * @param  string $x_user_id The &#x60;userId&#x60; of the authenticated user. (required)
     * @param  \WebMI\RocketChatApiClient\MessagingApi\Model\PostApiV1ImDeleteRequest|null $post_api_v1_im_delete_request post_api_v1_im_delete_request (optional)
     ...
     * @param  string $x_auth_token The &#x60;authToken&#x60; of the authenticated user. (required)
     * @param  string $x_user_id The &#x60;userId&#x60; of the authenticated user. (required)
     * @param  \WebMI\RocketChatApiClient\MessagingApi\Model\PostApiV1ImDeleteRequest|null $post_api_v1_im_delete_request (optional)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['postApiV1ImDelete'] to see the possible values for this operation
     *
     * @throws \WebMI\RocketChatApiClient\MessagingApi\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     ...
     * @param  string $x_auth_token The &#x60;authToken&#x60; of the authenticated user. (required)
     * @param  string $x_user_id The &#x60;userId&#x60; of the authenticated user. (required)
     * @param  \WebMI\RocketChatApiClient\MessagingApi\Model\PostApiV1ImSetTopicRequest|null $post_api_v1_im_set_topic_request post_api_v1_im_set_topic_request (optional)
     ...
     * @param  string $x_auth_token The &#x60;authToken&#x60; of the authenticated user. (required)
     * @param  string $x_user_id The &#x60;userId&#x60; of the authenticated user. (required)
     * @param  \WebMI\RocketChatApiClient\MessagingApi\Model\PostApiV1ImSetTopicRequest|null $post_api_v1_im_set_topic_request (optional)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['postApiV1ImSetTopic'] to see the possible values for this operation
     *
     * @throws \WebMI\RocketChatApiClient\MessagingApi\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
