<?php
/**
 * PostApiV1ChatReportMessageRequest
 *
 * PHP version 7.4
 *
 * @category Class
...
/**
 * PostApiV1ChatReportMessageRequest Class Doc Comment
 *
 * @category Class
 * @package  WebMI\RocketChatApiClient\MessagingApi
 * @author   OpenAPI Generator team
 ...
 */
class PostApiV1ChatReportMessageRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'post_api_v1_chat_reportMessage_request';
    ...
    */
     ...
     * Sets message_id
     *
     * @param string $message_id The message ID to report.
     *
     * @return self
     */
     ...
     * Sets description
     *
     * @param string $description The description of report.
     *
     * @return self
     */
