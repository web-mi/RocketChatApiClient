<?php
/**
 * PostApiV1ChatUnPinMessageRequest
 *
 * PHP version 7.4
 *
 * @category Class
...
/**
 * PostApiV1ChatUnPinMessageRequest Class Doc Comment
 *
 * @category Class
 * @package  WebMI\RocketChatApiClient\MessagingApi
 * @author   OpenAPI Generator team
 ...
 */
class PostApiV1ChatUnPinMessageRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'post_api_v1_chat_unPinMessage_request';
    ...
    */
     ...
     * Sets message_id
     *
     * @param string $message_id The message ID you want to to unpin.
     *
     * @return self
     */
