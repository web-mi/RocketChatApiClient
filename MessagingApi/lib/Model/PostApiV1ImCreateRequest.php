...
/**
 * PostApiV1ImCreateRequest Class Doc Comment
 *
 * @category Class
 * @package  RocketChatMessagingApi
 * @author   OpenAPI Generator team
 ...
 */
class PostApiV1ImCreateRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'post_api_v1_im_create_request';
    ...
    */
     ...
     * Sets username
     *
     * @param string|null $username The username to open a direct message session. This parameter is required if the `usernames` parameter is not provided
     *
     * @return self
     */
     ...
     * Sets usernames
     *
     * @param string|null $usernames List of usernames to open a multiple direct message session. This parameter is required if the `username` parameter is not provided
     *
     * @return self
     */
     ...
     * Sets exclude_self
     *
     * @param bool|null $exclude_self Creates the direct message session excluding the current authenticated user. The session will only be opened if the current user has the `view-room-administration` permission
     *
     * @return self
     */
