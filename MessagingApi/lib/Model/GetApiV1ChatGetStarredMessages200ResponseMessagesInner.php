 ...
 */
class GetApiV1ChatGetStarredMessages200ResponseMessagesInner implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'get_api_v1_chat_getStarredMessages_200_response_messages_inner';
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('dcount', $data ?? [], null);
        $this->setIfExists('dlm', $data ?? [], null);
