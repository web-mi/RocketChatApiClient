<?php
/**
 * PostApiV1ChatUnStarMessageRequest
 *
 * PHP version 7.4
 *
 * @category Class
...
/**
 * PostApiV1ChatUnStarMessageRequest Class Doc Comment
 *
 * @category Class
 * @package  WebMIRocketChatApiClientMessagingApi
 * @author   OpenAPI Generator team
 ...
 */
class PostApiV1ChatUnStarMessageRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'post_api_v1_chat_unStarMessage_request';
    ...
    */
     ...
     * Sets message_id
     *
     * @param string $message_id The message ID to unstar.
     *
     * @return self
     */
