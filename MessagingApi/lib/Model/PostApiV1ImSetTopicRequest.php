...
/**
 * PostApiV1ImSetTopicRequest Class Doc Comment
 *
 * @category Class
 * @package  WebMI\RocketChatApiClient\MessagingApi
 * @author   OpenAPI Generator team
 ...
 */
class PostApiV1ImSetTopicRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'post_api_v1_im_setTopic_request';
    ...
    */
     ...
     * Sets room_id
     *
     * @param string $room_id The room ID of the direct message.
     *
     * @return self
     */
     ...
     * Sets topic
     *
     * @param string $topic The topic of the DM.
     *
     * @return self
     */
