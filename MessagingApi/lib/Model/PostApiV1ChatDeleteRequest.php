...
/**
 * PostApiV1ChatDeleteRequest Class Doc Comment
 *
 * @category Class
 * @package  WebMI\RocketChatApiClient\MessagingApi
 * @author   OpenAPI Generator team
 ...
 */
class PostApiV1ChatDeleteRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'post_api_v1_chat_delete_request';
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('as_user', $data ?? [], null);
    }
    ...
    */
     ...
     * Sets as_user
     *
     * @param bool|null $as_user Should the message be deleted as the user who sent it? It is `false` by default.
     *
     * @return self
     */
    public function setAsUser($as_user)
    {
        ...
        $this->container['as_user'] = $as_user;
