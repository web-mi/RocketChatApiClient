<?php
/**
 * PostApiV1ChatUnfollowMessageRequest
 *
 * PHP version 7.4
 *
 * @category Class
...
/**
 * PostApiV1ChatUnfollowMessageRequest Class Doc Comment
 *
 * @category Class
 * @package  WebMIRocketChatApiClientMessagingApi
 * @author   OpenAPI Generator team
 ...
 */
class PostApiV1ChatUnfollowMessageRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'post_api_v1_chat_unfollowMessage_request';
    ...
    */
     ...
     * Sets mid
     *
     * @param string $mid The message ID to unfollow.
     *
     * @return self
     */
