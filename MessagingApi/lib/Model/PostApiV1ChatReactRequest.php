...
/**
 * PostApiV1ChatReactRequest Class Doc Comment
 *
 * @category Class
 * @package  WebMIRocketChatApiClientMessagingApi
 * @author   OpenAPI Generator team
 ...
 */
class PostApiV1ChatReactRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'post_api_v1_chat_react_request';
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('should_react', $data ?? [], null);
    }
    ...
    */
     ...
     * Sets message_id
     *
     * @param string $message_id The message ID to react to.
     *
     * @return self
     */
     ...
     * Sets should_react
     *
     * @param bool|null $should_react Boolean to specify if the reaction should be added or removed.
     *
     * @return self
     */
    public function setShouldReact($should_react)
    {
        ...
        $this->container['should_react'] = $should_react;
