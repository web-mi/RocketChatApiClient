<?php
/**
 * PostApiV1ChatFollowMessageRequest
 *
 * PHP version 7.4
 *
 * @category Class
...
/**
 * PostApiV1ChatFollowMessageRequest Class Doc Comment
 *
 * @category Class
 * @package  RocketChatMessagingApi
 * @author   OpenAPI Generator team
 ...
 */
class PostApiV1ChatFollowMessageRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'post_api_v1_chat_followMessage_request';
    ...
    */
     ...
     * Sets mid
     *
     * @param string $mid The message ID to follow.
     *
     * @return self
     */
