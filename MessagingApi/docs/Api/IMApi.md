...
```php
getApiV1ImCounters($x_auth_token, $x_user_id, $room_id, $user_id): \RocketChatMessagingApi\Model\GetApiV1ImCounters200Response
```
...
$apiInstance = new RocketChatMessagingApi\Api\IMApi(
...
[**\RocketChatMessagingApi\Model\GetApiV1ImCounters200Response**](../Model/GetApiV1ImCounters200Response.md)
...
```php
getApiV1ImFiles($x_auth_token, $x_user_id, $offset, $count, $sort, $query, $fields, $room_id, $username): \RocketChatMessagingApi\Model\GetApiV1ImFiles200Response
```
...
[**\RocketChatMessagingApi\Model\GetApiV1ImFiles200Response**](../Model/GetApiV1ImFiles200Response.md)
...
```php
getApiV1ImHistory($x_auth_token, $x_user_id, $room_id, $offset, $count, $latest, $oldest, $inclusive, $unreads): \RocketChatMessagingApi\Model\GetApiV1ImHistory200Response
```
...
[**\RocketChatMessagingApi\Model\GetApiV1ImHistory200Response**](../Model/GetApiV1ImHistory200Response.md)
...
```php
getApiV1ImList($x_auth_token, $x_user_id, $offset, $count, $sort): \RocketChatMessagingApi\Model\GetApiV1ImList200Response
```
...
[**\RocketChatMessagingApi\Model\GetApiV1ImList200Response**](../Model/GetApiV1ImList200Response.md)
...
```php
getApiV1ImListEveryone($x_auth_token, $x_user_id, $offset, $count, $sort, $query, $fields): \RocketChatMessagingApi\Model\GetApiV1ImListEveryone200Response
```
...
[**\RocketChatMessagingApi\Model\GetApiV1ImListEveryone200Response**](../Model/GetApiV1ImListEveryone200Response.md)
...
```php
getApiV1ImMembers($x_auth_token, $x_user_id, $offset, $count, $sort, $room_id, $username): \RocketChatMessagingApi\Model\GetApiV1ImMembers200Response
```
...
[**\RocketChatMessagingApi\Model\GetApiV1ImMembers200Response**](../Model/GetApiV1ImMembers200Response.md)
...
```php
getApiV1ImMessages($x_auth_token, $x_user_id, $offset, $count, $sort, $query, $fields, $room_id, $username): \RocketChatMessagingApi\Model\GetApiV1ImMessages200Response
```
...
[**\RocketChatMessagingApi\Model\GetApiV1ImMessages200Response**](../Model/GetApiV1ImMessages200Response.md)
...
```php
getApiV1ImMessagesOthers($x_auth_token, $x_user_id, $room_id, $offset, $count, $sort, $query, $fields): \RocketChatMessagingApi\Model\GetApiV1ImHistory200Response
```
...
```php
postApiV1ImClose($x_auth_token, $x_user_id, $post_api_v1_im_close_request): \RocketChatMessagingApi\Model\PostApiV1ChatReact200Response
```
...
$x_auth_token = RScctEHSmLGZGywfIhWyRpyofhKOiMoUIpimhvheU3f; // string | The `authToken` of the authenticated user.
$x_user_id = rbAXPnMktTFbNpwtJ; // string | The `userId` of the authenticated user.
$post_api_v1_im_close_request = {"roomId":"ByehQjC44FwMeiLbX"}; // \RocketChatMessagingApi\Model\PostApiV1ImCloseRequest
...
| **x_auth_token** | **string**| The &#x60;authToken&#x60; of the authenticated user. | |
| **x_user_id** | **string**| The &#x60;userId&#x60; of the authenticated user. | |
| **post_api_v1_im_close_request** | [**\RocketChatMessagingApi\Model\PostApiV1ImCloseRequest**](../Model/PostApiV1ImCloseRequest.md)|  | [optional] |
...
```php
postApiV1ImCreate($x_auth_token, $x_user_id, $post_api_v1_im_create_request): \RocketChatMessagingApi\Model\PostApiV1ImCreate200Response
```
...
$x_auth_token = RScctEHSmLGZGywfIhWyRpyofhKOiMoUIpimhvheU3f; // string | The `authToken` of the authenticated user.
$x_user_id = rbAXPnMktTFbNpwtJ; // string | The `userId` of the authenticated user.
$post_api_v1_im_create_request = {"username":"kim.dok","excludeSelf":true}; // \RocketChatMessagingApi\Model\PostApiV1ImCreateRequest
...
| **x_auth_token** | **string**| The &#x60;authToken&#x60; of the authenticated user. | |
| **x_user_id** | **string**| The &#x60;userId&#x60; of the authenticated user. | |
| **post_api_v1_im_create_request** | [**\RocketChatMessagingApi\Model\PostApiV1ImCreateRequest**](../Model/PostApiV1ImCreateRequest.md)|  | [optional] |

### Return type

[**\RocketChatMessagingApi\Model\PostApiV1ImCreate200Response**](../Model/PostApiV1ImCreate200Response.md)
...
```php
postApiV1ImDelete($x_auth_token, $x_user_id, $post_api_v1_im_delete_request): \RocketChatMessagingApi\Model\PostApiV1ChatReact200Response
```
...
$x_auth_token = RScctEHSmLGZGywfIhWyRpyofhKOiMoUIpimhvheU3f; // string | The `authToken` of the authenticated user.
$x_user_id = rbAXPnMktTFbNpwtJ; // string | The `userId` of the authenticated user.
$post_api_v1_im_delete_request = {"roomId":"hdy9972092873h8s7s0"}; // \RocketChatMessagingApi\Model\PostApiV1ImDeleteRequest
...
| **x_auth_token** | **string**| The &#x60;authToken&#x60; of the authenticated user. | |
| **x_user_id** | **string**| The &#x60;userId&#x60; of the authenticated user. | |
| **post_api_v1_im_delete_request** | [**\RocketChatMessagingApi\Model\PostApiV1ImDeleteRequest**](../Model/PostApiV1ImDeleteRequest.md)|  | [optional] |
...
```php
postApiV1ImOpen($x_auth_token, $x_user_id, $post_api_v1_im_close_request): \RocketChatMessagingApi\Model\PostApiV1ChatReact200Response
```
...
$x_auth_token = RScctEHSmLGZGywfIhWyRpyofhKOiMoUIpimhvheU3f; // string | The `authToken` of the authenticated user.
$x_user_id = rbAXPnMktTFbNpwtJ; // string | The `userId` of the authenticated user.
$post_api_v1_im_close_request = {"roomId":"5fRTXMt7DMJbpPJfhrbAXPnMktTFbNpwtJ"}; // \RocketChatMessagingApi\Model\PostApiV1ImCloseRequest
...
```php
postApiV1ImSetTopic($x_auth_token, $x_user_id, $post_api_v1_im_set_topic_request): \RocketChatMessagingApi\Model\PostApiV1ImSetTopic200Response
```
...
$x_auth_token = RScctEHSmLGZGywfIhWyRpyofhKOiMoUIpimhvheU3f; // string | The `authToken` of the authenticated user.
$x_user_id = rbAXPnMktTFbNpwtJ; // string | The `userId` of the authenticated user.
$post_api_v1_im_set_topic_request = {"roomId":"ByehQjC44FwMeiLbX","topic":"Discuss all of the testing"}; // \RocketChatMessagingApi\Model\PostApiV1ImSetTopicRequest
...
| **x_auth_token** | **string**| The &#x60;authToken&#x60; of the authenticated user. | |
| **x_user_id** | **string**| The &#x60;userId&#x60; of the authenticated user. | |
| **post_api_v1_im_set_topic_request** | [**\RocketChatMessagingApi\Model\PostApiV1ImSetTopicRequest**](../Model/PostApiV1ImSetTopicRequest.md)|  | [optional] |

### Return type

[**\RocketChatMessagingApi\Model\PostApiV1ImSetTopic200Response**](../Model/PostApiV1ImSetTopic200Response.md)
