...
class LivechatUnitsApi
{
     ...
     * @param  string $x_auth_token The &#x60;authToken&#x60; of the authenticated user. (required)
     * @param  string $x_user_id The &#x60;userId&#x60; of the authenticated user. (required)
     * @param  string|null $text Enter some text to filter the results. (optional)
     ...
     * @param  string $x_auth_token The &#x60;authToken&#x60; of the authenticated user. (required)
     * @param  string $x_user_id The &#x60;userId&#x60; of the authenticated user. (required)
     * @param  string|null $unit_id The unit ID. (optional)
     ...
     * @param  int|null $offset Number of items to \&quot;skip\&quot; in the query, i.e. requests return count items, skipping the first offset items. (optional)
     * @param  int|null $count The number of items to return. (optional)
     * @param  string|null $text Filter the result with the text. (optional)
     * @param  bool|null $only_my_departments Whether you want the result for the departments that you are part of. (optional)
     ...
     * @param  string $x_auth_token The &#x60;authToken&#x60; of the authenticated user. (required)
     * @param  string $x_user_id The &#x60;userId&#x60; of the authenticated user. (required)
     * @param  \WebMI\RocketChatApiClient\OmnichannelApi\Model\PostApiV1LivechatUnitsRequest|null $post_api_v1_livechat_units_request post_api_v1_livechat_units_request (optional)
     ...
     * @param  string $x_auth_token The &#x60;authToken&#x60; of the authenticated user. (required)
     * @param  string $x_user_id The &#x60;userId&#x60; of the authenticated user. (required)
     * @param  \WebMI\RocketChatApiClient\OmnichannelApi\Model\PostApiV1LivechatUnitsRequest|null $post_api_v1_livechat_units_request (optional)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['postApiV1LivechatUnits'] to see the possible values for this operation
     *
     * @throws \WebMI\RocketChatApiClient\OmnichannelApi\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     ...
     * @param  string $x_auth_token The &#x60;authToken&#x60; of the authenticated user. (required)
     * @param  string $x_user_id The &#x60;userId&#x60; of the authenticated user. (required)
     * @param  \WebMI\RocketChatApiClient\OmnichannelApi\Model\PostApiV1LivechatUnitsIdRequest|null $post_api_v1_livechat_units_id_request post_api_v1_livechat_units_id_request (optional)
     ...
     * @param  string $x_auth_token The &#x60;authToken&#x60; of the authenticated user. (required)
     * @param  string $x_user_id The &#x60;userId&#x60; of the authenticated user. (required)
     * @param  \WebMI\RocketChatApiClient\OmnichannelApi\Model\PostApiV1LivechatUnitsIdRequest|null $post_api_v1_livechat_units_id_request (optional)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['postApiV1LivechatUnitsId'] to see the possible values for this operation
     *
     * @throws \WebMI\RocketChatApiClient\OmnichannelApi\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
