 ...
 */
class PostApiV1LivechatTriggersRequestActionsInner implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'post_api_v1_livechat_triggers_request_actions_inner';
    ...
    */
     ...
     * Sets name
     *
     * @param string|null $name The name of the trigger action that takes place. The possible values are:  * `send-message`: A message is sent to the visitor.  * `use-external-service`: An external service is used for the trigger action.
     *
     * @return self
     */
