<?php
/**
 * PostApiV1LivechatDepartmentIdAgentsRequestUpsertInner
 *
 * PHP version 7.4
 *
 * @category Class
...
/**
 * PostApiV1LivechatDepartmentIdAgentsRequestUpsertInner Class Doc Comment
 *
 * @category Class
 * @package  WebMI\RocketChatApiClient\OmnichannelApi
 * @author   OpenAPI Generator team
 ...
 */
class PostApiV1LivechatDepartmentIdAgentsRequestUpsertInner implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'post_api_v1_livechat_department__id_agents_request_upsert_inner';
    ...
    */
     ...
     * Sets username
     *
     * @param string $username The user name of the agent.
     *
     * @return self
     */
