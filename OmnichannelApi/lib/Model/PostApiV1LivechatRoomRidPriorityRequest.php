<?php
/**
 * PostApiV1LivechatRoomRidPriorityRequest
 *
 * PHP version 7.4
 *
 * @category Class
...
/**
 * PostApiV1LivechatRoomRidPriorityRequest Class Doc Comment
 *
 * @category Class
 * @package  WebMI\RocketChatApiClient\OmnichannelApi
 * @author   OpenAPI Generator team
 ...
 */
class PostApiV1LivechatRoomRidPriorityRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'post_api_v1_livechat_room_rid_priority_request';
    ...
    */
     ...
     * Sets priority_id
     *
     * @param string $priority_id The ID of the priority to set.
     *
     * @return self
     */
