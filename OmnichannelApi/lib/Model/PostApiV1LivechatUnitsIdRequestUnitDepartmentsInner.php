<?php
/**
 * PostApiV1LivechatUnitsIdRequestUnitDepartmentsInner
 *
 * PHP version 7.4
 *
 * @category Class
...
/**
 * PostApiV1LivechatUnitsIdRequestUnitDepartmentsInner Class Doc Comment
 *
 * @category Class
 * @package  WebMI\RocketChatApiClient\OmnichannelApi
 * @author   OpenAPI Generator team
 ...
 */
class PostApiV1LivechatUnitsIdRequestUnitDepartmentsInner implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'post_api_v1_livechat_units_id_request_unitDepartments_inner';
    ...
    */
     ...
     * Sets department_id
     *
     * @param string $department_id The department ID that you want to add to the unit.
     *
     * @return self
     */
