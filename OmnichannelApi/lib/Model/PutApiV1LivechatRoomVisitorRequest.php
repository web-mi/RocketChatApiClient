<?php
/**
 * PutApiV1LivechatRoomVisitorRequest
 *
 * PHP version 7.4
 *
 * @category Class
...
/**
 * PutApiV1LivechatRoomVisitorRequest Class Doc Comment
 *
 * @category Class
 * @package  WebMIRocketChatApiClientOmnichannelApi
 * @author   OpenAPI Generator team
 ...
 */
class PutApiV1LivechatRoomVisitorRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'put_api_v1_livechat_room_visitor_request';
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('old_visitor_id', $data ?? [], null);
        $this->setIfExists('new_visitor_id', $data ?? [], null);
    }
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['old_visitor_id'] === null) {
            $invalidProperties[] = "'old_visitor_id' can't be null";
        }
        if ($this->container['new_visitor_id'] === null) {
            $invalidProperties[] = "'new_visitor_id' can't be null";
        }
     ...
     * Sets old_visitor_id
     *
     * @param string $old_visitor_id The visitor's old id.
     *
     * @return self
     */
    public function setOldVisitorId($old_visitor_id)
    {
        ...
        $this->container['old_visitor_id'] = $old_visitor_id;
     ...
     * Sets new_visitor_id
     *
     * @param string $new_visitor_id The visitor's new id.
     *
     * @return self
     */
    public function setNewVisitorId($new_visitor_id)
    {
        ...
        $this->container['new_visitor_id'] = $new_visitor_id;
