 ...
 */
class PostApiV1LivechatRoomSurveyRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'post_api_v1_livechat_room_survey_request';
    ...
    */
     ...
     * Sets data
     *
     * @param \WebMI\RocketChatApiClient\OmnichannelApi\Model\GetApiV1LivechatAnalyticsAgentOverview200ResponseDataInner[] $data An array of object with `name` and `value` to provide feedback.
     *
     * @return self
     */
