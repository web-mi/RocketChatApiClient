<?php
/**
 * PostApiV1LivechatRoomForwardRequest
 *
 * PHP version 7.4
 *
 * @category Class
...
/**
 * PostApiV1LivechatRoomForwardRequest Class Doc Comment
 *
 * @category Class
 * @package  RocketChatOmnichannelApi
 * @author   OpenAPI Generator team
 ...
 */
class PostApiV1LivechatRoomForwardRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'post_api_v1_livechat_room_forward_request';
    ...
    */
     ...
     * Sets user_id
     *
     * @param string|null $user_id The new agent ID.
     *
     * @return self
     */
     ...
     * Sets department_id
     *
     * @param string|null $department_id The new department ID.
     *
     * @return self
     */
