 ...
 */
class PostApiV1LivechatMessageRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'post_api_v1_livechat_message_request';
    ...
    */
     ...
     * Sets msg
     *
     * @param string $msg The message to send to the visitor.
     *
     * @return self
     */
     ...
     * Sets _id
     *
     * @param string|null $_id If you do not enter any value, a message ID is automatically generated. If you want to override the message ID in the database with your own, enter a random unique string.
     *
     * @return self
     */
