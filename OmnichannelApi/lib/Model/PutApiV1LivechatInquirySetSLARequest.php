<?php
/**
 * PutApiV1LivechatInquirySetSLARequest
 *
 * PHP version 7.4
 *
 * @category Class
...
/**
 * PutApiV1LivechatInquirySetSLARequest Class Doc Comment
 *
 * @category Class
 * @package  RocketChatOmnichannelApi
 * @author   OpenAPI Generator team
 ...
 */
class PutApiV1LivechatInquirySetSLARequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'put_api_v1_livechat_inquiry_setSLA_request';
    ...
    */
     ...
     * Sets sla
     *
     * @param string $sla Name or ID of the SLA policy.
     *
     * @return self
     */
