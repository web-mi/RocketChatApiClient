# RocketChatOmnichannelApi\SLAPoliciesApi
...
```php
deleteApiV1LivechatSlaSlaId($x_auth_token, $x_user_id, $sla_id): \RocketChatOmnichannelApi\Model\DeleteApiV1LivechatUsersTypeId200Response
```
...
$apiInstance = new RocketChatOmnichannelApi\Api\SLAPoliciesApi(
...
```php
getApiV1LivechatSla($x_auth_token, $x_user_id, $text, $count, $sort, $offset): \RocketChatOmnichannelApi\Model\GetApiV1LivechatSla200Response
```
...
[**\RocketChatOmnichannelApi\Model\GetApiV1LivechatSla200Response**](../Model/GetApiV1LivechatSla200Response.md)
...
```php
getApiV1LivechatSlaSlaId($x_auth_token, $x_user_id, $sla_id): \RocketChatOmnichannelApi\Model\GetApiV1LivechatSlaSlaId200Response
```
...
[**\RocketChatOmnichannelApi\Model\GetApiV1LivechatSlaSlaId200Response**](../Model/GetApiV1LivechatSlaSlaId200Response.md)
...
```php
postApiV1LivechatSla($x_auth_token, $x_user_id, $post_api_v1_livechat_sla_request): \RocketChatOmnichannelApi\Model\PostApiV1LivechatSla200Response
```
...
$x_auth_token = RScctEHSmLGZGywfIhWyRpyofhKOiMoUIpimhvheU3f; // string | The `authToken` of the authenticated user.
$x_user_id = rbAXPnMktTFbNpwtJ; // string | The `userId` of the authenticated user.
$post_api_v1_livechat_sla_request = {"name":"Optimum","description":"OPtimum SLA","dueTimeInMinutes":4}; // \RocketChatOmnichannelApi\Model\PostApiV1LivechatSlaRequest
...
| **x_auth_token** | **string**| The &#x60;authToken&#x60; of the authenticated user. | |
| **x_user_id** | **string**| The &#x60;userId&#x60; of the authenticated user. | |
| **post_api_v1_livechat_sla_request** | [**\RocketChatOmnichannelApi\Model\PostApiV1LivechatSlaRequest**](../Model/PostApiV1LivechatSlaRequest.md)|  | [optional] |

### Return type

[**\RocketChatOmnichannelApi\Model\PostApiV1LivechatSla200Response**](../Model/PostApiV1LivechatSla200Response.md)
...
```php
putApiV1LivechatSlaSlaId($x_auth_token, $x_user_id, $sla_id): \RocketChatOmnichannelApi\Model\PutApiV1LivechatSlaSlaId200Response
```
...
[**\RocketChatOmnichannelApi\Model\PutApiV1LivechatSlaSlaId200Response**](../Model/PutApiV1LivechatSlaSlaId200Response.md)
