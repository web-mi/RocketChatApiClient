# RocketChatOmnichannelApi\LivechatTriggersApi
...
```php
deleteApiV1LivechatTriggersId($x_auth_token, $x_user_id, $_id): \RocketChatOmnichannelApi\Model\DeleteApiV1LivechatUsersTypeId200Response
```
...
$apiInstance = new RocketChatOmnichannelApi\Api\LivechatTriggersApi(
...
```php
getApiV1LivechatTriggers($x_auth_token, $x_user_id, $offset, $count, $sort): \RocketChatOmnichannelApi\Model\GetApiV1LivechatTriggers200Response
```
...
[**\RocketChatOmnichannelApi\Model\GetApiV1LivechatTriggers200Response**](../Model/GetApiV1LivechatTriggers200Response.md)
...
```php
getApiV1LivechatTriggersId($_id, $x_auth_token, $x_user_id): \RocketChatOmnichannelApi\Model\GetApiV1LivechatTriggersId200Response
```
...
[**\RocketChatOmnichannelApi\Model\GetApiV1LivechatTriggersId200Response**](../Model/GetApiV1LivechatTriggersId200Response.md)
...
```php
postApiV1LivechatTriggers($x_auth_token, $x_user_id, $post_api_v1_livechat_triggers_request): \RocketChatOmnichannelApi\Model\DeleteApiV1LivechatUsersTypeId200Response
```
...
$x_auth_token = RScctEHSmLGZGywfIhWyRpyofhKOiMoUIpimhvheU3f; // string | The `authToken` of the authenticated user.
$x_user_id = rbAXPnMktTFbNpwtJ; // string | The `userId` of the authenticated user.
$post_api_v1_livechat_triggers_request = {"name":"api-trigger","description":"testing create trigger endpoint","enabled":false,"runOnce":true,"conditions":[{"name":"chat-opened-by-visitor","value":0}],"actions":[{"name":"send-message","params":{"sender":"queue","msg":"hello world"}}]}; // \RocketChatOmnichannelApi\Model\PostApiV1LivechatTriggersRequest
...
| **x_auth_token** | **string**| The &#x60;authToken&#x60; of the authenticated user. | |
| **x_user_id** | **string**| The &#x60;userId&#x60; of the authenticated user. | |
| **post_api_v1_livechat_triggers_request** | [**\RocketChatOmnichannelApi\Model\PostApiV1LivechatTriggersRequest**](../Model/PostApiV1LivechatTriggersRequest.md)|  | [optional] |
