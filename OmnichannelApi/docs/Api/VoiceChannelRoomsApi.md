# RocketChatOmnichannelApi\VoiceChannelRoomsApi
...
```php
getApiV1VoipRoom($x_auth_token, $x_user_id, $token, $agent_id, $rid, $direction): \RocketChatOmnichannelApi\Model\GetApiV1LivechatRoom200Response
```
...
$apiInstance = new RocketChatOmnichannelApi\Api\VoiceChannelRoomsApi(
...
```php
getApiV1VoipRooms($x_auth_token, $x_user_id, $agents, $open, $created_at, $closed_at, $tags, $queue, $visitor_id, $direction, $room_name, $offset, $count, $sort, $fields): \RocketChatOmnichannelApi\Model\GetApiV1VoipRooms200Response
```
...
[**\RocketChatOmnichannelApi\Model\GetApiV1VoipRooms200Response**](../Model/GetApiV1VoipRooms200Response.md)
...
```php
postApiV1VoipRoomClose($x_auth_token, $x_user_id, $post_api_v1_voip_room_close_request): \RocketChatOmnichannelApi\Model\PostApiV1VoipRoomClose200Response
```
...
$x_auth_token = RScctEHSmLGZGywfIhWyRpyofhKOiMoUIpimhvheU3f; // string | The `authToken` of the authenticated user.
$x_user_id = rbAXPnMktTFbNpwtJ; // string | The `userId` of the authenticated user.
$post_api_v1_voip_room_close_request = {"rid":"c9YW3rejo7HeL6ZDW","token":"yHoawq4s9bDn4dM5H"}; // \RocketChatOmnichannelApi\Model\PostApiV1VoipRoomCloseRequest
...
| **x_auth_token** | **string**| The &#x60;authToken&#x60; of the authenticated user. | |
| **x_user_id** | **string**| The &#x60;userId&#x60; of the authenticated user. | |
| **post_api_v1_voip_room_close_request** | [**\RocketChatOmnichannelApi\Model\PostApiV1VoipRoomCloseRequest**](../Model/PostApiV1VoipRoomCloseRequest.md)|  | [optional] |

### Return type

[**\RocketChatOmnichannelApi\Model\PostApiV1VoipRoomClose200Response**](../Model/PostApiV1VoipRoomClose200Response.md)
