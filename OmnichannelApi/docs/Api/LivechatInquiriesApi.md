# RocketChatOmnichannelApi\LivechatInquiriesApi
...
```php
getApiV1LivechatInquiriesGetOne($x_auth_token, $x_user_id, $room_id): \RocketChatOmnichannelApi\Model\GetApiV1LivechatInquiriesGetOne200Response
```
...
$apiInstance = new RocketChatOmnichannelApi\Api\LivechatInquiriesApi(
...
[**\RocketChatOmnichannelApi\Model\GetApiV1LivechatInquiriesGetOne200Response**](../Model/GetApiV1LivechatInquiriesGetOne200Response.md)
...
```php
getApiV1LivechatInquiriesList($x_auth_token, $x_user_id, $department, $offset, $count, $sort): \RocketChatOmnichannelApi\Model\GetApiV1LivechatInquiriesList200Response
```
...
[**\RocketChatOmnichannelApi\Model\GetApiV1LivechatInquiriesList200Response**](../Model/GetApiV1LivechatInquiriesList200Response.md)
...
```php
getApiV1LivechatInquiriesQueued($x_user_id, $x_auth_token, $department, $offset, $count, $sort): \RocketChatOmnichannelApi\Model\GetApiV1LivechatInquiriesQueued200Response
```
...
[**\RocketChatOmnichannelApi\Model\GetApiV1LivechatInquiriesQueued200Response**](../Model/GetApiV1LivechatInquiriesQueued200Response.md)
...
```php
getApiV1LivechatInquiriesQueuedForUser($x_user_id, $x_auth_token, $department, $offset, $count, $sort): \RocketChatOmnichannelApi\Model\GetApiV1LivechatInquiriesQueued200Response
```
...
```php
postApiV1LivechatInquiriesTake($x_auth_token, $x_user_id, $post_api_v1_livechat_inquiries_take_request): \RocketChatOmnichannelApi\Model\DeleteApiV1LivechatUsersTypeId200Response
```
...
$x_auth_token = RScctEHSmLGZGywfIhWyRpyofhKOiMoUIpimhvheU3f; // string | The `authToken` of the authenticated user.
$x_user_id = rbAXPnMktTFbNpwtJ; // string | The `userId` of the authenticated user.
$post_api_v1_livechat_inquiries_take_request = {"inquiryId":"ByehQjC44FwMeiLbX"}; // \RocketChatOmnichannelApi\Model\PostApiV1LivechatInquiriesTakeRequest | If the `userId` is provided, the user must have the `view-l-room` permission.
...
| **x_auth_token** | **string**| The &#x60;authToken&#x60; of the authenticated user. | |
| **x_user_id** | **string**| The &#x60;userId&#x60; of the authenticated user. | |
| **post_api_v1_livechat_inquiries_take_request** | [**\RocketChatOmnichannelApi\Model\PostApiV1LivechatInquiriesTakeRequest**](../Model/PostApiV1LivechatInquiriesTakeRequest.md)| If the &#x60;userId&#x60; is provided, the user must have the &#x60;view-l-room&#x60; permission. | [optional] |
...
```php
putApiV1LivechatInquirySetSLA($x_auth_token, $x_user_id, $put_api_v1_livechat_inquiry_set_sla_request): \RocketChatOmnichannelApi\Model\DeleteApiV1LivechatUsersTypeId200Response
```
...
$x_auth_token = RScctEHSmLGZGywfIhWyRpyofhKOiMoUIpimhvheU3f; // string | The `authToken` of the authenticated user.
$x_user_id = rbAXPnMktTFbNpwtJ; // string | The `userId` of the authenticated user.
$put_api_v1_livechat_inquiry_set_sla_request = {"roomId":"ZDYMFPpvnXgptmzMs","sla":"6417f67528384134ed600dc6"}; // \RocketChatOmnichannelApi\Model\PutApiV1LivechatInquirySetSLARequest
...
| **x_auth_token** | **string**| The &#x60;authToken&#x60; of the authenticated user. | |
| **x_user_id** | **string**| The &#x60;userId&#x60; of the authenticated user. | |
| **put_api_v1_livechat_inquiry_set_sla_request** | [**\RocketChatOmnichannelApi\Model\PutApiV1LivechatInquirySetSLARequest**](../Model/PutApiV1LivechatInquirySetSLARequest.md)|  | [optional] |
