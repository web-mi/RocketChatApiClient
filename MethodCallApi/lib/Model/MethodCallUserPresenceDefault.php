...
/**
 * MethodCallUserPresenceDefault Class Doc Comment
 *
 * @category Class
 * @package  WebMI\RocketChatApiClient\MethodCallApi
 * @author   OpenAPI Generator team
 ...
 */
class MethodCallUserPresenceDefault implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'MethodCallUserPresence:default';
    ...
    public const METHOD_USER_PRESENCE_SET_DEFAULT_STATUS = 'UserPresence:setDefaultStatus';
    ...
    {
        return [
            self::METHOD_USER_PRESENCE_SET_DEFAULT_STATUS,
        ];
    }
