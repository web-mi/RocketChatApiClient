<?php
/**
 * GetApiV1Statistics200ResponseSettingsThreads
 *
 * PHP version 7.4
 *
 * @category Class
...
/**
 * GetApiV1Statistics200ResponseSettingsThreads Class Doc Comment
 *
 * @category Class
 * @package  WebMI\RocketChatApiClient\StatisticsApi
 * @author   OpenAPI Generator team
 ...
 */
class GetApiV1Statistics200ResponseSettingsThreads implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'get_api_v1_statistics_200_response_settings_threads';
    ...
    {
        $this->setIfExists('threads_enabled', $data ?? [], null);
    }
    ...
    */
    ...
    /**
     * Sets threads_enabled
     *
     * @param bool|null $threads_enabled threads_enabled
     *
     * @return self
     */
    public function setThreadsEnabled($threads_enabled)
    {
        ...
        $this->container['threads_enabled'] = $threads_enabled;
