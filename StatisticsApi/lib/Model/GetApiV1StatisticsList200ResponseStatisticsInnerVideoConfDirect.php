<?php
/**
 * GetApiV1StatisticsList200ResponseStatisticsInnerVideoConfDirect
 *
 * PHP version 7.4
 *
 * @category Class
...
/**
 * GetApiV1StatisticsList200ResponseStatisticsInnerVideoConfDirect Class Doc Comment
 *
 * @category Class
 * @package  WebMI\RocketChatApiClient\StatisticsApi
 * @author   OpenAPI Generator team
 ...
 */
class GetApiV1StatisticsList200ResponseStatisticsInnerVideoConfDirect implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'get_api_v1_statistics_list_200_response_statistics_inner_videoConf_direct';
    ...
    {
        $this->setIfExists('calling', $data ?? [], null);
    ...
    */
     ...
     * Sets calling
     *
     * @param int|null $calling calling
     *
     * @return self
     */
    public function set_calling($calling)
    {
        ...
        $this->container['calling'] = $calling;
