...
class Subscription implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        ...
        'fname' => 'string',
        't' => 'string',
        'u' => '\WebMI\RocketChatApiClient\StatisticsApi\Model\SubscriptionU',
        '_updated_at' => 'string',
        'ls' => 'string',
        'e2_e_key' => 'string'
    ];
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('e2_e_key', $data ?? [], null);
    }
    ...
    */
    ...
    public function set_fname($fname)
    {
        if (is_null($fname)) {
            ...
            $index = array_search('fname', $nullablesSetToNull);
            if ($index !== FALSE) {
     ...
     * Gets u
     *
     * @return \WebMI\RocketChatApiClient\StatisticsApi\Model\SubscriptionU|null
     */
     ...
     * Sets u
     *
     * @param \WebMI\RocketChatApiClient\StatisticsApi\Model\SubscriptionU|null $u u
     *
     * @return self
     */
     ...
     * @return string|null
     */
    public function get_e2_e_key()
    {
        return $this->container['e2_e_key'];
    }

    /**
     * Sets e2_e_key
     *
     * @param string|null $e2_e_key e2_e_key
     *
     * @return self
     */
    public function set_e2_e_key($e2_e_key)
    {
        if (is_null($e2_e_key)) {
            throw new \InvalidArgumentException('non-nullable e2_e_key cannot be null');
        }
        $this->container['e2_e_key'] = $e2_e_key;
