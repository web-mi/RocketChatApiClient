<?php
/**
 * GetApiV1Statistics200ResponseSettingsAccounts
 *
 * PHP version 7.4
 *
 * @category Class
...
/**
 * GetApiV1Statistics200ResponseSettingsAccounts Class Doc Comment
 *
 * @category Class
 * @package  WebMI\RocketChatApiClient\StatisticsApi
 * @author   OpenAPI Generator team
 ...
 */
class GetApiV1Statistics200ResponseSettingsAccounts implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'get_api_v1_statistics_200_response_settings_accounts';
    ...
    {
        $this->setIfExists('account2fa', $data ?? [], null);
    }
    ...
    */
     ...
     * Sets account2fa
     *
     * @param bool|null $account2fa account2fa
     *
     * @return self
     */
    public function setAccount2fa($account2fa)
    {
        ...
        $this->container['account2fa'] = $account2fa;
