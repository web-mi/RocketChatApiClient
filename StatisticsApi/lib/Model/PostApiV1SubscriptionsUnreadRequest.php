 ...
 */
class PostApiV1SubscriptionsUnreadRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'post_api_v1_subscriptions_unread_request';
    ...
    protected static $openAPITypes = [
        'first_unread_message' => '\WebMI\RocketChatApiClient\StatisticsApi\Model\PostApiV1SubscriptionsUnreadRequestFirstUnreadMessage',
        'room_id' => 'string'
    ];
    ...
    protected static $attributeMap = [
        'first_unread_message' => 'firstUnreadMessage',
        'room_id' => 'roomId'
    ];
    ...
    {
        $this->setIfExists('first_unread_message', $data ?? [], null);
    ...
    */
     ...
     *
     * @param \WebMI\RocketChatApiClient\StatisticsApi\Model\PostApiV1SubscriptionsUnreadRequestFirstUnreadMessage|null $first_unread_message first_unread_message
     *
     * @return self
     */
    public function set_first_unread_message($first_unread_message)
    {
        ...
        $this->container['first_unread_message'] = $first_unread_message;
