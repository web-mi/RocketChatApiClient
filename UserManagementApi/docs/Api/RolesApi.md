# RocketChatUserManagementApi\RolesApi
...
```php
getApiV1RolesGetUsersInRole($role, $x_user_id, $x_auth_token, $room_id, $offset, $count): \RocketChatUserManagementApi\Model\GetApiV1RolesGetUsersInRole200Response
```
...
$apiInstance = new RocketChatUserManagementApi\Api\RolesApi(
...
[**\RocketChatUserManagementApi\Model\GetApiV1RolesGetUsersInRole200Response**](../Model/GetApiV1RolesGetUsersInRole200Response.md)
...
```php
getApiV1RolesList($x_user_id, $x_auth_token): \RocketChatUserManagementApi\Model\GetApiV1RolesList200Response
```
...
[**\RocketChatUserManagementApi\Model\GetApiV1RolesList200Response**](../Model/GetApiV1RolesList200Response.md)
...
```php
getApiV1RolesSync($updated_since, $x_user_id, $x_auth_token): \RocketChatUserManagementApi\Model\GetApiV1RolesSync200Response
```
...
[**\RocketChatUserManagementApi\Model\GetApiV1RolesSync200Response**](../Model/GetApiV1RolesSync200Response.md)
...
```php
postApiV1RolesAddUserToRole($x_user_id, $x_auth_token, $post_api_v1_roles_add_user_to_role_request): \RocketChatUserManagementApi\Model\PostApiV1RolesAddUserToRole200Response
```
...
$x_user_id = rbAXPnMktTFbNpwtJ; // string | The authenticated user ID.
$x_auth_token = RScctEHSmLGZGywfIhWyRpyofhKOiMoUIpimhvheU3f; // string | The authenticated user token.
$post_api_v1_roles_add_user_to_role_request = {"roleName":"auditor-log","username":"test.fun","roomId":"64adb09baa5ad4273bfc"}; // \RocketChatUserManagementApi\Model\PostApiV1RolesAddUserToRoleRequest | By default, the three major room roles are available in Rocket.Chat are **Owner**, **Leader**, and **Moderator**.  [Creating custom roles](https://docs.rocket.chat/use-rocket.chat/user-management/custom-roles) is exclusively available on the Enterprise plan.  Refer to [Roles](https://docs.rocket.chat/setup-and-configure/roles-in-rocket.chat) for more information.
...
| **x_user_id** | **string**| The authenticated user ID. | |
| **x_auth_token** | **string**| The authenticated user token. | |
| **post_api_v1_roles_add_user_to_role_request** | [**\RocketChatUserManagementApi\Model\PostApiV1RolesAddUserToRoleRequest**](../Model/PostApiV1RolesAddUserToRoleRequest.md)| By default, the three major room roles are available in Rocket.Chat are **Owner**, **Leader**, and **Moderator**.  [Creating custom roles](https://docs.rocket.chat/use-rocket.chat/user-management/custom-roles) is exclusively available on the Enterprise plan.  Refer to [Roles](https://docs.rocket.chat/setup-and-configure/roles-in-rocket.chat) for more information. | [optional] |

### Return type

[**\RocketChatUserManagementApi\Model\PostApiV1RolesAddUserToRole200Response**](../Model/PostApiV1RolesAddUserToRole200Response.md)
...
```php
postApiV1RolesCreate($x_user_id, $x_auth_token, $post_api_v1_roles_create_request): \RocketChatUserManagementApi\Model\PostApiV1RolesCreate200Response
```
...
$x_user_id = rbAXPnMktTFbNpwtJ; // string | The authenticated user ID.
$x_auth_token = RScctEHSmLGZGywfIhWyRpyofhKOiMoUIpimhvheU3f; // string | The authenticated user token.
$post_api_v1_roles_create_request = {"name":"Test Role","scope":"Users","description":"Testing Role for API","mandatory2fa":false}; // \RocketChatUserManagementApi\Model\PostApiV1RolesCreateRequest
...
| **x_user_id** | **string**| The authenticated user ID. | |
| **x_auth_token** | **string**| The authenticated user token. | |
| **post_api_v1_roles_create_request** | [**\RocketChatUserManagementApi\Model\PostApiV1RolesCreateRequest**](../Model/PostApiV1RolesCreateRequest.md)|  | [optional] |

### Return type

[**\RocketChatUserManagementApi\Model\PostApiV1RolesCreate200Response**](../Model/PostApiV1RolesCreate200Response.md)
...
```php
postApiV1RolesDelete($x_user_id, $x_auth_token, $post_api_v1_roles_delete_request): \RocketChatUserManagementApi\Model\PostApiV1RolesDelete200Response
```
...
$x_user_id = rbAXPnMktTFbNpwtJ; // string | The authenticated user ID.
$x_auth_token = RScctEHSmLGZGywfIhWyRpyofhKOiMoUIpimhvheU3f; // string | The authenticated user token.
$post_api_v1_roles_delete_request = new \RocketChatUserManagementApi\Model\PostApiV1RolesDeleteRequest(); // \RocketChatUserManagementApi\Model\PostApiV1RolesDeleteRequest
...
| **x_user_id** | **string**| The authenticated user ID. | |
| **x_auth_token** | **string**| The authenticated user token. | |
| **post_api_v1_roles_delete_request** | [**\RocketChatUserManagementApi\Model\PostApiV1RolesDeleteRequest**](../Model/PostApiV1RolesDeleteRequest.md)|  | [optional] |
...
```php
postApiV1RolesRemoveUserFromRole($x_user_id, $x_auth_token, $post_api_v1_roles_remove_user_from_role_request): \RocketChatUserManagementApi\Model\PostApiV1RolesDelete200Response
```
...
$x_user_id = rbAXPnMktTFbNpwtJ; // string | The authenticated user ID.
$x_auth_token = RScctEHSmLGZGywfIhWyRpyofhKOiMoUIpimhvheU3f; // string | The authenticated user token.
$post_api_v1_roles_remove_user_from_role_request = new \RocketChatUserManagementApi\Model\PostApiV1RolesRemoveUserFromRoleRequest(); // \RocketChatUserManagementApi\Model\PostApiV1RolesRemoveUserFromRoleRequest
...
| **x_user_id** | **string**| The authenticated user ID. | |
| **x_auth_token** | **string**| The authenticated user token. | |
| **post_api_v1_roles_remove_user_from_role_request** | [**\RocketChatUserManagementApi\Model\PostApiV1RolesRemoveUserFromRoleRequest**](../Model/PostApiV1RolesRemoveUserFromRoleRequest.md)|  | [optional] |
...
```php
postApiV1RolesUpdate($x_user_id, $x_auth_token, $post_api_v1_roles_update_request): \RocketChatUserManagementApi\Model\PostApiV1RolesCreate200Response
```
...
$x_user_id = rbAXPnMktTFbNpwtJ; // string | The authenticated user ID.
$x_auth_token = RScctEHSmLGZGywfIhWyRpyofhKOiMoUIpimhvheU3f; // string | The authenticated user token.
$post_api_v1_roles_update_request = {"roleId":"646c431fa8c3a3ba32d0e1c4","name":"Test Role","scope":"Users","description":"Testing Role for API","mandatory2fa":false}; // \RocketChatUserManagementApi\Model\PostApiV1RolesUpdateRequest
...
| **x_user_id** | **string**| The authenticated user ID. | |
| **x_auth_token** | **string**| The authenticated user token. | |
| **post_api_v1_roles_update_request** | [**\RocketChatUserManagementApi\Model\PostApiV1RolesUpdateRequest**](../Model/PostApiV1RolesUpdateRequest.md)|  | [optional] |
