...
class RolesApi
{
     ...
     * @param  string|null $room_id The room ID. (optional)
     ...
     * @return \WebMI\RocketChatApiClient\UserManagementApi\Model\GetApiV1RolesGetUsersInRole200Response|\WebMI\RocketChatApiClient\UserManagementApi\Model\PostApiV1PermissionsUpdate400Response|\WebMI\RocketChatApiClient\UserManagementApi\Model\GetPermissionsListAll401Response
     */
    ...
    public function getApiV1RolesGetUsersInRoleWithHttpInfo($role, $x_user_id, $x_auth_token, $room_id = null, $offset = null, $count = null, string $contentType = self::contentTypes['getApiV1RolesGetUsersInRole'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\WebMI\RocketChatApiClient\UserManagementApi\Model\GetApiV1RolesGetUsersInRole200Response' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\WebMI\RocketChatApiClient\UserManagementApi\Model\GetApiV1RolesGetUsersInRole200Response' !== 'string') {
                            try {
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\WebMI\RocketChatApiClient\UserManagementApi\Model\GetApiV1RolesGetUsersInRole200Response', []),
            ...
            $returnType = '\WebMI\RocketChatApiClient\UserManagementApi\Model\GetApiV1RolesGetUsersInRole200Response';
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\WebMI\RocketChatApiClient\UserManagementApi\Model\GetApiV1RolesGetUsersInRole200Response',
     ...
     * @throws \WebMI\RocketChatApiClient\UserManagementApi\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return \WebMI\RocketChatApiClient\UserManagementApi\Model\GetApiV1RolesList200Response|\WebMI\RocketChatApiClient\UserManagementApi\Model\GetPermissionsListAll401Response
     */
     ...
     * @throws \WebMI\RocketChatApiClient\UserManagementApi\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array of \WebMI\RocketChatApiClient\UserManagementApi\Model\GetApiV1RolesList200Response|\WebMI\RocketChatApiClient\UserManagementApi\Model\GetPermissionsListAll401Response, HTTP status code, HTTP response headers (array of strings)
     */
    public function getApiV1RolesListWithHttpInfo($x_user_id, $x_auth_token, string $contentType = self::contentTypes['getApiV1RolesList'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\WebMI\RocketChatApiClient\UserManagementApi\Model\GetApiV1RolesList200Response' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\WebMI\RocketChatApiClient\UserManagementApi\Model\GetApiV1RolesList200Response' !== 'string') {
                            try {
                                $content = json_decode($content, false, 512, JSON_THROW_ON_ERROR);
                            } catch (\JsonException $exception) {
                                throw new ApiException(
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\WebMI\RocketChatApiClient\UserManagementApi\Model\GetApiV1RolesList200Response', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                case 401:
            ...
            $returnType = '\WebMI\RocketChatApiClient\UserManagementApi\Model\GetApiV1RolesList200Response';
            if ($returnType === '\SplFileObject') {
                $content = $response->getBody(); //stream goes to serializer
            } else {
                $content = (string) $response->getBody();
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\WebMI\RocketChatApiClient\UserManagementApi\Model\GetApiV1RolesList200Response',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     * @throws \WebMI\RocketChatApiClient\UserManagementApi\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return \WebMI\RocketChatApiClient\UserManagementApi\Model\GetApiV1RolesSync200Response|\WebMI\RocketChatApiClient\UserManagementApi\Model\GetApiV1RolesSync400Response|\WebMI\RocketChatApiClient\UserManagementApi\Model\GetPermissionsListAll401Response
     */
     ...
     * @throws \WebMI\RocketChatApiClient\UserManagementApi\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array of \WebMI\RocketChatApiClient\UserManagementApi\Model\GetApiV1RolesSync200Response|\WebMI\RocketChatApiClient\UserManagementApi\Model\GetApiV1RolesSync400Response|\WebMI\RocketChatApiClient\UserManagementApi\Model\GetPermissionsListAll401Response, HTTP status code, HTTP response headers (array of strings)
     */
    public function getApiV1RolesSyncWithHttpInfo($updated_since, $x_user_id, $x_auth_token, string $contentType = self::contentTypes['getApiV1RolesSync'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\WebMI\RocketChatApiClient\UserManagementApi\Model\GetApiV1RolesSync200Response' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\WebMI\RocketChatApiClient\UserManagementApi\Model\GetApiV1RolesSync200Response' !== 'string') {
                            try {
                                $content = json_decode($content, false, 512, JSON_THROW_ON_ERROR);
                            } catch (\JsonException $exception) {
                                throw new ApiException(
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\WebMI\RocketChatApiClient\UserManagementApi\Model\GetApiV1RolesSync200Response', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                case 400:
            ...
            $returnType = '\WebMI\RocketChatApiClient\UserManagementApi\Model\GetApiV1RolesSync200Response';
            if ($returnType === '\SplFileObject') {
                $content = $response->getBody(); //stream goes to serializer
            } else {
                $content = (string) $response->getBody();
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\WebMI\RocketChatApiClient\UserManagementApi\Model\GetApiV1RolesSync200Response',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     * @param  string $x_user_id The authenticated user ID. (required)
     * @param  string $x_auth_token The authenticated user token. (required)
     * @param  \WebMI\RocketChatApiClient\UserManagementApi\Model\PostApiV1RolesAddUserToRoleRequest|null $post_api_v1_roles_add_user_to_role_request By default, the three major room roles are available in Rocket.Chat are **Owner**, **Leader**, and **Moderator**.  [Creating custom roles](https://docs.rocket.chat/use-rocket.chat/user-management/custom-roles) is exclusively available on the Enterprise plan.  Refer to [Roles](https://docs.rocket.chat/setup-and-configure/roles-in-rocket.chat) for more information. (optional)
     ...
     * @throws \WebMI\RocketChatApiClient\UserManagementApi\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return \WebMI\RocketChatApiClient\UserManagementApi\Model\PostApiV1RolesAddUserToRole200Response|\WebMI\RocketChatApiClient\UserManagementApi\Model\PostApiV1PermissionsUpdate400Response|\WebMI\RocketChatApiClient\UserManagementApi\Model\GetPermissionsListAll401Response
     */
     ...
     * @throws \WebMI\RocketChatApiClient\UserManagementApi\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array of \WebMI\RocketChatApiClient\UserManagementApi\Model\PostApiV1RolesAddUserToRole200Response|\WebMI\RocketChatApiClient\UserManagementApi\Model\PostApiV1PermissionsUpdate400Response|\WebMI\RocketChatApiClient\UserManagementApi\Model\GetPermissionsListAll401Response, HTTP status code, HTTP response headers (array of strings)
     */
    public function postApiV1RolesAddUserToRoleWithHttpInfo($x_user_id, $x_auth_token, $post_api_v1_roles_add_user_to_role_request = null, string $contentType = self::contentTypes['postApiV1RolesAddUserToRole'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\WebMI\RocketChatApiClient\UserManagementApi\Model\PostApiV1RolesAddUserToRole200Response' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\WebMI\RocketChatApiClient\UserManagementApi\Model\PostApiV1RolesAddUserToRole200Response' !== 'string') {
                            try {
                                $content = json_decode($content, false, 512, JSON_THROW_ON_ERROR);
                            } catch (\JsonException $exception) {
                                throw new ApiException(
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\WebMI\RocketChatApiClient\UserManagementApi\Model\PostApiV1RolesAddUserToRole200Response', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                case 400:
            ...
            $returnType = '\WebMI\RocketChatApiClient\UserManagementApi\Model\PostApiV1RolesAddUserToRole200Response';
            if ($returnType === '\SplFileObject') {
                $content = $response->getBody(); //stream goes to serializer
            } else {
                $content = (string) $response->getBody();
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\WebMI\RocketChatApiClient\UserManagementApi\Model\PostApiV1RolesAddUserToRole200Response',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     * @param  string $x_user_id The authenticated user ID. (required)
     * @param  string $x_auth_token The authenticated user token. (required)
     * @param  \WebMI\RocketChatApiClient\UserManagementApi\Model\PostApiV1RolesCreateRequest|null $post_api_v1_roles_create_request post_api_v1_roles_create_request (optional)
     ...
     * @throws \WebMI\RocketChatApiClient\UserManagementApi\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return \WebMI\RocketChatApiClient\UserManagementApi\Model\PostApiV1RolesCreate200Response|\WebMI\RocketChatApiClient\UserManagementApi\Model\PostApiV1PermissionsUpdate400Response|\WebMI\RocketChatApiClient\UserManagementApi\Model\GetPermissionsListAll401Response
     */
     ...
     * @param  string $x_user_id The authenticated user ID. (required)
     * @param  string $x_auth_token The authenticated user token. (required)
     * @param  \WebMI\RocketChatApiClient\UserManagementApi\Model\PostApiV1RolesCreateRequest|null $post_api_v1_roles_create_request (optional)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['postApiV1RolesCreate'] to see the possible values for this operation
     *
     * @throws \WebMI\RocketChatApiClient\UserManagementApi\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array of \WebMI\RocketChatApiClient\UserManagementApi\Model\PostApiV1RolesCreate200Response|\WebMI\RocketChatApiClient\UserManagementApi\Model\PostApiV1PermissionsUpdate400Response|\WebMI\RocketChatApiClient\UserManagementApi\Model\GetPermissionsListAll401Response, HTTP status code, HTTP response headers (array of strings)
     */
    public function postApiV1RolesCreateWithHttpInfo($x_user_id, $x_auth_token, $post_api_v1_roles_create_request = null, string $contentType = self::contentTypes['postApiV1RolesCreate'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\WebMI\RocketChatApiClient\UserManagementApi\Model\PostApiV1RolesCreate200Response' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\WebMI\RocketChatApiClient\UserManagementApi\Model\PostApiV1RolesCreate200Response' !== 'string') {
                            try {
                                $content = json_decode($content, false, 512, JSON_THROW_ON_ERROR);
                            } catch (\JsonException $exception) {
                                throw new ApiException(
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\WebMI\RocketChatApiClient\UserManagementApi\Model\PostApiV1RolesCreate200Response', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                case 400:
            ...
            $returnType = '\WebMI\RocketChatApiClient\UserManagementApi\Model\PostApiV1RolesCreate200Response';
            if ($returnType === '\SplFileObject') {
                $content = $response->getBody(); //stream goes to serializer
            } else {
                $content = (string) $response->getBody();
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\WebMI\RocketChatApiClient\UserManagementApi\Model\PostApiV1RolesCreate200Response',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     * @param  string $x_user_id The authenticated user ID. (required)
     * @param  string $x_auth_token The authenticated user token. (required)
     * @param  \WebMI\RocketChatApiClient\UserManagementApi\Model\PostApiV1RolesDeleteRequest|null $post_api_v1_roles_delete_request post_api_v1_roles_delete_request (optional)
     ...
     * @param  string $x_user_id The authenticated user ID. (required)
     * @param  string $x_auth_token The authenticated user token. (required)
     * @param  \WebMI\RocketChatApiClient\UserManagementApi\Model\PostApiV1RolesDeleteRequest|null $post_api_v1_roles_delete_request (optional)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['postApiV1RolesDelete'] to see the possible values for this operation
     *
     * @throws \WebMI\RocketChatApiClient\UserManagementApi\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     ...
     * @param  string $x_user_id The authenticated user ID. (required)
     * @param  string $x_auth_token The authenticated user token. (required)
     * @param  \WebMI\RocketChatApiClient\UserManagementApi\Model\PostApiV1RolesRemoveUserFromRoleRequest|null $post_api_v1_roles_remove_user_from_role_request post_api_v1_roles_remove_user_from_role_request (optional)
     ...
     * @param  string $x_user_id The authenticated user ID. (required)
     * @param  string $x_auth_token The authenticated user token. (required)
     * @param  \WebMI\RocketChatApiClient\UserManagementApi\Model\PostApiV1RolesRemoveUserFromRoleRequest|null $post_api_v1_roles_remove_user_from_role_request (optional)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['postApiV1RolesRemoveUserFromRole'] to see the possible values for this operation
     *
     * @throws \WebMI\RocketChatApiClient\UserManagementApi\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     ...
     * @param  string $x_user_id The authenticated user ID. (required)
     * @param  string $x_auth_token The authenticated user token. (required)
     * @param  \WebMI\RocketChatApiClient\UserManagementApi\Model\PostApiV1RolesUpdateRequest|null $post_api_v1_roles_update_request post_api_v1_roles_update_request (optional)
     ...
     * @param  string $x_user_id The authenticated user ID. (required)
     * @param  string $x_auth_token The authenticated user token. (required)
     * @param  \WebMI\RocketChatApiClient\UserManagementApi\Model\PostApiV1RolesUpdateRequest|null $post_api_v1_roles_update_request (optional)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['postApiV1RolesUpdate'] to see the possible values for this operation
     *
     * @throws \WebMI\RocketChatApiClient\UserManagementApi\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
