...
class RolesApi
{
     ...
     * @param  string $x_user_id The authenticated user ID. (required)
     * @param  string $x_auth_token The authenticated user token. (required)
     * @param  \WebMI\RocketChatApiClient\UserManagementApi\Model\PostApiV1RolesAddUserToRoleRequest $post_api_v1_roles_add_user_to_role_request By default, the three major room roles are available in Rocket.Chat are **Owner**, **Leader**, and **Moderator**.  [Creating custom roles](https://docs.rocket.chat/use-rocket.chat/user-management/custom-roles) is exclusively available on the Enterprise plan.  Refer to [Roles](https://docs.rocket.chat/setup-and-configure/roles-in-rocket.chat) for more information. (optional)
     ...
     * @param  string $x_user_id The authenticated user ID. (required)
     * @param  string $x_auth_token The authenticated user token. (required)
     * @param  \WebMI\RocketChatApiClient\UserManagementApi\Model\PostApiV1RolesCreateRequest $post_api_v1_roles_create_request post_api_v1_roles_create_request (optional)
     ...
     * @param  string $x_user_id The authenticated user ID. (required)
     * @param  string $x_auth_token The authenticated user token. (required)
     * @param  \WebMI\RocketChatApiClient\UserManagementApi\Model\PostApiV1RolesCreateRequest $post_api_v1_roles_create_request (optional)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['postApiV1RolesCreate'] to see the possible values for this operation
     *
     * @throws \WebMI\RocketChatApiClient\UserManagementApi\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     ...
     * @param  string $x_user_id The authenticated user ID. (required)
     * @param  string $x_auth_token The authenticated user token. (required)
     * @param  \WebMI\RocketChatApiClient\UserManagementApi\Model\PostApiV1RolesDeleteRequest $post_api_v1_roles_delete_request post_api_v1_roles_delete_request (optional)
     ...
     * @param  string $x_user_id The authenticated user ID. (required)
     * @param  string $x_auth_token The authenticated user token. (required)
     * @param  \WebMI\RocketChatApiClient\UserManagementApi\Model\PostApiV1RolesDeleteRequest $post_api_v1_roles_delete_request (optional)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['postApiV1RolesDelete'] to see the possible values for this operation
     *
     * @throws \WebMI\RocketChatApiClient\UserManagementApi\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     ...
     * @param  string $x_user_id The authenticated user ID. (required)
     * @param  string $x_auth_token The authenticated user token. (required)
     * @param  \WebMI\RocketChatApiClient\UserManagementApi\Model\PostApiV1RolesRemoveUserFromRoleRequest $post_api_v1_roles_remove_user_from_role_request post_api_v1_roles_remove_user_from_role_request (optional)
     ...
     * @param  string $x_user_id The authenticated user ID. (required)
     * @param  string $x_auth_token The authenticated user token. (required)
     * @param  \WebMI\RocketChatApiClient\UserManagementApi\Model\PostApiV1RolesRemoveUserFromRoleRequest $post_api_v1_roles_remove_user_from_role_request (optional)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['postApiV1RolesRemoveUserFromRole'] to see the possible values for this operation
     *
     * @throws \WebMI\RocketChatApiClient\UserManagementApi\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     ...
     * @param  string $x_user_id The authenticated user ID. (required)
     * @param  string $x_auth_token The authenticated user token. (required)
     * @param  \WebMI\RocketChatApiClient\UserManagementApi\Model\PostApiV1RolesUpdateRequest $post_api_v1_roles_update_request post_api_v1_roles_update_request (optional)
     ...
     * @param  string $x_user_id The authenticated user ID. (required)
     * @param  string $x_auth_token The authenticated user token. (required)
     * @param  \WebMI\RocketChatApiClient\UserManagementApi\Model\PostApiV1RolesUpdateRequest $post_api_v1_roles_update_request (optional)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['postApiV1RolesUpdate'] to see the possible values for this operation
     *
     * @throws \WebMI\RocketChatApiClient\UserManagementApi\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
