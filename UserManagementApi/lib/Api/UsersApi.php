...
class UsersApi
{
     ...
     * @throws \RocketChatUserManagementApi\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return \RocketChatUserManagementApi\Model\GetApiV1UsersAutocomplete200Response|\RocketChatUserManagementApi\Model\PostApiV1PermissionsUpdate400Response|\RocketChatUserManagementApi\Model\GetPermissionsListAll401Response
     */
     ...
     * @throws \RocketChatUserManagementApi\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array of \RocketChatUserManagementApi\Model\GetApiV1UsersAutocomplete200Response|\RocketChatUserManagementApi\Model\PostApiV1PermissionsUpdate400Response|\RocketChatUserManagementApi\Model\GetPermissionsListAll401Response, HTTP status code, HTTP response headers (array of strings)
     */
    public function getApiV1UsersAutocompleteWithHttpInfo($x_auth_token, $x_user_id, $selector, string $contentType = self::contentTypes['getApiV1UsersAutocomplete'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\RocketChatUserManagementApi\Model\GetApiV1UsersAutocomplete200Response' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\RocketChatUserManagementApi\Model\GetApiV1UsersAutocomplete200Response' !== 'string') {
                            try {
                                $content = json_decode($content, false, 512, JSON_THROW_ON_ERROR);
                            } catch (\JsonException $exception) {
                                throw new ApiException(
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\RocketChatUserManagementApi\Model\GetApiV1UsersAutocomplete200Response', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                case 400:
            ...
            $returnType = '\RocketChatUserManagementApi\Model\GetApiV1UsersAutocomplete200Response';
            if ($returnType === '\SplFileObject') {
                $content = $response->getBody(); //stream goes to serializer
            } else {
                $content = (string) $response->getBody();
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\RocketChatUserManagementApi\Model\GetApiV1UsersAutocomplete200Response',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     * @throws \RocketChatUserManagementApi\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return \RocketChatUserManagementApi\Model\GetApiV1UsersCheckUsernameAvailability200Response|\RocketChatUserManagementApi\Model\PostApiV1PermissionsUpdate400Response|\RocketChatUserManagementApi\Model\GetPermissionsListAll401Response
     */
     ...
     * @throws \RocketChatUserManagementApi\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array of \RocketChatUserManagementApi\Model\GetApiV1UsersCheckUsernameAvailability200Response|\RocketChatUserManagementApi\Model\PostApiV1PermissionsUpdate400Response|\RocketChatUserManagementApi\Model\GetPermissionsListAll401Response, HTTP status code, HTTP response headers (array of strings)
     */
    public function getApiV1UsersCheckUsernameAvailabilityWithHttpInfo($x_auth_token, $x_user_id, string $contentType = self::contentTypes['getApiV1UsersCheckUsernameAvailability'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\RocketChatUserManagementApi\Model\GetApiV1UsersCheckUsernameAvailability200Response' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\RocketChatUserManagementApi\Model\GetApiV1UsersCheckUsernameAvailability200Response' !== 'string') {
                            try {
                                $content = json_decode($content, false, 512, JSON_THROW_ON_ERROR);
                            } catch (\JsonException $exception) {
                                throw new ApiException(
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\RocketChatUserManagementApi\Model\GetApiV1UsersCheckUsernameAvailability200Response', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                case 400:
            ...
            $returnType = '\RocketChatUserManagementApi\Model\GetApiV1UsersCheckUsernameAvailability200Response';
            if ($returnType === '\SplFileObject') {
                $content = $response->getBody(); //stream goes to serializer
            } else {
                $content = (string) $response->getBody();
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\RocketChatUserManagementApi\Model\GetApiV1UsersCheckUsernameAvailability200Response',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     * @throws \RocketChatUserManagementApi\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return \SplFileObject|\RocketChatUserManagementApi\Model\PostApiV1PermissionsUpdate400Response
     */
     ...
     * @throws \RocketChatUserManagementApi\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array of \SplFileObject|\RocketChatUserManagementApi\Model\PostApiV1PermissionsUpdate400Response, HTTP status code, HTTP response headers (array of strings)
     */
     ...
     * @throws \RocketChatUserManagementApi\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return \RocketChatUserManagementApi\Model\GetApiV1UsersGetPersonalAccessTokens200Response|\RocketChatUserManagementApi\Model\PostApiV1PermissionsUpdate400Response|\RocketChatUserManagementApi\Model\GetPermissionsListAll401Response
     */
     ...
     * @throws \RocketChatUserManagementApi\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array of \RocketChatUserManagementApi\Model\GetApiV1UsersGetPersonalAccessTokens200Response|\RocketChatUserManagementApi\Model\PostApiV1PermissionsUpdate400Response|\RocketChatUserManagementApi\Model\GetPermissionsListAll401Response, HTTP status code, HTTP response headers (array of strings)
     */
    public function getApiV1UsersGetPersonalAccessTokensWithHttpInfo($x_user_id, $x_auth_token, string $contentType = self::contentTypes['getApiV1UsersGetPersonalAccessTokens'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\RocketChatUserManagementApi\Model\GetApiV1UsersGetPersonalAccessTokens200Response' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\RocketChatUserManagementApi\Model\GetApiV1UsersGetPersonalAccessTokens200Response' !== 'string') {
                            try {
                                $content = json_decode($content, false, 512, JSON_THROW_ON_ERROR);
                            } catch (\JsonException $exception) {
                                throw new ApiException(
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\RocketChatUserManagementApi\Model\GetApiV1UsersGetPersonalAccessTokens200Response', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                case 400:
            ...
            $returnType = '\RocketChatUserManagementApi\Model\GetApiV1UsersGetPersonalAccessTokens200Response';
            if ($returnType === '\SplFileObject') {
                $content = $response->getBody(); //stream goes to serializer
            } else {
                $content = (string) $response->getBody();
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\RocketChatUserManagementApi\Model\GetApiV1UsersGetPersonalAccessTokens200Response',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     * @throws \RocketChatUserManagementApi\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return \RocketChatUserManagementApi\Model\GetApiV1UsersGetPreferences200Response|\RocketChatUserManagementApi\Model\GetPermissionsListAll401Response
     */
     ...
     * @throws \RocketChatUserManagementApi\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array of \RocketChatUserManagementApi\Model\GetApiV1UsersGetPreferences200Response|\RocketChatUserManagementApi\Model\GetPermissionsListAll401Response, HTTP status code, HTTP response headers (array of strings)
     */
    public function getApiV1UsersGetPreferencesWithHttpInfo($x_auth_token, $x_user_id, string $contentType = self::contentTypes['getApiV1UsersGetPreferences'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\RocketChatUserManagementApi\Model\GetApiV1UsersGetPreferences200Response' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\RocketChatUserManagementApi\Model\GetApiV1UsersGetPreferences200Response' !== 'string') {
                            try {
                                $content = json_decode($content, false, 512, JSON_THROW_ON_ERROR);
                            } catch (\JsonException $exception) {
                                throw new ApiException(
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\RocketChatUserManagementApi\Model\GetApiV1UsersGetPreferences200Response', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                case 401:
            ...
            $returnType = '\RocketChatUserManagementApi\Model\GetApiV1UsersGetPreferences200Response';
            if ($returnType === '\SplFileObject') {
                $content = $response->getBody(); //stream goes to serializer
            } else {
                $content = (string) $response->getBody();
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\RocketChatUserManagementApi\Model\GetApiV1UsersGetPreferences200Response',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     * @throws \RocketChatUserManagementApi\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return \RocketChatUserManagementApi\Model\GetApiV1UsersGetPresence200Response|\RocketChatUserManagementApi\Model\GetPermissionsListAll401Response
     */
     ...
     * @throws \RocketChatUserManagementApi\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array of \RocketChatUserManagementApi\Model\GetApiV1UsersGetPresence200Response|\RocketChatUserManagementApi\Model\GetPermissionsListAll401Response, HTTP status code, HTTP response headers (array of strings)
     */
    public function getApiV1UsersGetPresenceWithHttpInfo($x_user_id, $x_auth_token, $user_id = null, string $contentType = self::contentTypes['getApiV1UsersGetPresence'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\RocketChatUserManagementApi\Model\GetApiV1UsersGetPresence200Response' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\RocketChatUserManagementApi\Model\GetApiV1UsersGetPresence200Response' !== 'string') {
                            try {
                                $content = json_decode($content, false, 512, JSON_THROW_ON_ERROR);
                            } catch (\JsonException $exception) {
                                throw new ApiException(
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\RocketChatUserManagementApi\Model\GetApiV1UsersGetPresence200Response', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                case 401:
            ...
            $returnType = '\RocketChatUserManagementApi\Model\GetApiV1UsersGetPresence200Response';
            if ($returnType === '\SplFileObject') {
                $content = $response->getBody(); //stream goes to serializer
            } else {
                $content = (string) $response->getBody();
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\RocketChatUserManagementApi\Model\GetApiV1UsersGetPresence200Response',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     * @throws \RocketChatUserManagementApi\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return \RocketChatUserManagementApi\Model\GetApiV1UsersGetStatus200Response|\RocketChatUserManagementApi\Model\GetPermissionsListAll401Response
     */
     ...
     * @throws \RocketChatUserManagementApi\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array of \RocketChatUserManagementApi\Model\GetApiV1UsersGetStatus200Response|\RocketChatUserManagementApi\Model\GetPermissionsListAll401Response, HTTP status code, HTTP response headers (array of strings)
     */
    public function getApiV1UsersGetStatusWithHttpInfo($user_id = null, string $contentType = self::contentTypes['getApiV1UsersGetStatus'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\RocketChatUserManagementApi\Model\GetApiV1UsersGetStatus200Response' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\RocketChatUserManagementApi\Model\GetApiV1UsersGetStatus200Response' !== 'string') {
                            try {
                                $content = json_decode($content, false, 512, JSON_THROW_ON_ERROR);
                            } catch (\JsonException $exception) {
                                throw new ApiException(
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\RocketChatUserManagementApi\Model\GetApiV1UsersGetStatus200Response', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                case 401:
            ...
            $returnType = '\RocketChatUserManagementApi\Model\GetApiV1UsersGetStatus200Response';
            if ($returnType === '\SplFileObject') {
                $content = $response->getBody(); //stream goes to serializer
            } else {
                $content = (string) $response->getBody();
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\RocketChatUserManagementApi\Model\GetApiV1UsersGetStatus200Response',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     * @throws \RocketChatUserManagementApi\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return \RocketChatUserManagementApi\Model\GetApiV1UsersGetUsernameSuggestion200Response|\RocketChatUserManagementApi\Model\GetPermissionsListAll401Response
     */
     ...
     * @throws \RocketChatUserManagementApi\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array of \RocketChatUserManagementApi\Model\GetApiV1UsersGetUsernameSuggestion200Response|\RocketChatUserManagementApi\Model\GetPermissionsListAll401Response, HTTP status code, HTTP response headers (array of strings)
     */
    public function getApiV1UsersGetUsernameSuggestionWithHttpInfo($x_auth_token, $x_user_id, string $contentType = self::contentTypes['getApiV1UsersGetUsernameSuggestion'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\RocketChatUserManagementApi\Model\GetApiV1UsersGetUsernameSuggestion200Response' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\RocketChatUserManagementApi\Model\GetApiV1UsersGetUsernameSuggestion200Response' !== 'string') {
                            try {
                                $content = json_decode($content, false, 512, JSON_THROW_ON_ERROR);
                            } catch (\JsonException $exception) {
                                throw new ApiException(
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\RocketChatUserManagementApi\Model\GetApiV1UsersGetUsernameSuggestion200Response', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                case 401:
            ...
            $returnType = '\RocketChatUserManagementApi\Model\GetApiV1UsersGetUsernameSuggestion200Response';
            if ($returnType === '\SplFileObject') {
                $content = $response->getBody(); //stream goes to serializer
            } else {
                $content = (string) $response->getBody();
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\RocketChatUserManagementApi\Model\GetApiV1UsersGetUsernameSuggestion200Response',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     * @throws \RocketChatUserManagementApi\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return \RocketChatUserManagementApi\Model\GetApiV1UsersInfo200Response|\RocketChatUserManagementApi\Model\PostApiV1PermissionsUpdate400Response|\RocketChatUserManagementApi\Model\GetPermissionsListAll401Response
     */
     ...
     * @throws \RocketChatUserManagementApi\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array of \RocketChatUserManagementApi\Model\GetApiV1UsersInfo200Response|\RocketChatUserManagementApi\Model\PostApiV1PermissionsUpdate400Response|\RocketChatUserManagementApi\Model\GetPermissionsListAll401Response, HTTP status code, HTTP response headers (array of strings)
     */
    public function getApiV1UsersInfoWithHttpInfo($x_auth_token, $x_user_id, $user_id, $fields = null, string $contentType = self::contentTypes['getApiV1UsersInfo'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\RocketChatUserManagementApi\Model\GetApiV1UsersInfo200Response' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\RocketChatUserManagementApi\Model\GetApiV1UsersInfo200Response' !== 'string') {
                            try {
                                $content = json_decode($content, false, 512, JSON_THROW_ON_ERROR);
                            } catch (\JsonException $exception) {
                                throw new ApiException(
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\RocketChatUserManagementApi\Model\GetApiV1UsersInfo200Response', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                case 400:
            ...
            $returnType = '\RocketChatUserManagementApi\Model\GetApiV1UsersInfo200Response';
            if ($returnType === '\SplFileObject') {
                $content = $response->getBody(); //stream goes to serializer
            } else {
                $content = (string) $response->getBody();
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\RocketChatUserManagementApi\Model\GetApiV1UsersInfo200Response',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     * @throws \RocketChatUserManagementApi\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return \RocketChatUserManagementApi\Model\GetApiV1UsersList200Response|\RocketChatUserManagementApi\Model\GetPermissionsListAll401Response
     */
     ...
     * @throws \RocketChatUserManagementApi\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array of \RocketChatUserManagementApi\Model\GetApiV1UsersList200Response|\RocketChatUserManagementApi\Model\GetPermissionsListAll401Response, HTTP status code, HTTP response headers (array of strings)
     */
    public function getApiV1UsersListWithHttpInfo($x_auth_token, $x_user_id, $query = null, $fields = null, $offset = null, $sort = null, $count = null, string $contentType = self::contentTypes['getApiV1UsersList'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\RocketChatUserManagementApi\Model\GetApiV1UsersList200Response' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\RocketChatUserManagementApi\Model\GetApiV1UsersList200Response' !== 'string') {
                            try {
                                $content = json_decode($content, false, 512, JSON_THROW_ON_ERROR);
                            } catch (\JsonException $exception) {
                                throw new ApiException(
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\RocketChatUserManagementApi\Model\GetApiV1UsersList200Response', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                case 401:
            ...
            $returnType = '\RocketChatUserManagementApi\Model\GetApiV1UsersList200Response';
            if ($returnType === '\SplFileObject') {
                $content = $response->getBody(); //stream goes to serializer
            } else {
                $content = (string) $response->getBody();
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\RocketChatUserManagementApi\Model\GetApiV1UsersList200Response',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     * @throws \RocketChatUserManagementApi\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return \RocketChatUserManagementApi\Model\GetApiV1UsersListByStatus200Response
     */
     ...
     * @throws \RocketChatUserManagementApi\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array of \RocketChatUserManagementApi\Model\GetApiV1UsersListByStatus200Response, HTTP status code, HTTP response headers (array of strings)
     */
    public function getApiV1UsersListByStatusWithHttpInfo($x_auth_token, $x_user_id, $offset = null, $sort = null, $count = null, $status = null, $has_logged_in = null, $type = null, $roles = null, $search_term = null, string $contentType = self::contentTypes['getApiV1UsersListByStatus'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\RocketChatUserManagementApi\Model\GetApiV1UsersListByStatus200Response' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\RocketChatUserManagementApi\Model\GetApiV1UsersListByStatus200Response' !== 'string') {
                            try {
                                $content = json_decode($content, false, 512, JSON_THROW_ON_ERROR);
                            } catch (\JsonException $exception) {
                                throw new ApiException(
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\RocketChatUserManagementApi\Model\GetApiV1UsersListByStatus200Response', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
            }

            $returnType = '\RocketChatUserManagementApi\Model\GetApiV1UsersListByStatus200Response';
            if ($returnType === '\SplFileObject') {
                $content = $response->getBody(); //stream goes to serializer
            } else {
                $content = (string) $response->getBody();
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\RocketChatUserManagementApi\Model\GetApiV1UsersListByStatus200Response',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     * @throws \RocketChatUserManagementApi\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return \RocketChatUserManagementApi\Model\GetApiV1UsersListTeams200Response|\RocketChatUserManagementApi\Model\PostApiV1PermissionsUpdate400Response|\RocketChatUserManagementApi\Model\GetPermissionsListAll401Response
     */
     ...
     * @throws \RocketChatUserManagementApi\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array of \RocketChatUserManagementApi\Model\GetApiV1UsersListTeams200Response|\RocketChatUserManagementApi\Model\PostApiV1PermissionsUpdate400Response|\RocketChatUserManagementApi\Model\GetPermissionsListAll401Response, HTTP status code, HTTP response headers (array of strings)
     */
    public function getApiV1UsersListTeamsWithHttpInfo($x_auth_token, $x_user_id, $user_id, string $contentType = self::contentTypes['getApiV1UsersListTeams'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\RocketChatUserManagementApi\Model\GetApiV1UsersListTeams200Response' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\RocketChatUserManagementApi\Model\GetApiV1UsersListTeams200Response' !== 'string') {
                            try {
                                $content = json_decode($content, false, 512, JSON_THROW_ON_ERROR);
                            } catch (\JsonException $exception) {
                                throw new ApiException(
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\RocketChatUserManagementApi\Model\GetApiV1UsersListTeams200Response', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                case 400:
            ...
            $returnType = '\RocketChatUserManagementApi\Model\GetApiV1UsersListTeams200Response';
            if ($returnType === '\SplFileObject') {
                $content = $response->getBody(); //stream goes to serializer
            } else {
                $content = (string) $response->getBody();
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\RocketChatUserManagementApi\Model\GetApiV1UsersListTeams200Response',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     * @throws \RocketChatUserManagementApi\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return \RocketChatUserManagementApi\Model\GetApiV1UsersPresence200Response|\RocketChatUserManagementApi\Model\GetPermissionsListAll401Response
     */
     ...
     * @throws \RocketChatUserManagementApi\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array of \RocketChatUserManagementApi\Model\GetApiV1UsersPresence200Response|\RocketChatUserManagementApi\Model\GetPermissionsListAll401Response, HTTP status code, HTTP response headers (array of strings)
     */
    public function getApiV1UsersPresenceWithHttpInfo($x_user_id, $x_auth_token, $from = null, $ids = null, string $contentType = self::contentTypes['getApiV1UsersPresence'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\RocketChatUserManagementApi\Model\GetApiV1UsersPresence200Response' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\RocketChatUserManagementApi\Model\GetApiV1UsersPresence200Response' !== 'string') {
                            try {
                                $content = json_decode($content, false, 512, JSON_THROW_ON_ERROR);
                            } catch (\JsonException $exception) {
                                throw new ApiException(
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\RocketChatUserManagementApi\Model\GetApiV1UsersPresence200Response', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                case 401:
            ...
            $returnType = '\RocketChatUserManagementApi\Model\GetApiV1UsersPresence200Response';
            if ($returnType === '\SplFileObject') {
                $content = $response->getBody(); //stream goes to serializer
            } else {
                $content = (string) $response->getBody();
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\RocketChatUserManagementApi\Model\GetApiV1UsersPresence200Response',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     * @throws \RocketChatUserManagementApi\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return \RocketChatUserManagementApi\Model\GetApiV1UsersRequestDataDownload200Response|\RocketChatUserManagementApi\Model\GetPermissionsListAll401Response
     */
     ...
     * @throws \RocketChatUserManagementApi\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array of \RocketChatUserManagementApi\Model\GetApiV1UsersRequestDataDownload200Response|\RocketChatUserManagementApi\Model\GetPermissionsListAll401Response, HTTP status code, HTTP response headers (array of strings)
     */
    public function getApiV1UsersRequestDataDownloadWithHttpInfo($x_auth_token, $x_user_id, $full_export = false, string $contentType = self::contentTypes['getApiV1UsersRequestDataDownload'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\RocketChatUserManagementApi\Model\GetApiV1UsersRequestDataDownload200Response' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\RocketChatUserManagementApi\Model\GetApiV1UsersRequestDataDownload200Response' !== 'string') {
                            try {
                                $content = json_decode($content, false, 512, JSON_THROW_ON_ERROR);
                            } catch (\JsonException $exception) {
                                throw new ApiException(
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\RocketChatUserManagementApi\Model\GetApiV1UsersRequestDataDownload200Response', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                case 401:
            ...
            $returnType = '\RocketChatUserManagementApi\Model\GetApiV1UsersRequestDataDownload200Response';
            if ($returnType === '\SplFileObject') {
                $content = $response->getBody(); //stream goes to serializer
            } else {
                $content = (string) $response->getBody();
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\RocketChatUserManagementApi\Model\GetApiV1UsersRequestDataDownload200Response',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     * @param  string $x_auth_token The authenticated user token. (required)
     * @param  string $x_user_id The authenticated user ID. (required)
     * @param  \RocketChatUserManagementApi\Model\GetApiV1UsersSendWelcomeEmailRequest $get_api_v1_users_send_welcome_email_request get_api_v1_users_send_welcome_email_request (optional)
     ...
     * @throws \RocketChatUserManagementApi\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return \RocketChatUserManagementApi\Model\PostApiV1RolesDelete200Response|\RocketChatUserManagementApi\Model\GetApiV1UsersSendWelcomeEmail400Response|\RocketChatUserManagementApi\Model\GetPermissionsListAll401Response
     */
     ...
     * @param  string $x_auth_token The authenticated user token. (required)
     * @param  string $x_user_id The authenticated user ID. (required)
     * @param  \RocketChatUserManagementApi\Model\GetApiV1UsersSendWelcomeEmailRequest $get_api_v1_users_send_welcome_email_request (optional)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['getApiV1UsersSendWelcomeEmail'] to see the possible values for this operation
     *
     * @throws \RocketChatUserManagementApi\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array of \RocketChatUserManagementApi\Model\PostApiV1RolesDelete200Response|\RocketChatUserManagementApi\Model\GetApiV1UsersSendWelcomeEmail400Response|\RocketChatUserManagementApi\Model\GetPermissionsListAll401Response, HTTP status code, HTTP response headers (array of strings)
     */
    public function getApiV1UsersSendWelcomeEmailWithHttpInfo($x_auth_token, $x_user_id, $get_api_v1_users_send_welcome_email_request = null, string $contentType = self::contentTypes['getApiV1UsersSendWelcomeEmail'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                ...
                case 400:
                    if ('\RocketChatUserManagementApi\Model\GetApiV1UsersSendWelcomeEmail400Response' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\RocketChatUserManagementApi\Model\GetApiV1UsersSendWelcomeEmail400Response' !== 'string') {
                            try {
                                $content = json_decode($content, false, 512, JSON_THROW_ON_ERROR);
                            } catch (\JsonException $exception) {
                                throw new ApiException(
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\RocketChatUserManagementApi\Model\GetApiV1UsersSendWelcomeEmail400Response', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                case 401:
            ...
            switch ($e->getCode()) {
                ...
                case 400:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\RocketChatUserManagementApi\Model\GetApiV1UsersSendWelcomeEmail400Response',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     * @param  string $x_auth_token The authenticated user token. (required)
     * @param  string $x_user_id The authenticated user ID. (required)
     * @param  \RocketChatUserManagementApi\Model\PostApiV1ModerationReportUserRequest $post_api_v1_moderation_report_user_request post_api_v1_moderation_report_user_request (optional)
     ...
     * @param  string $x_auth_token The authenticated user token. (required)
     * @param  string $x_user_id The authenticated user ID. (required)
     * @param  \RocketChatUserManagementApi\Model\PostApiV1ModerationReportUserRequest $post_api_v1_moderation_report_user_request (optional)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['postApiV1ModerationReportUser'] to see the possible values for this operation
     *
     * @throws \RocketChatUserManagementApi\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     ...
     * @throws \RocketChatUserManagementApi\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return \RocketChatUserManagementApi\Model\PostApiV1RolesDelete200Response|\RocketChatUserManagementApi\Model\PostApiV1UsersGeneratePersonalAccessToken400Response|\RocketChatUserManagementApi\Model\GetPermissionsListAll401Response
     */
     ...
     * @throws \RocketChatUserManagementApi\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array of \RocketChatUserManagementApi\Model\PostApiV1RolesDelete200Response|\RocketChatUserManagementApi\Model\PostApiV1UsersGeneratePersonalAccessToken400Response|\RocketChatUserManagementApi\Model\GetPermissionsListAll401Response, HTTP status code, HTTP response headers (array of strings)
     */
    public function postApiV1Users2faDisableEmailWithHttpInfo($x_auth_token, $x_user_id, $x_2fa_code, $x_2fa_method, string $contentType = self::contentTypes['postApiV1Users2faDisableEmail'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                ...
                case 400:
                    if ('\RocketChatUserManagementApi\Model\PostApiV1UsersGeneratePersonalAccessToken400Response' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\RocketChatUserManagementApi\Model\PostApiV1UsersGeneratePersonalAccessToken400Response' !== 'string') {
                            try {
                                $content = json_decode($content, false, 512, JSON_THROW_ON_ERROR);
                            } catch (\JsonException $exception) {
                                throw new ApiException(
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\RocketChatUserManagementApi\Model\PostApiV1UsersGeneratePersonalAccessToken400Response', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                case 401:
            ...
            switch ($e->getCode()) {
                ...
                case 400:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\RocketChatUserManagementApi\Model\PostApiV1UsersGeneratePersonalAccessToken400Response',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     * @throws \RocketChatUserManagementApi\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return \RocketChatUserManagementApi\Model\PostApiV1RolesDelete200Response|\RocketChatUserManagementApi\Model\GetPermissionsListAll401Response
     */
     ...
     * @throws \RocketChatUserManagementApi\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array of \RocketChatUserManagementApi\Model\PostApiV1RolesDelete200Response|\RocketChatUserManagementApi\Model\GetPermissionsListAll401Response, HTTP status code, HTTP response headers (array of strings)
     */
     ...
     * @param  string $x_auth_token The authenticated user token. (required)
     * @param  string $x_user_id The authenticated user ID. (required)
     * @param  \RocketChatUserManagementApi\Model\PostApiV1Users2faSendEmailCodeRequest $post_api_v1_users2fa_send_email_code_request post_api_v1_users2fa_send_email_code_request (optional)
     ...
     * @param  string $x_auth_token The authenticated user token. (required)
     * @param  string $x_user_id The authenticated user ID. (required)
     * @param  \RocketChatUserManagementApi\Model\PostApiV1Users2faSendEmailCodeRequest $post_api_v1_users2fa_send_email_code_request (optional)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['postApiV1Users2faSendEmailCode'] to see the possible values for this operation
     *
     * @throws \RocketChatUserManagementApi\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     ...
     * @param  string $x_user_id The authenticated user ID. (required)
     * @param  string $x_auth_token The authenticated user token. (required)
     * @param  \RocketChatUserManagementApi\Model\PostApiV1UsersCreateRequest $post_api_v1_users_create_request post_api_v1_users_create_request (optional)
     ...
     * @throws \RocketChatUserManagementApi\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return \RocketChatUserManagementApi\Model\PostApiV1UsersCreate200Response|\RocketChatUserManagementApi\Model\PostApiV1UsersCreate400Response|\RocketChatUserManagementApi\Model\GetPermissionsListAll401Response
     */
     ...
     * @param  string $x_user_id The authenticated user ID. (required)
     * @param  string $x_auth_token The authenticated user token. (required)
     * @param  \RocketChatUserManagementApi\Model\PostApiV1UsersCreateRequest $post_api_v1_users_create_request (optional)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['postApiV1UsersCreate'] to see the possible values for this operation
     *
     * @throws \RocketChatUserManagementApi\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array of \RocketChatUserManagementApi\Model\PostApiV1UsersCreate200Response|\RocketChatUserManagementApi\Model\PostApiV1UsersCreate400Response|\RocketChatUserManagementApi\Model\GetPermissionsListAll401Response, HTTP status code, HTTP response headers (array of strings)
     */
    public function postApiV1UsersCreateWithHttpInfo($x_user_id, $x_auth_token, $post_api_v1_users_create_request = null, string $contentType = self::contentTypes['postApiV1UsersCreate'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\RocketChatUserManagementApi\Model\PostApiV1UsersCreate200Response' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\RocketChatUserManagementApi\Model\PostApiV1UsersCreate200Response' !== 'string') {
                            try {
                                $content = json_decode($content, false, 512, JSON_THROW_ON_ERROR);
                            } catch (\JsonException $exception) {
                                throw new ApiException(
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\RocketChatUserManagementApi\Model\PostApiV1UsersCreate200Response', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                case 400:
                    if ('\RocketChatUserManagementApi\Model\PostApiV1UsersCreate400Response' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\RocketChatUserManagementApi\Model\PostApiV1UsersCreate400Response' !== 'string') {
                            try {
                                $content = json_decode($content, false, 512, JSON_THROW_ON_ERROR);
                            } catch (\JsonException $exception) {
                                throw new ApiException(
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\RocketChatUserManagementApi\Model\PostApiV1UsersCreate400Response', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                case 401:
            ...
            $returnType = '\RocketChatUserManagementApi\Model\PostApiV1UsersCreate200Response';
            if ($returnType === '\SplFileObject') {
                $content = $response->getBody(); //stream goes to serializer
            } else {
                $content = (string) $response->getBody();
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\RocketChatUserManagementApi\Model\PostApiV1UsersCreate200Response',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
                case 400:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\RocketChatUserManagementApi\Model\PostApiV1UsersCreate400Response',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     * @param  string $x_auth_token The authenticated user token. (required)
     * @param  string $x_user_id The authenticated user ID. (required)
     * @param  \RocketChatUserManagementApi\Model\PostApiV1UsersCreateTokenRequest $post_api_v1_users_create_token_request post_api_v1_users_create_token_request (optional)
     ...
     * @throws \RocketChatUserManagementApi\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return \RocketChatUserManagementApi\Model\PostApiV1UsersCreateToken200Response|\RocketChatUserManagementApi\Model\PostApiV1PermissionsUpdate400Response|\RocketChatUserManagementApi\Model\GetPermissionsListAll401Response
     * @deprecated
     */
     ...
     * @param  string $x_auth_token The authenticated user token. (required)
     * @param  string $x_user_id The authenticated user ID. (required)
     * @param  \RocketChatUserManagementApi\Model\PostApiV1UsersCreateTokenRequest $post_api_v1_users_create_token_request (optional)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['postApiV1UsersCreateToken'] to see the possible values for this operation
     *
     * @throws \RocketChatUserManagementApi\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array of \RocketChatUserManagementApi\Model\PostApiV1UsersCreateToken200Response|\RocketChatUserManagementApi\Model\PostApiV1PermissionsUpdate400Response|\RocketChatUserManagementApi\Model\GetPermissionsListAll401Response, HTTP status code, HTTP response headers (array of strings)
     * @deprecated
     */
    public function postApiV1UsersCreateTokenWithHttpInfo($x_auth_token, $x_user_id, $post_api_v1_users_create_token_request = null, string $contentType = self::contentTypes['postApiV1UsersCreateToken'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\RocketChatUserManagementApi\Model\PostApiV1UsersCreateToken200Response' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\RocketChatUserManagementApi\Model\PostApiV1UsersCreateToken200Response' !== 'string') {
                            try {
                                $content = json_decode($content, false, 512, JSON_THROW_ON_ERROR);
                            } catch (\JsonException $exception) {
                                throw new ApiException(
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\RocketChatUserManagementApi\Model\PostApiV1UsersCreateToken200Response', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                case 400:
            ...
            $returnType = '\RocketChatUserManagementApi\Model\PostApiV1UsersCreateToken200Response';
            if ($returnType === '\SplFileObject') {
                $content = $response->getBody(); //stream goes to serializer
            } else {
                $content = (string) $response->getBody();
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\RocketChatUserManagementApi\Model\PostApiV1UsersCreateToken200Response',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     * @param  string $x_user_id The authenticated user ID. (required)
     * @param  string $x_auth_token The authenticated user token. (required)
     * @param  \RocketChatUserManagementApi\Model\PostApiV1UsersDeactivateIdleRequest $post_api_v1_users_deactivate_idle_request post_api_v1_users_deactivate_idle_request (optional)
     ...
     * @throws \RocketChatUserManagementApi\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return \RocketChatUserManagementApi\Model\PostApiV1UsersDeactivateIdle200Response|\RocketChatUserManagementApi\Model\PostApiV1PermissionsUpdate400Response|\RocketChatUserManagementApi\Model\GetPermissionsListAll401Response|\RocketChatUserManagementApi\Model\GetApiV1RolesSync400Response
     */
     ...
     * @param  string $x_user_id The authenticated user ID. (required)
     * @param  string $x_auth_token The authenticated user token. (required)
     * @param  \RocketChatUserManagementApi\Model\PostApiV1UsersDeactivateIdleRequest $post_api_v1_users_deactivate_idle_request (optional)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['postApiV1UsersDeactivateIdle'] to see the possible values for this operation
     *
     * @throws \RocketChatUserManagementApi\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array of \RocketChatUserManagementApi\Model\PostApiV1UsersDeactivateIdle200Response|\RocketChatUserManagementApi\Model\PostApiV1PermissionsUpdate400Response|\RocketChatUserManagementApi\Model\GetPermissionsListAll401Response|\RocketChatUserManagementApi\Model\GetApiV1RolesSync400Response, HTTP status code, HTTP response headers (array of strings)
     */
    public function postApiV1UsersDeactivateIdleWithHttpInfo($x_user_id, $x_auth_token, $post_api_v1_users_deactivate_idle_request = null, string $contentType = self::contentTypes['postApiV1UsersDeactivateIdle'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\RocketChatUserManagementApi\Model\PostApiV1UsersDeactivateIdle200Response' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\RocketChatUserManagementApi\Model\PostApiV1UsersDeactivateIdle200Response' !== 'string') {
                            try {
                                $content = json_decode($content, false, 512, JSON_THROW_ON_ERROR);
                            } catch (\JsonException $exception) {
                                throw new ApiException(
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\RocketChatUserManagementApi\Model\PostApiV1UsersDeactivateIdle200Response', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                case 400:
            ...
            $returnType = '\RocketChatUserManagementApi\Model\PostApiV1UsersDeactivateIdle200Response';
            if ($returnType === '\SplFileObject') {
                $content = $response->getBody(); //stream goes to serializer
            } else {
                $content = (string) $response->getBody();
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\RocketChatUserManagementApi\Model\PostApiV1UsersDeactivateIdle200Response',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     * @param  string $x_auth_token The authenticated user token. (required)
     * @param  string $x_user_id The authenticated user ID. (required)
     * @param  \RocketChatUserManagementApi\Model\PostApiV1UsersDeleteRequest $post_api_v1_users_delete_request post_api_v1_users_delete_request (optional)
     ...
     * @throws \RocketChatUserManagementApi\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return \RocketChatUserManagementApi\Model\PostApiV1RolesDelete200Response|\RocketChatUserManagementApi\Model\PostApiV1PermissionsUpdate400Response|\RocketChatUserManagementApi\Model\GetPermissionsListAll401Response|\RocketChatUserManagementApi\Model\GetApiV1RolesSync400Response
     */
     ...
     * @param  string $x_auth_token The authenticated user token. (required)
     * @param  string $x_user_id The authenticated user ID. (required)
     * @param  \RocketChatUserManagementApi\Model\PostApiV1UsersDeleteRequest $post_api_v1_users_delete_request (optional)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['postApiV1UsersDelete'] to see the possible values for this operation
     *
     * @throws \RocketChatUserManagementApi\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array of \RocketChatUserManagementApi\Model\PostApiV1RolesDelete200Response|\RocketChatUserManagementApi\Model\PostApiV1PermissionsUpdate400Response|\RocketChatUserManagementApi\Model\GetPermissionsListAll401Response|\RocketChatUserManagementApi\Model\GetApiV1RolesSync400Response, HTTP status code, HTTP response headers (array of strings)
     */
     ...
     * @param  string $x_auth_token The authenticated user token. (required)
     * @param  string $x_user_id The authenticated user ID. (required)
     * @param  \RocketChatUserManagementApi\Model\PostApiV1UsersDeleteOwnAccountRequest $post_api_v1_users_delete_own_account_request post_api_v1_users_delete_own_account_request (optional)
     ...
     * @throws \RocketChatUserManagementApi\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return \RocketChatUserManagementApi\Model\PostApiV1RolesDelete200Response|\RocketChatUserManagementApi\Model\GetApiV1RolesSync400Response|\RocketChatUserManagementApi\Model\GetPermissionsListAll401Response
     */
     ...
     * @param  string $x_auth_token The authenticated user token. (required)
     * @param  string $x_user_id The authenticated user ID. (required)
     * @param  \RocketChatUserManagementApi\Model\PostApiV1UsersDeleteOwnAccountRequest $post_api_v1_users_delete_own_account_request (optional)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['postApiV1UsersDeleteOwnAccount'] to see the possible values for this operation
     *
     * @throws \RocketChatUserManagementApi\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array of \RocketChatUserManagementApi\Model\PostApiV1RolesDelete200Response|\RocketChatUserManagementApi\Model\GetApiV1RolesSync400Response|\RocketChatUserManagementApi\Model\GetPermissionsListAll401Response, HTTP status code, HTTP response headers (array of strings)
     */
     ...
     * Forgot Password
     *
     * @param  \RocketChatUserManagementApi\Model\PostApiV1UsersForgotPasswordRequest $post_api_v1_users_forgot_password_request post_api_v1_users_forgot_password_request (optional)
     ...
     * @throws \RocketChatUserManagementApi\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return \RocketChatUserManagementApi\Model\PostApiV1UsersForgotPassword200Response|\RocketChatUserManagementApi\Model\GetApiV1RolesSync400Response
     */
     ...
     * Forgot Password
     *
     * @param  \RocketChatUserManagementApi\Model\PostApiV1UsersForgotPasswordRequest $post_api_v1_users_forgot_password_request (optional)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['postApiV1UsersForgotPassword'] to see the possible values for this operation
     *
     * @throws \RocketChatUserManagementApi\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array of \RocketChatUserManagementApi\Model\PostApiV1UsersForgotPassword200Response|\RocketChatUserManagementApi\Model\GetApiV1RolesSync400Response, HTTP status code, HTTP response headers (array of strings)
     */
    public function postApiV1UsersForgotPasswordWithHttpInfo($post_api_v1_users_forgot_password_request = null, string $contentType = self::contentTypes['postApiV1UsersForgotPassword'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\RocketChatUserManagementApi\Model\PostApiV1UsersForgotPassword200Response' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\RocketChatUserManagementApi\Model\PostApiV1UsersForgotPassword200Response' !== 'string') {
                            try {
                                $content = json_decode($content, false, 512, JSON_THROW_ON_ERROR);
                            } catch (\JsonException $exception) {
                                throw new ApiException(
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\RocketChatUserManagementApi\Model\PostApiV1UsersForgotPassword200Response', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                case 400:
            ...
            $returnType = '\RocketChatUserManagementApi\Model\PostApiV1UsersForgotPassword200Response';
            if ($returnType === '\SplFileObject') {
                $content = $response->getBody(); //stream goes to serializer
            } else {
                $content = (string) $response->getBody();
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\RocketChatUserManagementApi\Model\PostApiV1UsersForgotPassword200Response',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     * @param  string $x_2fa_code The 2fa code. See &lt;a href&#x3D;\&quot;https://developer.rocket.chat/apidocs/introduction-to-two-factor-authentication\&quot; target&#x3D;\&quot;_blank\&quot;&gt;Introduction to Two-Factor Authentication&lt;/a&gt;. (required)
     * @param  string $x_2fa_method The desired method to get the 2FA code. It can be &#x60;email&#x60;, &#x60;totp&#x60;, or &#x60;password&#x60;. (required)
     * @param  \RocketChatUserManagementApi\Model\PostApiV1UsersGeneratePersonalAccessTokenRequest $post_api_v1_users_generate_personal_access_token_request post_api_v1_users_generate_personal_access_token_request (optional)
     ...
     * @throws \RocketChatUserManagementApi\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return \RocketChatUserManagementApi\Model\PostApiV1UsersGeneratePersonalAccessToken200Response|\RocketChatUserManagementApi\Model\PostApiV1UsersGeneratePersonalAccessToken400Response|\RocketChatUserManagementApi\Model\GetPermissionsListAll401Response
     */
     ...
     * @param  string $x_2fa_code The 2fa code. See &lt;a href&#x3D;\&quot;https://developer.rocket.chat/apidocs/introduction-to-two-factor-authentication\&quot; target&#x3D;\&quot;_blank\&quot;&gt;Introduction to Two-Factor Authentication&lt;/a&gt;. (required)
     * @param  string $x_2fa_method The desired method to get the 2FA code. It can be &#x60;email&#x60;, &#x60;totp&#x60;, or &#x60;password&#x60;. (required)
     * @param  \RocketChatUserManagementApi\Model\PostApiV1UsersGeneratePersonalAccessTokenRequest $post_api_v1_users_generate_personal_access_token_request (optional)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['postApiV1UsersGeneratePersonalAccessToken'] to see the possible values for this operation
     *
     * @throws \RocketChatUserManagementApi\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array of \RocketChatUserManagementApi\Model\PostApiV1UsersGeneratePersonalAccessToken200Response|\RocketChatUserManagementApi\Model\PostApiV1UsersGeneratePersonalAccessToken400Response|\RocketChatUserManagementApi\Model\GetPermissionsListAll401Response, HTTP status code, HTTP response headers (array of strings)
     */
    public function postApiV1UsersGeneratePersonalAccessTokenWithHttpInfo($x_auth_token, $x_user_id, $x_2fa_code, $x_2fa_method, $post_api_v1_users_generate_personal_access_token_request = null, string $contentType = self::contentTypes['postApiV1UsersGeneratePersonalAccessToken'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\RocketChatUserManagementApi\Model\PostApiV1UsersGeneratePersonalAccessToken200Response' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\RocketChatUserManagementApi\Model\PostApiV1UsersGeneratePersonalAccessToken200Response' !== 'string') {
                            try {
                                $content = json_decode($content, false, 512, JSON_THROW_ON_ERROR);
                            } catch (\JsonException $exception) {
                                throw new ApiException(
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\RocketChatUserManagementApi\Model\PostApiV1UsersGeneratePersonalAccessToken200Response', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                case 400:
            ...
            $returnType = '\RocketChatUserManagementApi\Model\PostApiV1UsersGeneratePersonalAccessToken200Response';
            if ($returnType === '\SplFileObject') {
                $content = $response->getBody(); //stream goes to serializer
            } else {
                $content = (string) $response->getBody();
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\RocketChatUserManagementApi\Model\PostApiV1UsersGeneratePersonalAccessToken200Response',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     * @throws \RocketChatUserManagementApi\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return \RocketChatUserManagementApi\Model\PostApiV1UsersLogoutOtherClients200Response|\RocketChatUserManagementApi\Model\GetPermissionsListAll401Response
     */
     ...
     * @throws \RocketChatUserManagementApi\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array of \RocketChatUserManagementApi\Model\PostApiV1UsersLogoutOtherClients200Response|\RocketChatUserManagementApi\Model\GetPermissionsListAll401Response, HTTP status code, HTTP response headers (array of strings)
     */
    public function postApiV1UsersLogoutOtherClientsWithHttpInfo($x_auth_token, $x_user_id, string $contentType = self::contentTypes['postApiV1UsersLogoutOtherClients'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\RocketChatUserManagementApi\Model\PostApiV1UsersLogoutOtherClients200Response' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\RocketChatUserManagementApi\Model\PostApiV1UsersLogoutOtherClients200Response' !== 'string') {
                            try {
                                $content = json_decode($content, false, 512, JSON_THROW_ON_ERROR);
                            } catch (\JsonException $exception) {
                                throw new ApiException(
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\RocketChatUserManagementApi\Model\PostApiV1UsersLogoutOtherClients200Response', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                case 401:
            ...
            $returnType = '\RocketChatUserManagementApi\Model\PostApiV1UsersLogoutOtherClients200Response';
            if ($returnType === '\SplFileObject') {
                $content = $response->getBody(); //stream goes to serializer
            } else {
                $content = (string) $response->getBody();
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\RocketChatUserManagementApi\Model\PostApiV1UsersLogoutOtherClients200Response',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     * @param  string $x_2fa_code The 2fa code. See &lt;a href&#x3D;\&quot;https://developer.rocket.chat/apidocs/introduction-to-two-factor-authentication\&quot; target&#x3D;\&quot;_blank\&quot;&gt;Introduction to Two-Factor Authentication&lt;/a&gt;. (required)
     * @param  string $x_2fa_method The desired method to get the 2FA code. It can be &#x60;email&#x60;, &#x60;totp&#x60;, or &#x60;password&#x60;. (required)
     * @param  \RocketChatUserManagementApi\Model\PostApiV1UsersRegeneratePersonalAccessTokenRequest $post_api_v1_users_regenerate_personal_access_token_request post_api_v1_users_regenerate_personal_access_token_request (optional)
     ...
     * @param  string $x_2fa_code The 2fa code. See &lt;a href&#x3D;\&quot;https://developer.rocket.chat/apidocs/introduction-to-two-factor-authentication\&quot; target&#x3D;\&quot;_blank\&quot;&gt;Introduction to Two-Factor Authentication&lt;/a&gt;. (required)
     * @param  string $x_2fa_method The desired method to get the 2FA code. It can be &#x60;email&#x60;, &#x60;totp&#x60;, or &#x60;password&#x60;. (required)
     * @param  \RocketChatUserManagementApi\Model\PostApiV1UsersRegeneratePersonalAccessTokenRequest $post_api_v1_users_regenerate_personal_access_token_request (optional)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['postApiV1UsersRegeneratePersonalAccessToken'] to see the possible values for this operation
     *
     * @throws \RocketChatUserManagementApi\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     ...
     * Register User
     *
     * @param  \RocketChatUserManagementApi\Model\PostApiV1UsersRegisterRequest $post_api_v1_users_register_request post_api_v1_users_register_request (optional)
     ...
     * @throws \RocketChatUserManagementApi\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return \RocketChatUserManagementApi\Model\PostApiV1UsersRegister200Response
     */
     ...
     * Register User
     *
     * @param  \RocketChatUserManagementApi\Model\PostApiV1UsersRegisterRequest $post_api_v1_users_register_request (optional)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['postApiV1UsersRegister'] to see the possible values for this operation
     *
     * @throws \RocketChatUserManagementApi\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array of \RocketChatUserManagementApi\Model\PostApiV1UsersRegister200Response, HTTP status code, HTTP response headers (array of strings)
     */
    public function postApiV1UsersRegisterWithHttpInfo($post_api_v1_users_register_request = null, string $contentType = self::contentTypes['postApiV1UsersRegister'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\RocketChatUserManagementApi\Model\PostApiV1UsersRegister200Response' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\RocketChatUserManagementApi\Model\PostApiV1UsersRegister200Response' !== 'string') {
                            try {
                                $content = json_decode($content, false, 512, JSON_THROW_ON_ERROR);
                            } catch (\JsonException $exception) {
                                throw new ApiException(
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\RocketChatUserManagementApi\Model\PostApiV1UsersRegister200Response', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
            }

            $returnType = '\RocketChatUserManagementApi\Model\PostApiV1UsersRegister200Response';
            if ($returnType === '\SplFileObject') {
                $content = $response->getBody(); //stream goes to serializer
            } else {
                $content = (string) $response->getBody();
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\RocketChatUserManagementApi\Model\PostApiV1UsersRegister200Response',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     * @param  string $x_user_id The authenticated user ID. (required)
     * @param  string $x_auth_token The authenticated user token. (required)
     * @param  \RocketChatUserManagementApi\Model\PostApiV1UsersResetAvatarRequest $post_api_v1_users_reset_avatar_request post_api_v1_users_reset_avatar_request (optional)
     ...
     * @param  string $x_user_id The authenticated user ID. (required)
     * @param  string $x_auth_token The authenticated user token. (required)
     * @param  \RocketChatUserManagementApi\Model\PostApiV1UsersResetAvatarRequest $post_api_v1_users_reset_avatar_request (optional)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['postApiV1UsersResetAvatar'] to see the possible values for this operation
     *
     * @throws \RocketChatUserManagementApi\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     ...
     * @param  string $x_2fa_code The 2fa code. See &lt;a href&#x3D;\&quot;https://developer.rocket.chat/apidocs/introduction-to-two-factor-authentication\&quot; target&#x3D;\&quot;_blank\&quot;&gt;Introduction to Two-Factor Authentication&lt;/a&gt;. (required)
     * @param  string $x_2fa_method The desired method to get the 2FA code. It can be &#x60;email&#x60;, &#x60;totp&#x60;, or &#x60;password&#x60;. (required)
     * @param  \RocketChatUserManagementApi\Model\PostApiV1UsersResetE2EKeyRequest $post_api_v1_users_reset_e2_e_key_request post_api_v1_users_reset_e2_e_key_request (optional)
     ...
     * @param  string $x_2fa_code The 2fa code. See &lt;a href&#x3D;\&quot;https://developer.rocket.chat/apidocs/introduction-to-two-factor-authentication\&quot; target&#x3D;\&quot;_blank\&quot;&gt;Introduction to Two-Factor Authentication&lt;/a&gt;. (required)
     * @param  string $x_2fa_method The desired method to get the 2FA code. It can be &#x60;email&#x60;, &#x60;totp&#x60;, or &#x60;password&#x60;. (required)
     * @param  \RocketChatUserManagementApi\Model\PostApiV1UsersResetE2EKeyRequest $post_api_v1_users_reset_e2_e_key_request (optional)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['postApiV1UsersResetE2EKey'] to see the possible values for this operation
     *
     * @throws \RocketChatUserManagementApi\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     ...
     * @param  string $x_2fa_code The 2fa code. See &lt;a href&#x3D;\&quot;https://developer.rocket.chat/apidocs/introduction-to-two-factor-authentication\&quot; target&#x3D;\&quot;_blank\&quot;&gt;Introduction to Two-Factor Authentication&lt;/a&gt;. (required)
     * @param  string $x_2fa_method The desired method to get the 2FA code. It can be &#x60;email&#x60;, &#x60;totp&#x60;, or &#x60;password&#x60;. (required)
     * @param  \RocketChatUserManagementApi\Model\PostApiV1UsersResetTOTPRequest $post_api_v1_users_reset_totp_request post_api_v1_users_reset_totp_request (optional)
     ...
     * @param  string $x_2fa_code The 2fa code. See &lt;a href&#x3D;\&quot;https://developer.rocket.chat/apidocs/introduction-to-two-factor-authentication\&quot; target&#x3D;\&quot;_blank\&quot;&gt;Introduction to Two-Factor Authentication&lt;/a&gt;. (required)
     * @param  string $x_2fa_method The desired method to get the 2FA code. It can be &#x60;email&#x60;, &#x60;totp&#x60;, or &#x60;password&#x60;. (required)
     * @param  \RocketChatUserManagementApi\Model\PostApiV1UsersResetTOTPRequest $post_api_v1_users_reset_totp_request (optional)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['postApiV1UsersResetTOTP'] to see the possible values for this operation
     *
     * @throws \RocketChatUserManagementApi\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     ...
     * @param  string $x_user_id The authenticated user ID. (required)
     * @param  string $x_auth_token The authenticated user token. (required)
     * @param  \RocketChatUserManagementApi\Model\PostApiV1UsersSetActiveStatusRequest $post_api_v1_users_set_active_status_request If &#x60;activeStatus&#x3D;false&#x60; &amp; &#x60;confirmRelinquish&#x3D;true&#x60; and the user is the last remaining owner of a room, the oldest member of that room will be chosen as the new owner. (optional)
     ...
     * @throws \RocketChatUserManagementApi\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return \RocketChatUserManagementApi\Model\PostApiV1UsersSetActiveStatus200Response|\RocketChatUserManagementApi\Model\PostApiV1PermissionsUpdate400Response|\RocketChatUserManagementApi\Model\GetPermissionsListAll401Response
     */
     ...
     * @throws \RocketChatUserManagementApi\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array of \RocketChatUserManagementApi\Model\PostApiV1UsersSetActiveStatus200Response|\RocketChatUserManagementApi\Model\PostApiV1PermissionsUpdate400Response|\RocketChatUserManagementApi\Model\GetPermissionsListAll401Response, HTTP status code, HTTP response headers (array of strings)
     */
    public function postApiV1UsersSetActiveStatusWithHttpInfo($x_user_id, $x_auth_token, $post_api_v1_users_set_active_status_request = null, string $contentType = self::contentTypes['postApiV1UsersSetActiveStatus'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\RocketChatUserManagementApi\Model\PostApiV1UsersSetActiveStatus200Response' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\RocketChatUserManagementApi\Model\PostApiV1UsersSetActiveStatus200Response' !== 'string') {
                            try {
                                $content = json_decode($content, false, 512, JSON_THROW_ON_ERROR);
                            } catch (\JsonException $exception) {
                                throw new ApiException(
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\RocketChatUserManagementApi\Model\PostApiV1UsersSetActiveStatus200Response', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                case 400:
            ...
            $returnType = '\RocketChatUserManagementApi\Model\PostApiV1UsersSetActiveStatus200Response';
            if ($returnType === '\SplFileObject') {
                $content = $response->getBody(); //stream goes to serializer
            } else {
                $content = (string) $response->getBody();
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\RocketChatUserManagementApi\Model\PostApiV1UsersSetActiveStatus200Response',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     * @param  string $x_user_id The authenticated user ID. (required)
     * @param  string $x_auth_token The authenticated user token. (required)
     * @param  \RocketChatUserManagementApi\Model\PostApiV1UsersSetPreferencesRequest $post_api_v1_users_set_preferences_request post_api_v1_users_set_preferences_request (optional)
     ...
     * @throws \RocketChatUserManagementApi\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return \RocketChatUserManagementApi\Model\PostApiV1UsersSetPreferences200Response|\RocketChatUserManagementApi\Model\PostApiV1PermissionsUpdate400Response|\RocketChatUserManagementApi\Model\GetPermissionsListAll401Response
     */
     ...
     * @param  string $x_user_id The authenticated user ID. (required)
     * @param  string $x_auth_token The authenticated user token. (required)
     * @param  \RocketChatUserManagementApi\Model\PostApiV1UsersSetPreferencesRequest $post_api_v1_users_set_preferences_request (optional)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['postApiV1UsersSetPreferences'] to see the possible values for this operation
     *
     * @throws \RocketChatUserManagementApi\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array of \RocketChatUserManagementApi\Model\PostApiV1UsersSetPreferences200Response|\RocketChatUserManagementApi\Model\PostApiV1PermissionsUpdate400Response|\RocketChatUserManagementApi\Model\GetPermissionsListAll401Response, HTTP status code, HTTP response headers (array of strings)
     */
    public function postApiV1UsersSetPreferencesWithHttpInfo($x_user_id, $x_auth_token, $post_api_v1_users_set_preferences_request = null, string $contentType = self::contentTypes['postApiV1UsersSetPreferences'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\RocketChatUserManagementApi\Model\PostApiV1UsersSetPreferences200Response' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\RocketChatUserManagementApi\Model\PostApiV1UsersSetPreferences200Response' !== 'string') {
                            try {
                                $content = json_decode($content, false, 512, JSON_THROW_ON_ERROR);
                            } catch (\JsonException $exception) {
                                throw new ApiException(
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\RocketChatUserManagementApi\Model\PostApiV1UsersSetPreferences200Response', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                case 400:
            ...
            $returnType = '\RocketChatUserManagementApi\Model\PostApiV1UsersSetPreferences200Response';
            if ($returnType === '\SplFileObject') {
                $content = $response->getBody(); //stream goes to serializer
            } else {
                $content = (string) $response->getBody();
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\RocketChatUserManagementApi\Model\PostApiV1UsersSetPreferences200Response',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     * @param  string $x_user_id The authenticated user ID. (required)
     * @param  string $x_auth_token The authenticated user token. (required)
     * @param  \RocketChatUserManagementApi\Model\PostApiV1UsersSetStatusRequest $post_api_v1_users_set_status_request post_api_v1_users_set_status_request (optional)
     ...
     * @param  string $x_user_id The authenticated user ID. (required)
     * @param  string $x_auth_token The authenticated user token. (required)
     * @param  \RocketChatUserManagementApi\Model\PostApiV1UsersSetStatusRequest $post_api_v1_users_set_status_request (optional)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['postApiV1UsersSetStatus'] to see the possible values for this operation
     *
     * @throws \RocketChatUserManagementApi\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     ...
     * @param  string $x_2fa_code The 2fa code. See &lt;a href&#x3D;\&quot;https://developer.rocket.chat/apidocs/introduction-to-two-factor-authentication\&quot; target&#x3D;\&quot;_blank\&quot;&gt;Introduction to Two-Factor Authentication&lt;/a&gt;. (required)
     * @param  string $x_2fa_method The desired method to get the 2FA code. It can be &#x60;email&#x60;, &#x60;totp&#x60;, or &#x60;password&#x60;. (required)
     * @param  \RocketChatUserManagementApi\Model\PostApiV1UsersUpdateRequest $post_api_v1_users_update_request post_api_v1_users_update_request (optional)
     ...
     * @throws \RocketChatUserManagementApi\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return \RocketChatUserManagementApi\Model\PostApiV1UsersUpdate200Response|\RocketChatUserManagementApi\Model\PostApiV1UsersCreate400Response|\RocketChatUserManagementApi\Model\GetPermissionsListAll401Response
     */
     ...
     * @param  string $x_2fa_code The 2fa code. See &lt;a href&#x3D;\&quot;https://developer.rocket.chat/apidocs/introduction-to-two-factor-authentication\&quot; target&#x3D;\&quot;_blank\&quot;&gt;Introduction to Two-Factor Authentication&lt;/a&gt;. (required)
     * @param  string $x_2fa_method The desired method to get the 2FA code. It can be &#x60;email&#x60;, &#x60;totp&#x60;, or &#x60;password&#x60;. (required)
     * @param  \RocketChatUserManagementApi\Model\PostApiV1UsersUpdateRequest $post_api_v1_users_update_request (optional)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['postApiV1UsersUpdate'] to see the possible values for this operation
     *
     * @throws \RocketChatUserManagementApi\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array of \RocketChatUserManagementApi\Model\PostApiV1UsersUpdate200Response|\RocketChatUserManagementApi\Model\PostApiV1UsersCreate400Response|\RocketChatUserManagementApi\Model\GetPermissionsListAll401Response, HTTP status code, HTTP response headers (array of strings)
     */
    public function postApiV1UsersUpdateWithHttpInfo($x_user_id, $x_auth_token, $x_2fa_code, $x_2fa_method, $post_api_v1_users_update_request = null, string $contentType = self::contentTypes['postApiV1UsersUpdate'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\RocketChatUserManagementApi\Model\PostApiV1UsersUpdate200Response' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\RocketChatUserManagementApi\Model\PostApiV1UsersUpdate200Response' !== 'string') {
                            try {
                                $content = json_decode($content, false, 512, JSON_THROW_ON_ERROR);
                            } catch (\JsonException $exception) {
                                throw new ApiException(
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\RocketChatUserManagementApi\Model\PostApiV1UsersUpdate200Response', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                case 400:
            ...
            $returnType = '\RocketChatUserManagementApi\Model\PostApiV1UsersUpdate200Response';
            if ($returnType === '\SplFileObject') {
                $content = $response->getBody(); //stream goes to serializer
            } else {
                $content = (string) $response->getBody();
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\RocketChatUserManagementApi\Model\PostApiV1UsersUpdate200Response',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     * @param  string $x_2fa_code The 2fa code. See &lt;a href&#x3D;\&quot;https://developer.rocket.chat/apidocs/introduction-to-two-factor-authentication\&quot; target&#x3D;\&quot;_blank\&quot;&gt;Introduction to Two-Factor Authentication&lt;/a&gt;. (required)
     * @param  string $x_2fa_method The desired method to get the 2FA code. It can be &#x60;email&#x60;, &#x60;totp&#x60;, or &#x60;password&#x60;. (required)
     * @param  \RocketChatUserManagementApi\Model\PostApiV1UsersUpdateOwnBasicInfoRequest $post_api_v1_users_update_own_basic_info_request post_api_v1_users_update_own_basic_info_request (optional)
     ...
     * @throws \RocketChatUserManagementApi\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return \RocketChatUserManagementApi\Model\PostApiV1UsersUpdateOwnBasicInfo200Response|\RocketChatUserManagementApi\Model\GetPermissionsListAll401Response
     */
     ...
     * @param  string $x_2fa_code The 2fa code. See &lt;a href&#x3D;\&quot;https://developer.rocket.chat/apidocs/introduction-to-two-factor-authentication\&quot; target&#x3D;\&quot;_blank\&quot;&gt;Introduction to Two-Factor Authentication&lt;/a&gt;. (required)
     * @param  string $x_2fa_method The desired method to get the 2FA code. It can be &#x60;email&#x60;, &#x60;totp&#x60;, or &#x60;password&#x60;. (required)
     * @param  \RocketChatUserManagementApi\Model\PostApiV1UsersUpdateOwnBasicInfoRequest $post_api_v1_users_update_own_basic_info_request (optional)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['postApiV1UsersUpdateOwnBasicInfo'] to see the possible values for this operation
     *
     * @throws \RocketChatUserManagementApi\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array of \RocketChatUserManagementApi\Model\PostApiV1UsersUpdateOwnBasicInfo200Response|\RocketChatUserManagementApi\Model\GetPermissionsListAll401Response, HTTP status code, HTTP response headers (array of strings)
     */
    public function postApiV1UsersUpdateOwnBasicInfoWithHttpInfo($x_user_id, $x_auth_token, $x_2fa_code, $x_2fa_method, $post_api_v1_users_update_own_basic_info_request = null, string $contentType = self::contentTypes['postApiV1UsersUpdateOwnBasicInfo'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\RocketChatUserManagementApi\Model\PostApiV1UsersUpdateOwnBasicInfo200Response' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\RocketChatUserManagementApi\Model\PostApiV1UsersUpdateOwnBasicInfo200Response' !== 'string') {
                            try {
                                $content = json_decode($content, false, 512, JSON_THROW_ON_ERROR);
                            } catch (\JsonException $exception) {
                                throw new ApiException(
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\RocketChatUserManagementApi\Model\PostApiV1UsersUpdateOwnBasicInfo200Response', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                case 401:
            ...
            $returnType = '\RocketChatUserManagementApi\Model\PostApiV1UsersUpdateOwnBasicInfo200Response';
            if ($returnType === '\SplFileObject') {
                $content = $response->getBody(); //stream goes to serializer
            } else {
                $content = (string) $response->getBody();
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\RocketChatUserManagementApi\Model\PostApiV1UsersUpdateOwnBasicInfo200Response',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
