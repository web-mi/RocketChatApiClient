...
class UsersApi
{
     ...
     * @param  string|null $format Format of the image requested.  The values can be one of: jpg, jpeg, png. (optional)
     * @param  int|null $size Width and height of the image. Default: 200 (optional)
     * @param  string|null $rc_uid User ID for authenticating is only required if &#x60;Accounts_AvatarBlockUnauthenticatedAccess&#x60; is enabled. (optional)
     * @param  string|null $rc_token User auth token for authenticating is only required if &#x60;Accounts_AvatarBlockUnauthenticatedAccess&#x60; is enabled. (optional)
     ...
     * @param  string $x_user_id The authenticated user ID. (required)
     * @param  string $x_auth_token The authenticated user token. (required)
     * @param  string|null $user_id The user ID. Alternatively, you can enter the &#x60;username&#x60; parameter. If not provided, the user who sending the request is retrieved. (optional)
     ...
     * Get Status
     *
     * @param  string|null $user_id The &#x60;userId&#x60; of the user. Alternatively, you can use the &#x60;username&#x60; property and value. If the value is not provided, the authenticated user is used. (optional)
     ...
     * @param  string $x_auth_token The authenticated user token. (required)
     * @param  string $x_user_id The authenticated user ID. (required)
     * @param  mixed|null $query This parameter allows you to use [MongoDB query](https://www.mongodb.com/docs/manual/reference/operator/query/) operators to search for specific data. For example, to query users with a name that contains the letter \&quot;g\&quot;: query&#x3D;{ \&quot;name\&quot;: { \&quot;$regex\&quot;: \&quot;g\&quot; } } (optional)
     * @param  mixed|null $fields This parameter accepts a JSON object with properties that have a value of 1 or 0 to include or exclude them in the response. For example, to only retrieve the usernames of users: fields&#x3D;{ \&quot;username\&quot;: 1 } (optional)
     ...
     * @param  mixed|null $sort List of fields to order by, and in which direction. JSON object, with properties listed in desired order, with values of 1 for ascending, or -1 for descending. For example, {\&quot;value\&quot;: -1, \&quot;_id\&quot;: 1} (optional)
     ...
     * @param  mixed|null $sort List of fields to order by, and in which direction. JSON object, with properties listed in desired order, with values of 1 for ascending, or -1 for descending. For example, {\&quot;value\&quot;: -1, \&quot;_id\&quot;: 1} (optional)
     * @param  int|null $count How many items to return. (optional)
     * @param  string|null $status Filter users based on their activation status. It can either  be &#x60;active&#x60; or &#x60;deactivated&#x60; (optional)
     * @param  bool|null $has_logged_in Filter the users who have logged into their accounts for the first time. (optional)
     * @param  string|null $type Filter the type of users to be returned. For example, &#39;bot&#39;, &#39;user&#39;, &#39;app&#39;, etc. (optional)
     * @param  string|null $roles Filter the users returned based on a list of roles. (optional)
     * @param  string|null $search_term Filter the list of users returned based on a search term (optional)
     ...
     * @param  string $x_user_id The authenticated user ID. (required)
     * @param  string $x_auth_token The authenticated user token. (required)
     * @param  string|null $from The last date when the status was changed. Format: ISO 8601 datetime. Timezone, milliseconds and seconds are optional. If you don&#39;t pass &#x60;from&#x60; parameter, you&#39;ll get a list of all users&#39; presence and the result will have a &#x60;full&#x60; field with value &#x60;true&#x60; . (optional)
     * @param  string|null $ids The user IDs whose status you want. (optional)
     ...
     * @param  string $x_auth_token The authenticated user token. (required)
     * @param  string $x_user_id The authenticated user ID. (required)
     * @param  bool|null $full_export Whether you want a full export or not. By default, the value is false. (optional, default to false)
     ...
     * @param  string $x_auth_token The authenticated user token. (required)
     * @param  string $x_user_id The authenticated user ID. (required)
     * @param  \WebMI\RocketChatApiClient\UserManagementApi\Model\GetApiV1UsersSendWelcomeEmailRequest|null $get_api_v1_users_send_welcome_email_request get_api_v1_users_send_welcome_email_request (optional)
     ...
     * @param  string $x_auth_token The authenticated user token. (required)
     * @param  string $x_user_id The authenticated user ID. (required)
     * @param  \WebMI\RocketChatApiClient\UserManagementApi\Model\GetApiV1UsersSendWelcomeEmailRequest|null $get_api_v1_users_send_welcome_email_request (optional)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['getApiV1UsersSendWelcomeEmail'] to see the possible values for this operation
     *
     * @throws \WebMI\RocketChatApiClient\UserManagementApi\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     ...
     * @param  string $x_auth_token The authenticated user token. (required)
     * @param  string $x_user_id The authenticated user ID. (required)
     * @param  \WebMI\RocketChatApiClient\UserManagementApi\Model\PostApiV1ModerationReportUserRequest|null $post_api_v1_moderation_report_user_request post_api_v1_moderation_report_user_request (optional)
     ...
     * @param  string $x_auth_token The authenticated user token. (required)
     * @param  string $x_user_id The authenticated user ID. (required)
     * @param  \WebMI\RocketChatApiClient\UserManagementApi\Model\PostApiV1ModerationReportUserRequest|null $post_api_v1_moderation_report_user_request (optional)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['postApiV1ModerationReportUser'] to see the possible values for this operation
     *
     * @throws \WebMI\RocketChatApiClient\UserManagementApi\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     ...
     * @param  string $x_auth_token The authenticated user token. (required)
     * @param  string $x_user_id The authenticated user ID. (required)
     * @param  \WebMI\RocketChatApiClient\UserManagementApi\Model\PostApiV1Users2faSendEmailCodeRequest|null $post_api_v1_users2fa_send_email_code_request post_api_v1_users2fa_send_email_code_request (optional)
     ...
     * @param  string $x_auth_token The authenticated user token. (required)
     * @param  string $x_user_id The authenticated user ID. (required)
     * @param  \WebMI\RocketChatApiClient\UserManagementApi\Model\PostApiV1Users2faSendEmailCodeRequest|null $post_api_v1_users2fa_send_email_code_request (optional)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['postApiV1Users2faSendEmailCode'] to see the possible values for this operation
     *
     * @throws \WebMI\RocketChatApiClient\UserManagementApi\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     ...
     * @param  string $x_user_id The authenticated user ID. (required)
     * @param  string $x_auth_token The authenticated user token. (required)
     * @param  \WebMI\RocketChatApiClient\UserManagementApi\Model\PostApiV1UsersCreateRequest|null $post_api_v1_users_create_request post_api_v1_users_create_request (optional)
     ...
     * @param  string $x_user_id The authenticated user ID. (required)
     * @param  string $x_auth_token The authenticated user token. (required)
     * @param  \WebMI\RocketChatApiClient\UserManagementApi\Model\PostApiV1UsersCreateRequest|null $post_api_v1_users_create_request (optional)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['postApiV1UsersCreate'] to see the possible values for this operation
     *
     * @throws \WebMI\RocketChatApiClient\UserManagementApi\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     ...
     * @param  string $x_auth_token The authenticated user token. (required)
     * @param  string $x_user_id The authenticated user ID. (required)
     * @param  \WebMI\RocketChatApiClient\UserManagementApi\Model\PostApiV1UsersCreateTokenRequest|null $post_api_v1_users_create_token_request post_api_v1_users_create_token_request (optional)
     ...
     * @param  string $x_auth_token The authenticated user token. (required)
     * @param  string $x_user_id The authenticated user ID. (required)
     * @param  \WebMI\RocketChatApiClient\UserManagementApi\Model\PostApiV1UsersCreateTokenRequest|null $post_api_v1_users_create_token_request (optional)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['postApiV1UsersCreateToken'] to see the possible values for this operation
     *
     * @throws \WebMI\RocketChatApiClient\UserManagementApi\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     ...
     * @param  string $x_user_id The authenticated user ID. (required)
     * @param  string $x_auth_token The authenticated user token. (required)
     * @param  \WebMI\RocketChatApiClient\UserManagementApi\Model\PostApiV1UsersDeactivateIdleRequest|null $post_api_v1_users_deactivate_idle_request post_api_v1_users_deactivate_idle_request (optional)
     ...
     * @param  string $x_user_id The authenticated user ID. (required)
     * @param  string $x_auth_token The authenticated user token. (required)
     * @param  \WebMI\RocketChatApiClient\UserManagementApi\Model\PostApiV1UsersDeactivateIdleRequest|null $post_api_v1_users_deactivate_idle_request (optional)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['postApiV1UsersDeactivateIdle'] to see the possible values for this operation
     *
     * @throws \WebMI\RocketChatApiClient\UserManagementApi\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     ...
     * @param  string $x_auth_token The authenticated user token. (required)
     * @param  string $x_user_id The authenticated user ID. (required)
     * @param  \WebMI\RocketChatApiClient\UserManagementApi\Model\PostApiV1UsersDeleteRequest|null $post_api_v1_users_delete_request post_api_v1_users_delete_request (optional)
     ...
     * @param  string $x_auth_token The authenticated user token. (required)
     * @param  string $x_user_id The authenticated user ID. (required)
     * @param  \WebMI\RocketChatApiClient\UserManagementApi\Model\PostApiV1UsersDeleteRequest|null $post_api_v1_users_delete_request (optional)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['postApiV1UsersDelete'] to see the possible values for this operation
     *
     * @throws \WebMI\RocketChatApiClient\UserManagementApi\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     ...
     * @param  string $x_auth_token The authenticated user token. (required)
     * @param  string $x_user_id The authenticated user ID. (required)
     * @param  \WebMI\RocketChatApiClient\UserManagementApi\Model\PostApiV1UsersDeleteOwnAccountRequest|null $post_api_v1_users_delete_own_account_request post_api_v1_users_delete_own_account_request (optional)
     ...
     * @param  string $x_auth_token The authenticated user token. (required)
     * @param  string $x_user_id The authenticated user ID. (required)
     * @param  \WebMI\RocketChatApiClient\UserManagementApi\Model\PostApiV1UsersDeleteOwnAccountRequest|null $post_api_v1_users_delete_own_account_request (optional)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['postApiV1UsersDeleteOwnAccount'] to see the possible values for this operation
     *
     * @throws \WebMI\RocketChatApiClient\UserManagementApi\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     ...
     * Forgot Password
     *
     * @param  \WebMI\RocketChatApiClient\UserManagementApi\Model\PostApiV1UsersForgotPasswordRequest|null $post_api_v1_users_forgot_password_request post_api_v1_users_forgot_password_request (optional)
     ...
     * Forgot Password
     *
     * @param  \WebMI\RocketChatApiClient\UserManagementApi\Model\PostApiV1UsersForgotPasswordRequest|null $post_api_v1_users_forgot_password_request (optional)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['postApiV1UsersForgotPassword'] to see the possible values for this operation
     *
     * @throws \WebMI\RocketChatApiClient\UserManagementApi\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     ...
     * @param  string $x_2fa_code The 2fa code. See &lt;a href&#x3D;\&quot;https://developer.rocket.chat/apidocs/introduction-to-two-factor-authentication\&quot; target&#x3D;\&quot;_blank\&quot;&gt;Introduction to Two-Factor Authentication&lt;/a&gt;. (required)
     * @param  string $x_2fa_method The desired method to get the 2FA code. It can be &#x60;email&#x60;, &#x60;totp&#x60;, or &#x60;password&#x60;. (required)
     * @param  \WebMI\RocketChatApiClient\UserManagementApi\Model\PostApiV1UsersGeneratePersonalAccessTokenRequest|null $post_api_v1_users_generate_personal_access_token_request post_api_v1_users_generate_personal_access_token_request (optional)
     ...
     * @param  string $x_2fa_code The 2fa code. See &lt;a href&#x3D;\&quot;https://developer.rocket.chat/apidocs/introduction-to-two-factor-authentication\&quot; target&#x3D;\&quot;_blank\&quot;&gt;Introduction to Two-Factor Authentication&lt;/a&gt;. (required)
     * @param  string $x_2fa_method The desired method to get the 2FA code. It can be &#x60;email&#x60;, &#x60;totp&#x60;, or &#x60;password&#x60;. (required)
     * @param  \WebMI\RocketChatApiClient\UserManagementApi\Model\PostApiV1UsersGeneratePersonalAccessTokenRequest|null $post_api_v1_users_generate_personal_access_token_request (optional)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['postApiV1UsersGeneratePersonalAccessToken'] to see the possible values for this operation
     *
     * @throws \WebMI\RocketChatApiClient\UserManagementApi\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     ...
     * @param  string $x_2fa_code The 2fa code. See &lt;a href&#x3D;\&quot;https://developer.rocket.chat/apidocs/introduction-to-two-factor-authentication\&quot; target&#x3D;\&quot;_blank\&quot;&gt;Introduction to Two-Factor Authentication&lt;/a&gt;. (required)
     * @param  string $x_2fa_method The desired method to get the 2FA code. It can be &#x60;email&#x60;, &#x60;totp&#x60;, or &#x60;password&#x60;. (required)
     * @param  \WebMI\RocketChatApiClient\UserManagementApi\Model\PostApiV1UsersRegeneratePersonalAccessTokenRequest|null $post_api_v1_users_regenerate_personal_access_token_request post_api_v1_users_regenerate_personal_access_token_request (optional)
     ...
     * @param  string $x_2fa_code The 2fa code. See &lt;a href&#x3D;\&quot;https://developer.rocket.chat/apidocs/introduction-to-two-factor-authentication\&quot; target&#x3D;\&quot;_blank\&quot;&gt;Introduction to Two-Factor Authentication&lt;/a&gt;. (required)
     * @param  string $x_2fa_method The desired method to get the 2FA code. It can be &#x60;email&#x60;, &#x60;totp&#x60;, or &#x60;password&#x60;. (required)
     * @param  \WebMI\RocketChatApiClient\UserManagementApi\Model\PostApiV1UsersRegeneratePersonalAccessTokenRequest|null $post_api_v1_users_regenerate_personal_access_token_request (optional)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['postApiV1UsersRegeneratePersonalAccessToken'] to see the possible values for this operation
     *
     * @throws \WebMI\RocketChatApiClient\UserManagementApi\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     ...
     * Register User
     *
     * @param  \WebMI\RocketChatApiClient\UserManagementApi\Model\PostApiV1UsersRegisterRequest|null $post_api_v1_users_register_request post_api_v1_users_register_request (optional)
     ...
     * Register User
     *
     * @param  \WebMI\RocketChatApiClient\UserManagementApi\Model\PostApiV1UsersRegisterRequest|null $post_api_v1_users_register_request (optional)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['postApiV1UsersRegister'] to see the possible values for this operation
     *
     * @throws \WebMI\RocketChatApiClient\UserManagementApi\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     ...
     * @param  string $x_user_id The authenticated user ID. (required)
     * @param  string $x_auth_token The authenticated user token. (required)
     * @param  \WebMI\RocketChatApiClient\UserManagementApi\Model\PostApiV1UsersResetAvatarRequest|null $post_api_v1_users_reset_avatar_request post_api_v1_users_reset_avatar_request (optional)
     ...
     * @param  string $x_user_id The authenticated user ID. (required)
     * @param  string $x_auth_token The authenticated user token. (required)
     * @param  \WebMI\RocketChatApiClient\UserManagementApi\Model\PostApiV1UsersResetAvatarRequest|null $post_api_v1_users_reset_avatar_request (optional)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['postApiV1UsersResetAvatar'] to see the possible values for this operation
     *
     * @throws \WebMI\RocketChatApiClient\UserManagementApi\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     ...
     * @param  string $x_2fa_code The 2fa code. See &lt;a href&#x3D;\&quot;https://developer.rocket.chat/apidocs/introduction-to-two-factor-authentication\&quot; target&#x3D;\&quot;_blank\&quot;&gt;Introduction to Two-Factor Authentication&lt;/a&gt;. (required)
     * @param  string $x_2fa_method The desired method to get the 2FA code. It can be &#x60;email&#x60;, &#x60;totp&#x60;, or &#x60;password&#x60;. (required)
     * @param  \WebMI\RocketChatApiClient\UserManagementApi\Model\PostApiV1UsersResetE2EKeyRequest|null $post_api_v1_users_reset_e2_e_key_request post_api_v1_users_reset_e2_e_key_request (optional)
     ...
     * @param  string $x_2fa_code The 2fa code. See &lt;a href&#x3D;\&quot;https://developer.rocket.chat/apidocs/introduction-to-two-factor-authentication\&quot; target&#x3D;\&quot;_blank\&quot;&gt;Introduction to Two-Factor Authentication&lt;/a&gt;. (required)
     * @param  string $x_2fa_method The desired method to get the 2FA code. It can be &#x60;email&#x60;, &#x60;totp&#x60;, or &#x60;password&#x60;. (required)
     * @param  \WebMI\RocketChatApiClient\UserManagementApi\Model\PostApiV1UsersResetE2EKeyRequest|null $post_api_v1_users_reset_e2_e_key_request (optional)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['postApiV1UsersResetE2EKey'] to see the possible values for this operation
     *
     * @throws \WebMI\RocketChatApiClient\UserManagementApi\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     ...
     * @param  string $x_2fa_code The 2fa code. See &lt;a href&#x3D;\&quot;https://developer.rocket.chat/apidocs/introduction-to-two-factor-authentication\&quot; target&#x3D;\&quot;_blank\&quot;&gt;Introduction to Two-Factor Authentication&lt;/a&gt;. (required)
     * @param  string $x_2fa_method The desired method to get the 2FA code. It can be &#x60;email&#x60;, &#x60;totp&#x60;, or &#x60;password&#x60;. (required)
     * @param  \WebMI\RocketChatApiClient\UserManagementApi\Model\PostApiV1UsersResetTOTPRequest|null $post_api_v1_users_reset_totp_request post_api_v1_users_reset_totp_request (optional)
     ...
     * @param  string $x_2fa_code The 2fa code. See &lt;a href&#x3D;\&quot;https://developer.rocket.chat/apidocs/introduction-to-two-factor-authentication\&quot; target&#x3D;\&quot;_blank\&quot;&gt;Introduction to Two-Factor Authentication&lt;/a&gt;. (required)
     * @param  string $x_2fa_method The desired method to get the 2FA code. It can be &#x60;email&#x60;, &#x60;totp&#x60;, or &#x60;password&#x60;. (required)
     * @param  \WebMI\RocketChatApiClient\UserManagementApi\Model\PostApiV1UsersResetTOTPRequest|null $post_api_v1_users_reset_totp_request (optional)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['postApiV1UsersResetTOTP'] to see the possible values for this operation
     *
     * @throws \WebMI\RocketChatApiClient\UserManagementApi\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     ...
     * @param  string $x_user_id The authenticated user ID. (required)
     * @param  string $x_auth_token The authenticated user token. (required)
     * @param  \WebMI\RocketChatApiClient\UserManagementApi\Model\PostApiV1UsersSetActiveStatusRequest|null $post_api_v1_users_set_active_status_request If &#x60;activeStatus&#x3D;false&#x60; &amp; &#x60;confirmRelinquish&#x3D;true&#x60; and the user is the last remaining owner of a room, the oldest member of that room will be chosen as the new owner. (optional)
     ...
     * @param  string $x_user_id The authenticated user ID. (required)
     * @param  string $x_auth_token The authenticated user token. (required)
     * @param  \WebMI\RocketChatApiClient\UserManagementApi\Model\PostApiV1UsersSetPreferencesRequest|null $post_api_v1_users_set_preferences_request post_api_v1_users_set_preferences_request (optional)
     ...
     * @param  string $x_user_id The authenticated user ID. (required)
     * @param  string $x_auth_token The authenticated user token. (required)
     * @param  \WebMI\RocketChatApiClient\UserManagementApi\Model\PostApiV1UsersSetPreferencesRequest|null $post_api_v1_users_set_preferences_request (optional)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['postApiV1UsersSetPreferences'] to see the possible values for this operation
     *
     * @throws \WebMI\RocketChatApiClient\UserManagementApi\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     ...
     * @param  string $x_user_id The authenticated user ID. (required)
     * @param  string $x_auth_token The authenticated user token. (required)
     * @param  \WebMI\RocketChatApiClient\UserManagementApi\Model\PostApiV1UsersSetStatusRequest|null $post_api_v1_users_set_status_request post_api_v1_users_set_status_request (optional)
     ...
     * @param  string $x_user_id The authenticated user ID. (required)
     * @param  string $x_auth_token The authenticated user token. (required)
     * @param  \WebMI\RocketChatApiClient\UserManagementApi\Model\PostApiV1UsersSetStatusRequest|null $post_api_v1_users_set_status_request (optional)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['postApiV1UsersSetStatus'] to see the possible values for this operation
     *
     * @throws \WebMI\RocketChatApiClient\UserManagementApi\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     ...
     * @param  string $x_2fa_code The 2fa code. See &lt;a href&#x3D;\&quot;https://developer.rocket.chat/apidocs/introduction-to-two-factor-authentication\&quot; target&#x3D;\&quot;_blank\&quot;&gt;Introduction to Two-Factor Authentication&lt;/a&gt;. (required)
     * @param  string $x_2fa_method The desired method to get the 2FA code. It can be &#x60;email&#x60;, &#x60;totp&#x60;, or &#x60;password&#x60;. (required)
     * @param  \WebMI\RocketChatApiClient\UserManagementApi\Model\PostApiV1UsersUpdateRequest|null $post_api_v1_users_update_request post_api_v1_users_update_request (optional)
     ...
     * @param  string $x_2fa_code The 2fa code. See &lt;a href&#x3D;\&quot;https://developer.rocket.chat/apidocs/introduction-to-two-factor-authentication\&quot; target&#x3D;\&quot;_blank\&quot;&gt;Introduction to Two-Factor Authentication&lt;/a&gt;. (required)
     * @param  string $x_2fa_method The desired method to get the 2FA code. It can be &#x60;email&#x60;, &#x60;totp&#x60;, or &#x60;password&#x60;. (required)
     * @param  \WebMI\RocketChatApiClient\UserManagementApi\Model\PostApiV1UsersUpdateRequest|null $post_api_v1_users_update_request (optional)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['postApiV1UsersUpdate'] to see the possible values for this operation
     *
     * @throws \WebMI\RocketChatApiClient\UserManagementApi\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     ...
     * @param  string $x_2fa_code The 2fa code. See &lt;a href&#x3D;\&quot;https://developer.rocket.chat/apidocs/introduction-to-two-factor-authentication\&quot; target&#x3D;\&quot;_blank\&quot;&gt;Introduction to Two-Factor Authentication&lt;/a&gt;. (required)
     * @param  string $x_2fa_method The desired method to get the 2FA code. It can be &#x60;email&#x60;, &#x60;totp&#x60;, or &#x60;password&#x60;. (required)
     * @param  \WebMI\RocketChatApiClient\UserManagementApi\Model\PostApiV1UsersUpdateOwnBasicInfoRequest|null $post_api_v1_users_update_own_basic_info_request post_api_v1_users_update_own_basic_info_request (optional)
     ...
     * @param  string $x_2fa_code The 2fa code. See &lt;a href&#x3D;\&quot;https://developer.rocket.chat/apidocs/introduction-to-two-factor-authentication\&quot; target&#x3D;\&quot;_blank\&quot;&gt;Introduction to Two-Factor Authentication&lt;/a&gt;. (required)
     * @param  string $x_2fa_method The desired method to get the 2FA code. It can be &#x60;email&#x60;, &#x60;totp&#x60;, or &#x60;password&#x60;. (required)
     * @param  \WebMI\RocketChatApiClient\UserManagementApi\Model\PostApiV1UsersUpdateOwnBasicInfoRequest|null $post_api_v1_users_update_own_basic_info_request (optional)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['postApiV1UsersUpdateOwnBasicInfo'] to see the possible values for this operation
     *
     * @throws \WebMI\RocketChatApiClient\UserManagementApi\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
