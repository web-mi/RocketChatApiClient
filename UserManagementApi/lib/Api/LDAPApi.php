...
class LDAPApi
{
     ...
     * @return \WebMI\RocketChatApiClient\UserManagementApi\Model\PostApiV1UsersLogout200Response|\WebMI\RocketChatApiClient\UserManagementApi\Model\PostApiV1LdapSyncNow400Response|\WebMI\RocketChatApiClient\UserManagementApi\Model\GetPermissionsListAll401Response
     */
    ...
    {
        list($response) = $this->postApiV1LdapSyncNowWithHttpInfo($x_auth_token, $x_user_id, $x_2fa_code, $x_2fa_method, $contentType);
        return $response;
    }
     ...
     * @throws \WebMI\RocketChatApiClient\UserManagementApi\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array of \WebMI\RocketChatApiClient\UserManagementApi\Model\PostApiV1UsersLogout200Response|\WebMI\RocketChatApiClient\UserManagementApi\Model\PostApiV1LdapSyncNow400Response|\WebMI\RocketChatApiClient\UserManagementApi\Model\GetPermissionsListAll401Response, HTTP status code, HTTP response headers (array of strings)
     */
    public function postApiV1LdapSyncNowWithHttpInfo($x_auth_token, $x_user_id, $x_2fa_code, $x_2fa_method, string $contentType = self::contentTypes['postApiV1LdapSyncNow'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                ...
                case 400:
                    if ('\WebMI\RocketChatApiClient\UserManagementApi\Model\PostApiV1LdapSyncNow400Response' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\WebMI\RocketChatApiClient\UserManagementApi\Model\PostApiV1LdapSyncNow400Response' !== 'string') {
                            try {
                                $content = json_decode($content, false, 512, JSON_THROW_ON_ERROR);
                            } catch (\JsonException $exception) {
                                throw new ApiException(
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\WebMI\RocketChatApiClient\UserManagementApi\Model\PostApiV1LdapSyncNow400Response', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                case 401:
            ...
            switch ($e->getCode()) {
                ...
                case 400:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\WebMI\RocketChatApiClient\UserManagementApi\Model\PostApiV1LdapSyncNow400Response',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     */
    public function postApiV1LdapSyncNowAsync($x_auth_token, $x_user_id, $x_2fa_code, $x_2fa_method, string $contentType = self::contentTypes['postApiV1LdapSyncNow'][0])
    {
        return $this->postApiV1LdapSyncNowAsyncWithHttpInfo($x_auth_token, $x_user_id, $x_2fa_code, $x_2fa_method, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     */
    public function postApiV1LdapSyncNowRequest($x_auth_token, $x_user_id, $x_2fa_code, $x_2fa_method, string $contentType = self::contentTypes['postApiV1LdapSyncNow'][0])
    {
    ...
    {
        list($response) = $this->postApiV1LdapTestConnectionWithHttpInfo($x_auth_token, $x_user_id, $contentType);
        return $response;
    }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function postApiV1LdapTestConnectionAsync($x_auth_token, $x_user_id, string $contentType = self::contentTypes['postApiV1LdapTestConnection'][0])
    {
        return $this->postApiV1LdapTestConnectionAsyncWithHttpInfo($x_auth_token, $x_user_id, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function postApiV1LdapTestConnectionRequest($x_auth_token, $x_user_id, string $contentType = self::contentTypes['postApiV1LdapTestConnection'][0])
    {
     ...
     * @param  string $x_auth_token The authenticated user token. (required)
     * @param  string $x_user_id The authenticated user ID. (required)
     * @param  \WebMI\RocketChatApiClient\UserManagementApi\Model\PostApiV1LdapTestSearchRequest|null $post_api_v1_ldap_test_search_request post_api_v1_ldap_test_search_request (optional)
    ...
    {
        list($response) = $this->postApiV1LdapTestSearchWithHttpInfo($x_auth_token, $x_user_id, $post_api_v1_ldap_test_search_request, $contentType);
        return $response;
    }
     ...
     * @param  string $x_auth_token The authenticated user token. (required)
     * @param  string $x_user_id The authenticated user ID. (required)
     * @param  \WebMI\RocketChatApiClient\UserManagementApi\Model\PostApiV1LdapTestSearchRequest|null $post_api_v1_ldap_test_search_request (optional)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['postApiV1LdapTestSearch'] to see the possible values for this operation
     *
     * @throws \WebMI\RocketChatApiClient\UserManagementApi\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function postApiV1LdapTestSearchAsync($x_auth_token, $x_user_id, $post_api_v1_ldap_test_search_request = null, string $contentType = self::contentTypes['postApiV1LdapTestSearch'][0])
    {
        return $this->postApiV1LdapTestSearchAsyncWithHttpInfo($x_auth_token, $x_user_id, $post_api_v1_ldap_test_search_request, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function postApiV1LdapTestSearchRequest($x_auth_token, $x_user_id, $post_api_v1_ldap_test_search_request = null, string $contentType = self::contentTypes['postApiV1LdapTestSearch'][0])
    {
        ...
        // for model (json/xml)
        if (isset($post_api_v1_ldap_test_search_request)) {
            if (stripos($headers['Content-Type'], 'application/json') !== false) {
                # if Content-Type contains "application/json", json_encode the body
                $httpBody = \GuzzleHttp\Utils::jsonEncode(ObjectSerializer::sanitizeForSerialization($post_api_v1_ldap_test_search_request));
            } else {
                $httpBody = $post_api_v1_ldap_test_search_request;
            }
