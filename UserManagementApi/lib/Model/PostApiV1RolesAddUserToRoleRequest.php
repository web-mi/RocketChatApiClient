...
/**
 * PostApiV1RolesAddUserToRoleRequest Class Doc Comment
 *
 * @category Class
 * @package  WebMI\RocketChatApiClient\UserManagementApi
 * @author   OpenAPI Generator team
 ...
 */
class PostApiV1RolesAddUserToRoleRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'post_api_v1_roles_addUserToRole_request';
    ...
    */
     ...
     * Sets room_id
     *
     * @param string|null $room_id The ID of the room where the user should be assigned a role, if it is a room role.
     *
     * @return self
     */
