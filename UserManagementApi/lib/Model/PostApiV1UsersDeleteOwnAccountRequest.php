<?php
/**
 * PostApiV1UsersDeleteOwnAccountRequest
 *
 * PHP version 7.4
 *
 * @category Class
...
/**
 * PostApiV1UsersDeleteOwnAccountRequest Class Doc Comment
 *
 * @category Class
 * @package  WebMIRocketChatApiClientUserManagementApi
 * @author   OpenAPI Generator team
 ...
 */
class PostApiV1UsersDeleteOwnAccountRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'post_api_v1_users_deleteOwnAccount_request';
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('confirm_relinquish', $data ?? [], null);
    }
    ...
    */
     ...
     * Sets password
     *
     * @param string $password The password of user (encrypted in SHA256).
     *
     * @return self
     */
     ...
     *
     * @param bool|null $confirm_relinquish Deletes own account even if user is the last owner of a room.
     *
     * @return self
     */
