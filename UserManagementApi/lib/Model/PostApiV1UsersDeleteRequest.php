...
/**
 * PostApiV1UsersDeleteRequest Class Doc Comment
 *
 * @category Class
 * @package  RocketChatUserManagementApi
 * @author   OpenAPI Generator team
 ...
 */
class PostApiV1UsersDeleteRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'post_api_v1_users_delete_request';
    ...
    */
     ...
     *
     * @param bool|null $confirm_relinquish Deletes user even if it is the last owner of a room. By default, it is set to `false`.
     *
     * @return self
     */
