 ...
 */
class PostApiV1UsersUpdateOwnBasicInfoRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'post_api_v1_users_updateOwnBasicInfo_request';
    ...
    */
     ...
     * Sets custom_fields
     *
     * @param object|null $custom_fields Any custom fields the user should have on their account. You must define the custom fields in the workspace settings.
     *
     * @return self
     */
