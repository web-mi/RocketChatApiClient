 ...
 */
class PostApiV1UsersSetPreferencesRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'post_api_v1_users_setPreferences_request';
    ...
    */
     ...
     * Sets user_id
     *
     * @param string|null $user_id The user ID whose preferences you want to change. If an ID is not provided, the preferences will be set for the user who is sending the request.
     *
     * @return self
     */
