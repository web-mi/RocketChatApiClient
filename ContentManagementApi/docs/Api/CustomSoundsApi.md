...
```php
getApiV1CustomSoundsList($x_auth_token, $x_user_id, $offset, $count, $sort, $query, $fields, $name): \WebMI\RocketChatApiClient\ContentManagementApi\Model\GetApiV1CustomSoundsList200Response
```
...
$name = drill; // string | Filter list by the name of the custom sound.
