<?php
/**
 * PostApiV1EmojiCustomDeleteRequest
 *
 * PHP version 7.4
 *
 * @category Class
 ...
 */
class PostApiV1EmojiCustomDeleteRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'post_api_v1_emoji_custom_delete_request';
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['emoji_id'] === null) {
            $invalidProperties[] = "'emoji_id' can't be null";
        }
     ...
     * Sets emoji_id
     *
     * @param string $emoji_id The id of the emoji to delete
     *
     * @return self
     */
