<?php
/**
 * PostApiV1EmojiCustomUpdateRequest
 *
 * PHP version 7.4
 *
 * @category Class
...
/**
 * PostApiV1EmojiCustomUpdateRequest Class Doc Comment
 *
 * @category Class
 * @package  WebMI\RocketChatApiClient\ContentManagementApi
 * @author   OpenAPI Generator team
 ...
 */
class PostApiV1EmojiCustomUpdateRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'post_api_v1_emoji_custom_update_request';
    ...
    */
     ...
     * Sets emoji
     *
     * @param string|null $emoji The image file to use as custom emoji, as form data.
     *
     * @return self
     */
     ...
     * Sets aliases
     *
     * @param string|null $aliases The alias of the custom emoji.
     *
     * @return self
     */
