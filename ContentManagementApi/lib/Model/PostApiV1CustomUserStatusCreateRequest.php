<?php
/**
 * PostApiV1CustomUserStatusCreateRequest
 *
 * PHP version 7.4
 *
 * @category Class
...
/**
 * PostApiV1CustomUserStatusCreateRequest Class Doc Comment
 *
 * @category Class
 * @package  RocketChatContentManagementApi
 * @author   OpenAPI Generator team
 ...
 */
class PostApiV1CustomUserStatusCreateRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'post_api_v1_custom_user_status_create_request';
    ...
    */
     ...
     * Sets name
     *
     * @param string $name The name of the custom status.
     *
     * @return self
     */
     ...
     * Sets status_type
     *
     * @param string $status_type The `statusType` of the custom status. Valid status type includes: `Online`, `Busy`, `Away`, `Offline`.
     *
     * @return self
     */
