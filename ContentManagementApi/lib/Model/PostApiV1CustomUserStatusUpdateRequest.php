<?php
/**
 * PostApiV1CustomUserStatusUpdateRequest
 *
 * PHP version 7.4
 *
 * @category Class
...
/**
 * PostApiV1CustomUserStatusUpdateRequest Class Doc Comment
 *
 * @category Class
 * @package  WebMIRocketChatApiClientContentManagementApi
 * @author   OpenAPI Generator team
 ...
 */
class PostApiV1CustomUserStatusUpdateRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'post_api_v1_custom_user_status_update_request';
    ...
    */
     ...
     * Sets _id
     *
     * @param string $_id The `_id` of the custom status.
     *
     * @return self
     */
     ...
     * Sets name
     *
     * @param string $name The updated name of the custom status.
     *
     * @return self
     */
     ...
     * Sets status_type
     *
     * @param string $status_type The updated `statusType` of the custom status
     *
     * @return self
     */
