 ...
 */
class PostApiV1ChatSendMessageRequestMessageAttachmentsInner implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'post_api_v1_chat_sendMessage_request_message_attachments_inner';
    ...
    protected static $openAPITypes = [
        ...
        'collapsed' => 'bool',
        'color' => 'string',
        'fields' => '\WebMI\RocketChatApiClient\CustomApi\Model\PostApiV1ChatSendMessageRequestMessageAttachmentsInnerFieldsInner[]',
        'image_url' => 'string',
        'message_link' => 'string',
        'text' => 'string',
        'thumb_url' => 'string',
    ...
    */
     ...
     * Sets audio_url
     *
     * @param string|null $audio_url Audio file to attach. See <a href='https://developer.mozilla.org/en-US/docs/Web/HTML/Element/audio' target='_blank'>HTML audio element</a> for information.
     *
     * @return self
     */
     ...
     * Sets author_link
     *
     * @param string|null $author_link Providing this makes the author name clickable and points to this link.
     *
     * @return self
     */
     ...
     * Sets color
     *
     * @param string|null $color See <a href='https://developer.mozilla.org/en-US/docs/Web/CSS/background-color' target='_blank'>background-css</a> for the supported format.
     *
     * @return self
     */
     ...
     * Gets fields
     *
     * @return \WebMI\RocketChatApiClient\CustomApi\Model\PostApiV1ChatSendMessageRequestMessageAttachmentsInnerFieldsInner[]|null
     */
     ...
     * Sets fields
     *
     * @param \WebMI\RocketChatApiClient\CustomApi\Model\PostApiV1ChatSendMessageRequestMessageAttachmentsInnerFieldsInner[]|null $fields fields
     *
     * @return self
     */
     ...
     * Sets message_link
     *
     * @param string|null $message_link Only applicable if the `ts` parameter is provided, as it makes the time clickable to this link.
     *
     * @return self
     */
     ...
     * Sets video_url
     *
     * @param string|null $video_url Video file to attach. See the <a href='https://developer.mozilla.org/en-US/docs/Web/HTML/Element/video' target='blank'>HTML video element</a> for information.
     *
     * @return self
     */
