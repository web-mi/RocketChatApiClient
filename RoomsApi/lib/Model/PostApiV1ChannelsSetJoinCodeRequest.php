<?php
/**
 * PostApiV1ChannelsSetJoinCodeRequest
 *
 * PHP version 7.4
 *
 * @category Class
...
/**
 * PostApiV1ChannelsSetJoinCodeRequest Class Doc Comment
 *
 * @category Class
 * @package  RocketChatRoomsApi
 * @author   OpenAPI Generator team
 ...
 */
class PostApiV1ChannelsSetJoinCodeRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'post_api_v1_channels_setJoinCode_request';
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['join_code'] === null) {
            $invalidProperties[] = "'join_code' can't be null";
        }
     ...
     * Sets join_code
     *
     * @param string $join_code The join code that will be required for any user to join this channel.
     *
     * @return self
     */
