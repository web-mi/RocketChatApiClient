<?php
/**
 * PostApiV1TeamsRemoveRoomRequest
 *
 * PHP version 7.4
 *
 * @category Class
...
/**
 * PostApiV1TeamsRemoveRoomRequest Class Doc Comment
 *
 * @category Class
 * @package  WebMI\RocketChatApiClient\RoomsApi
 * @author   OpenAPI Generator team
 ...
 */
class PostApiV1TeamsRemoveRoomRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'post_api_v1_teams_removeRoom_request';
    ...
    */
     ...
     * Sets room_id
     *
     * @param string|null $room_id The room ID to be removed from the team.
     *
     * @return self
     */
