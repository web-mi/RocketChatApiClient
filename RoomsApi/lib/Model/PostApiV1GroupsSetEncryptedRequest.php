<?php
/**
 * PostApiV1GroupsSetEncryptedRequest
 *
 * PHP version 7.4
 *
 * @category Class
...
/**
 * PostApiV1GroupsSetEncryptedRequest Class Doc Comment
 *
 * @category Class
 * @package  RocketChatRoomsApi
 * @author   OpenAPI Generator team
 ...
 */
class PostApiV1GroupsSetEncryptedRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'post_api_v1_groups_setEncrypted_request';
    ...
    */
     ...
     * Sets encrypted
     *
     * @param bool $encrypted Whether or not to encrypt the room.
     *
     * @return self
     */
     ...
     * Sets room_id
     *
     * @param string|null $room_id The group ID. Alternatively, use the `roomName` parameter and enter the group name.
     *
     * @return self
     */
