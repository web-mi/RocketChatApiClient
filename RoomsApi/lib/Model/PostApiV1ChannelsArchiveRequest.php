<?php
/**
 * PostApiV1ChannelsArchiveRequest
 *
 * PHP version 7.4
 *
 * @category Class
...
/**
 * PostApiV1ChannelsArchiveRequest Class Doc Comment
 *
 * @category Class
 * @package  WebMI\RocketChatApiClient\RoomsApi
 * @author   OpenAPI Generator team
 ...
 */
class PostApiV1ChannelsArchiveRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'post_api_v1_channels_archive_request';
    ...
    */
     ...
     * Sets room_id
     *
     * @param string $room_id The channel ID that you want to archive.
     *
     * @return self
     */
