...
/**
 * PostApiV1ChannelsJoinRequest Class Doc Comment
 *
 * @category Class
 * @package  WebMI\RocketChatApiClient\RoomsApi
 * @author   OpenAPI Generator team
 ...
 */
class PostApiV1ChannelsJoinRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'post_api_v1_channels_join_request';
    ...
    */
     ...
     * Sets join_code
     *
     * @param string|null $join_code The join code of the room. The join code isn't needed if the user has the `join-without-join-code` permission.
     *
     * @return self
     */
