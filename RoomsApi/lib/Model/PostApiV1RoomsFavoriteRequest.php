...
/**
 * PostApiV1RoomsFavoriteRequest Class Doc Comment
 *
 * @category Class
 * @package  WebMI\RocketChatApiClient\RoomsApi
 * @author   OpenAPI Generator team
 ...
 */
class PostApiV1RoomsFavoriteRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'post_api_v1_rooms_favorite_request';
    ...
    */
     ...
     * Sets room_id
     *
     * @param string $room_id The room ID. Alternatively, enter the `roomName` parameter and provide the room's name as the value.
     *
     * @return self
     */
     ...
     * Sets favorite
     *
     * @param bool $favorite A boolean to mark the room as favourite or not.
     *
     * @return self
     */
