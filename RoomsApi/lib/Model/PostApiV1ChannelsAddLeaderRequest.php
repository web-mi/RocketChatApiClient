<?php
/**
 * PostApiV1ChannelsAddLeaderRequest
 *
 * PHP version 7.4
 *
 * @category Class
...
/**
 * PostApiV1ChannelsAddLeaderRequest Class Doc Comment
 *
 * @category Class
 * @package  WebMI\RocketChatApiClient\RoomsApi
 * @author   OpenAPI Generator team
 ...
 */
class PostApiV1ChannelsAddLeaderRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'post_api_v1_channels_addLeader_request';
    ...
    */
     ...
     * Sets user_id
     *
     * @param string $user_id The userId of the user to be made leader
     *
     * @return self
     */
