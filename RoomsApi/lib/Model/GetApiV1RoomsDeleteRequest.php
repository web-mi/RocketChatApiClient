...
/**
 * GetApiV1RoomsDeleteRequest Class Doc Comment
 *
 * @category Class
 * @package  WebMI\RocketChatApiClient\RoomsApi
 * @author   OpenAPI Generator team
 ...
 */
class GetApiV1RoomsDeleteRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'get_api_v1_rooms_delete_request';
    ...
    */
     ...
     * Sets room_id
     *
     * @param string|null $room_id The room ID that you want to delete.
     *
     * @return self
     */
