...
/**
 * PostApiV1ChannelsAddModeratorRequest Class Doc Comment
 *
 * @category Class
 * @package  RocketChatRoomsApi
 * @author   OpenAPI Generator team
 ...
 */
class PostApiV1ChannelsAddModeratorRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'post_api_v1_channels_addModerator_request';
    ...
    */
     ...
     * Sets user_id
     *
     * @param string $user_id The user ID that you want to set as the moderator.
     *
     * @return self
     */
