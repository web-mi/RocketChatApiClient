...
/**
 * PostApiV1ChannelsCloseRequest Class Doc Comment
 *
 * @category Class
 * @package  WebMI\RocketChatApiClient\RoomsApi
 * @author   OpenAPI Generator team
 ...
 */
class PostApiV1ChannelsCloseRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'post_api_v1_channels_close_request';
    ...
    */
     ...
     * Sets room_id
     *
     * @param string $room_id The channel ID that you want to close from your list.
     *
     * @return self
     */
