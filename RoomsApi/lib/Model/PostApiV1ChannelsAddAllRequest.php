<?php
/**
 * PostApiV1ChannelsAddAllRequest
 *
 * PHP version 7.4
 *
 * @category Class
...
/**
 * PostApiV1ChannelsAddAllRequest Class Doc Comment
 *
 * @category Class
 * @package  WebMI\RocketChatApiClient\RoomsApi
 * @author   OpenAPI Generator team
 ...
 */
class PostApiV1ChannelsAddAllRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'post_api_v1_channels_addAll_request';
    ...
    */
     ...
     *
     * @param bool|null $active_users_only Add only active users. It is `false` by default.
     *
     * @return self
     */
