...
/**
 * PostApiV1TeamsAddRoomsRequest Class Doc Comment
 *
 * @category Class
 * @package  WebMI\RocketChatApiClient\RoomsApi
 * @author   OpenAPI Generator team
 ...
 */
class PostApiV1TeamsAddRoomsRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'post_api_v1_teams_addRooms_request';
    ...
    */
     ...
     * Sets rooms
     *
     * @param string[] $rooms The IDs of the rooms to be added to the team.
     *
     * @return self
     */
