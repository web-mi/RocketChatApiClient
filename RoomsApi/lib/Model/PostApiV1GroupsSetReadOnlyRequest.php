<?php
/**
 * PostApiV1GroupsSetReadOnlyRequest
 *
 * PHP version 7.4
 *
 * @category Class
...
/**
 * PostApiV1GroupsSetReadOnlyRequest Class Doc Comment
 *
 * @category Class
 * @package  WebMI\RocketChatApiClient\RoomsApi
 * @author   OpenAPI Generator team
 ...
 */
class PostApiV1GroupsSetReadOnlyRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'post_api_v1_groups_setReadOnly_request';
    ...
    */
     ...
     * Sets read_only
     *
     * @param bool $read_only Boolean to represent the group read-only status
     *
     * @return self
     */
