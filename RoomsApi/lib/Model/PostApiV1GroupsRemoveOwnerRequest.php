<?php
/**
 * PostApiV1GroupsRemoveOwnerRequest
 *
 * PHP version 7.4
 *
 * @category Class
...
/**
 * PostApiV1GroupsRemoveOwnerRequest Class Doc Comment
 *
 * @category Class
 * @package  WebMI\RocketChatApiClient\RoomsApi
 * @author   OpenAPI Generator team
 ...
 */
class PostApiV1GroupsRemoveOwnerRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'post_api_v1_groups_removeOwner_request';
    ...
    */
     ...
     * Sets user_id
     *
     * @param string $user_id The id of the user to be removed as owner
     *
     * @return self
     */
