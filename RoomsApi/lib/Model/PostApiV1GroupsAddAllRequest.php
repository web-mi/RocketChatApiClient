...
/**
 * PostApiV1GroupsAddAllRequest Class Doc Comment
 *
 * @category Class
 * @package  WebMI\RocketChatApiClient\RoomsApi
 * @author   OpenAPI Generator team
 ...
 */
class PostApiV1GroupsAddAllRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'post_api_v1_groups_addAll_request';
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('active_users_only', $data ?? [], null);
    }
    ...
    */
     ...
     *
     * @param string|null $active_users_only Adds all of the users of the Rocket.Chat workspace to the group/channel.
     *
     * @return self
     */
