...
class ChannelsApi
{
     ...
     *
     * @param  string|null $room_id The room id. It is required if the &#x60;roomName&#x60; is not provided. (optional)
     * @param  string|null $room_name The room name.  It is required if the &#x60;roomId&#x60; is not provided. (optional)
     ...
     * @param  mixed|null $sort List of fields to order by, and in which direction. This is a JSON object, with properties listed in desired order, with values of 1 for ascending, or -1 for descending. For example, {\&quot;value\&quot;: -1, \&quot;_id\&quot;: 1} (optional)
     * @param  mixed|null $query This parameter allows you to use MongoDB query operators to search for specific data. For example, to query users with a name that contains the letter \&quot;g\&quot;: query&#x3D;{ \&quot;name\&quot;: { \&quot;$regex\&quot;: \&quot;g\&quot; } } (optional)
     * @param  string|null $fields This parameter accepts a JSON object with properties that have a value of 1 or 0 to include or exclude them in the response. For example, to only retrieve the usernames of users: fields&#x3D;{ \&quot;username\&quot;: 1 } (optional)
     ...
     * @return \WebMI\RocketChatApiClient\RoomsApi\Model\GetApiV1ChannelsAnonymousread200Response
     */
     ...
     * @throws \WebMI\RocketChatApiClient\RoomsApi\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array of \WebMI\RocketChatApiClient\RoomsApi\Model\GetApiV1ChannelsAnonymousread200Response, HTTP status code, HTTP response headers (array of strings)
     */
    public function getApiV1ChannelsAnonymousreadWithHttpInfo($room_id = null, $room_name = null, $offset = null, $count = null, $sort = null, $query = null, $fields = null, string $contentType = self::contentTypes['getApiV1ChannelsAnonymousread'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\WebMI\RocketChatApiClient\RoomsApi\Model\GetApiV1ChannelsAnonymousread200Response' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\WebMI\RocketChatApiClient\RoomsApi\Model\GetApiV1ChannelsAnonymousread200Response' !== 'string') {
                            try {
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\WebMI\RocketChatApiClient\RoomsApi\Model\GetApiV1ChannelsAnonymousread200Response', []),
            ...
            $returnType = '\WebMI\RocketChatApiClient\RoomsApi\Model\GetApiV1ChannelsAnonymousread200Response';
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\WebMI\RocketChatApiClient\RoomsApi\Model\GetApiV1ChannelsAnonymousread200Response',
     ...
     * @throws \WebMI\RocketChatApiClient\RoomsApi\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return \WebMI\RocketChatApiClient\RoomsApi\Model\GetApiV1ChannelsFiles200Response
     */
     ...
     * @throws \WebMI\RocketChatApiClient\RoomsApi\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array of \WebMI\RocketChatApiClient\RoomsApi\Model\GetApiV1ChannelsFiles200Response, HTTP status code, HTTP response headers (array of strings)
     */
    public function getApiV1ChannelsFilesWithHttpInfo($x_user_id, $x_auth_token, $room_id = null, $room_name = null, $fields = null, $query = null, $sort = null, $count = null, $offset = null, string $contentType = self::contentTypes['getApiV1ChannelsFiles'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\WebMI\RocketChatApiClient\RoomsApi\Model\GetApiV1ChannelsFiles200Response' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\WebMI\RocketChatApiClient\RoomsApi\Model\GetApiV1ChannelsFiles200Response' !== 'string') {
                            try {
                                $content = json_decode($content, false, 512, JSON_THROW_ON_ERROR);
                            } catch (\JsonException $exception) {
                                throw new ApiException(
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\WebMI\RocketChatApiClient\RoomsApi\Model\GetApiV1ChannelsFiles200Response', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
            }
            ...
            $returnType = '\WebMI\RocketChatApiClient\RoomsApi\Model\GetApiV1ChannelsFiles200Response';
            if ($returnType === '\SplFileObject') {
                $content = $response->getBody(); //stream goes to serializer
            } else {
                $content = (string) $response->getBody();
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\WebMI\RocketChatApiClient\RoomsApi\Model\GetApiV1ChannelsFiles200Response',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     * @throws \WebMI\RocketChatApiClient\RoomsApi\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return \WebMI\RocketChatApiClient\RoomsApi\Model\GetApiV1ChannelsGetAllUserMentionsByChannel200Response|\WebMI\RocketChatApiClient\RoomsApi\Model\PostApiV1ChannelsCreate401Response
     */
     ...
     * @throws \WebMI\RocketChatApiClient\RoomsApi\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array of \WebMI\RocketChatApiClient\RoomsApi\Model\GetApiV1ChannelsGetAllUserMentionsByChannel200Response|\WebMI\RocketChatApiClient\RoomsApi\Model\PostApiV1ChannelsCreate401Response, HTTP status code, HTTP response headers (array of strings)
     */
    public function getApiV1ChannelsGetAllUserMentionsByChannelWithHttpInfo($x_auth_token, $x_user_id, $room_id, $offset = null, $count = null, $sort = null, string $contentType = self::contentTypes['getApiV1ChannelsGetAllUserMentionsByChannel'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\WebMI\RocketChatApiClient\RoomsApi\Model\GetApiV1ChannelsGetAllUserMentionsByChannel200Response' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\WebMI\RocketChatApiClient\RoomsApi\Model\GetApiV1ChannelsGetAllUserMentionsByChannel200Response' !== 'string') {
                            try {
                                $content = json_decode($content, false, 512, JSON_THROW_ON_ERROR);
                            } catch (\JsonException $exception) {
                                throw new ApiException(
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\WebMI\RocketChatApiClient\RoomsApi\Model\GetApiV1ChannelsGetAllUserMentionsByChannel200Response', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                case 401:
            ...
            $returnType = '\WebMI\RocketChatApiClient\RoomsApi\Model\GetApiV1ChannelsGetAllUserMentionsByChannel200Response';
            if ($returnType === '\SplFileObject') {
                $content = $response->getBody(); //stream goes to serializer
            } else {
                $content = (string) $response->getBody();
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\WebMI\RocketChatApiClient\RoomsApi\Model\GetApiV1ChannelsGetAllUserMentionsByChannel200Response',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     * @throws \WebMI\RocketChatApiClient\RoomsApi\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return \WebMI\RocketChatApiClient\RoomsApi\Model\GetApiV1ChannelsGetIntegrations200Response|\WebMI\RocketChatApiClient\RoomsApi\Model\PostApiV1ChannelsCreate401Response
     */
     ...
     * @throws \WebMI\RocketChatApiClient\RoomsApi\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array of \WebMI\RocketChatApiClient\RoomsApi\Model\GetApiV1ChannelsGetIntegrations200Response|\WebMI\RocketChatApiClient\RoomsApi\Model\PostApiV1ChannelsCreate401Response, HTTP status code, HTTP response headers (array of strings)
     */
    public function getApiV1ChannelsGetIntegrationsWithHttpInfo($x_auth_token, $x_user_id, $room_id, $offset = null, $sort = null, $fields = null, $query = null, $count = null, string $contentType = self::contentTypes['getApiV1ChannelsGetIntegrations'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\WebMI\RocketChatApiClient\RoomsApi\Model\GetApiV1ChannelsGetIntegrations200Response' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\WebMI\RocketChatApiClient\RoomsApi\Model\GetApiV1ChannelsGetIntegrations200Response' !== 'string') {
                            try {
                                $content = json_decode($content, false, 512, JSON_THROW_ON_ERROR);
                            } catch (\JsonException $exception) {
                                throw new ApiException(
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\WebMI\RocketChatApiClient\RoomsApi\Model\GetApiV1ChannelsGetIntegrations200Response', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                case 401:
            ...
            $returnType = '\WebMI\RocketChatApiClient\RoomsApi\Model\GetApiV1ChannelsGetIntegrations200Response';
            if ($returnType === '\SplFileObject') {
                $content = $response->getBody(); //stream goes to serializer
            } else {
                $content = (string) $response->getBody();
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\WebMI\RocketChatApiClient\RoomsApi\Model\GetApiV1ChannelsGetIntegrations200Response',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     * @param  int|null $count The number of items to return. (optional)
     * @param  int|null $offset Number of items to \&quot;skip\&quot; in the query, i.e. requests return count items, skipping the first offset items. (optional)
     * @param  string|null $latest The end of time range of messages to retrieve. The default value is the current date and time. (optional)
     * @param  string|null $oldest The start of the time range of messages to retrieve (optional)
     * @param  bool|null $inclusive Whether messages which land on the latest and oldest dates should be included. The default value is false. (optional)
     * @param  bool|null $show_thread_messages Whether thread messages should be included in the response (optional)
     * @param  bool|null $unreads Whether the number of unread messages should be included. The default value is false. (optional)
     ...
     * @throws \WebMI\RocketChatApiClient\RoomsApi\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return \WebMI\RocketChatApiClient\RoomsApi\Model\PostApiV1ChannelsAddAll200Response
     */
     ...
     * @throws \WebMI\RocketChatApiClient\RoomsApi\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array of \WebMI\RocketChatApiClient\RoomsApi\Model\PostApiV1ChannelsAddAll200Response, HTTP status code, HTTP response headers (array of strings)
     */
    public function getApiV1ChannelsInfoWithHttpInfo($x_auth_token, $x_user_id, $room_id = null, $room_name = null, string $contentType = self::contentTypes['getApiV1ChannelsInfo'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\WebMI\RocketChatApiClient\RoomsApi\Model\PostApiV1ChannelsAddAll200Response' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\WebMI\RocketChatApiClient\RoomsApi\Model\PostApiV1ChannelsAddAll200Response' !== 'string') {
                            try {
                                $content = json_decode($content, false, 512, JSON_THROW_ON_ERROR);
                            } catch (\JsonException $exception) {
                                throw new ApiException(
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\WebMI\RocketChatApiClient\RoomsApi\Model\PostApiV1ChannelsAddAll200Response', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
            }
            ...
            $returnType = '\WebMI\RocketChatApiClient\RoomsApi\Model\PostApiV1ChannelsAddAll200Response';
            if ($returnType === '\SplFileObject') {
                $content = $response->getBody(); //stream goes to serializer
            } else {
                $content = (string) $response->getBody();
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\WebMI\RocketChatApiClient\RoomsApi\Model\PostApiV1ChannelsAddAll200Response',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     * @throws \WebMI\RocketChatApiClient\RoomsApi\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return \WebMI\RocketChatApiClient\RoomsApi\Model\GetApiV1ChannelsList200Response|\WebMI\RocketChatApiClient\RoomsApi\Model\PostApiV1ChannelsCreate401Response
     */
     ...
     * @throws \WebMI\RocketChatApiClient\RoomsApi\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array of \WebMI\RocketChatApiClient\RoomsApi\Model\GetApiV1ChannelsList200Response|\WebMI\RocketChatApiClient\RoomsApi\Model\PostApiV1ChannelsCreate401Response, HTTP status code, HTTP response headers (array of strings)
     */
    public function getApiV1ChannelsListWithHttpInfo($x_auth_token, $x_user_id, $offset = null, $count = null, $sort = null, $query = null, $fields = null, string $contentType = self::contentTypes['getApiV1ChannelsList'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\WebMI\RocketChatApiClient\RoomsApi\Model\GetApiV1ChannelsList200Response' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\WebMI\RocketChatApiClient\RoomsApi\Model\GetApiV1ChannelsList200Response' !== 'string') {
                            try {
                                $content = json_decode($content, false, 512, JSON_THROW_ON_ERROR);
                            } catch (\JsonException $exception) {
                                throw new ApiException(
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\WebMI\RocketChatApiClient\RoomsApi\Model\GetApiV1ChannelsList200Response', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                case 401:
            ...
            $returnType = '\WebMI\RocketChatApiClient\RoomsApi\Model\GetApiV1ChannelsList200Response';
            if ($returnType === '\SplFileObject') {
                $content = $response->getBody(); //stream goes to serializer
            } else {
                $content = (string) $response->getBody();
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\WebMI\RocketChatApiClient\RoomsApi\Model\GetApiV1ChannelsList200Response',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     * @throws \WebMI\RocketChatApiClient\RoomsApi\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return \WebMI\RocketChatApiClient\RoomsApi\Model\GetApiV1ChannelsListJoined200Response
     */
     ...
     * @throws \WebMI\RocketChatApiClient\RoomsApi\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array of \WebMI\RocketChatApiClient\RoomsApi\Model\GetApiV1ChannelsListJoined200Response, HTTP status code, HTTP response headers (array of strings)
     */
    public function getApiV1ChannelsListJoinedWithHttpInfo($x_auth_token, $x_user_id, $offset = null, $count = null, $sort = null, $query = null, $fields = null, string $contentType = self::contentTypes['getApiV1ChannelsListJoined'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\WebMI\RocketChatApiClient\RoomsApi\Model\GetApiV1ChannelsListJoined200Response' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\WebMI\RocketChatApiClient\RoomsApi\Model\GetApiV1ChannelsListJoined200Response' !== 'string') {
                            try {
                                $content = json_decode($content, false, 512, JSON_THROW_ON_ERROR);
                            } catch (\JsonException $exception) {
                                throw new ApiException(
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\WebMI\RocketChatApiClient\RoomsApi\Model\GetApiV1ChannelsListJoined200Response', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
            }
            ...
            $returnType = '\WebMI\RocketChatApiClient\RoomsApi\Model\GetApiV1ChannelsListJoined200Response';
            if ($returnType === '\SplFileObject') {
                $content = $response->getBody(); //stream goes to serializer
            } else {
                $content = (string) $response->getBody();
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\WebMI\RocketChatApiClient\RoomsApi\Model\GetApiV1ChannelsListJoined200Response',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     * @param  string|null $room_id The room id. It is required if the &#x60;roomName&#x60; is not provided. (optional)
     * @param  string|null $room_name The room name.  It is required if the &#x60;roomId&#x60; is not provided. (optional)
     * @param  string[]|null $status The user&#39;s status (search filter). (optional)
     * @param  string|null $filter Extra search filters to be applied to the fields defined in the &#x60;Accounts_SearchFields&#x60;setting. (optional)
     * @param  mixed|null $sort List of fields to order by, and in which direction. This is a JSON object, with properties listed in desired order, with values of 1 for ascending, or -1 for descending. For example, {\&quot;value\&quot;: -1, \&quot;_id\&quot;: 1} (optional)
     * @param  int|null $count The number of items to return. (optional)
     * @param  int|null $offset Number of items to \&quot;skip\&quot; in the query, i.e. requests return count items, skipping the first offset items. (optional)
     ...
     * @throws \WebMI\RocketChatApiClient\RoomsApi\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return \WebMI\RocketChatApiClient\RoomsApi\Model\GetApiV1ChannelsMembers200Response
     */
     ...
     * @throws \WebMI\RocketChatApiClient\RoomsApi\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array of \WebMI\RocketChatApiClient\RoomsApi\Model\GetApiV1ChannelsMembers200Response, HTTP status code, HTTP response headers (array of strings)
     */
    public function getApiV1ChannelsMembersWithHttpInfo($x_auth_token, $x_user_id, $room_id = null, $room_name = null, $status = null, $filter = null, $sort = null, $count = null, $offset = null, string $contentType = self::contentTypes['getApiV1ChannelsMembers'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\WebMI\RocketChatApiClient\RoomsApi\Model\GetApiV1ChannelsMembers200Response' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\WebMI\RocketChatApiClient\RoomsApi\Model\GetApiV1ChannelsMembers200Response' !== 'string') {
                            try {
                                $content = json_decode($content, false, 512, JSON_THROW_ON_ERROR);
                            } catch (\JsonException $exception) {
                                throw new ApiException(
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\WebMI\RocketChatApiClient\RoomsApi\Model\GetApiV1ChannelsMembers200Response', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
            }
            ...
            $returnType = '\WebMI\RocketChatApiClient\RoomsApi\Model\GetApiV1ChannelsMembers200Response';
            if ($returnType === '\SplFileObject') {
                $content = $response->getBody(); //stream goes to serializer
            } else {
                $content = (string) $response->getBody();
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\WebMI\RocketChatApiClient\RoomsApi\Model\GetApiV1ChannelsMembers200Response',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     * @param  mixed|null $sort List of fields to order by, and in which direction. This is a JSON object, with properties listed in desired order, with values of 1 for ascending, or -1 for descending. For example, {\&quot;value\&quot;: -1, \&quot;_id\&quot;: 1} (optional)
     * @param  int|null $offset Number of items to \&quot;skip\&quot; in the query, i.e. requests return count items, skipping the first offset items. (optional)
     * @param  string|null $mention_ids Filter the messages where a user has been mentioned by the userId. For a set of userIds, use an array (&#x60;[\&quot;838ndhd79w\&quot;, \&quot;dud0wu900\&quot;]&#x60;). (optional)
     * @param  string|null $starred_ids Filter the messages a user have starred by userId. For a set of userIds, use an array (&#x60;[\&quot;838ndhd79w\&quot;, \&quot;dud0wu900\&quot;]&#x60;). (optional)
     * @param  bool|null $pinned Filter pinned messages. (optional)
     ...
     * @throws \WebMI\RocketChatApiClient\RoomsApi\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return \WebMI\RocketChatApiClient\RoomsApi\Model\GetApiV1ChannelsMessages200Response|\WebMI\RocketChatApiClient\RoomsApi\Model\PostApiV1ChannelsCreate401Response
     */
    public function getApiV1ChannelsMessages($x_auth_token, $x_user_id, $room_id, $count = null, $sort = null, $offset = null, $mention_ids = null, $starred_ids = null, $pinned = null, string $contentType = self::contentTypes['getApiV1ChannelsMessages'][0])
    {
        list($response) = $this->getApiV1ChannelsMessagesWithHttpInfo($x_auth_token, $x_user_id, $room_id, $count, $sort, $offset, $mention_ids, $starred_ids, $pinned, $contentType);
        return $response;
    }
     ...
     * @throws \WebMI\RocketChatApiClient\RoomsApi\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array of \WebMI\RocketChatApiClient\RoomsApi\Model\GetApiV1ChannelsMessages200Response|\WebMI\RocketChatApiClient\RoomsApi\Model\PostApiV1ChannelsCreate401Response, HTTP status code, HTTP response headers (array of strings)
     */
    public function getApiV1ChannelsMessagesWithHttpInfo($x_auth_token, $x_user_id, $room_id, $count = null, $sort = null, $offset = null, $mention_ids = null, $starred_ids = null, $pinned = null, string $contentType = self::contentTypes['getApiV1ChannelsMessages'][0])
    {
        $request = $this->getApiV1ChannelsMessagesRequest($x_auth_token, $x_user_id, $room_id, $count, $sort, $offset, $mention_ids, $starred_ids, $pinned, $contentType);
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\WebMI\RocketChatApiClient\RoomsApi\Model\GetApiV1ChannelsMessages200Response' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\WebMI\RocketChatApiClient\RoomsApi\Model\GetApiV1ChannelsMessages200Response' !== 'string') {
                            try {
                                $content = json_decode($content, false, 512, JSON_THROW_ON_ERROR);
                            } catch (\JsonException $exception) {
                                throw new ApiException(
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\WebMI\RocketChatApiClient\RoomsApi\Model\GetApiV1ChannelsMessages200Response', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                case 401:
            ...
            $returnType = '\WebMI\RocketChatApiClient\RoomsApi\Model\GetApiV1ChannelsMessages200Response';
            if ($returnType === '\SplFileObject') {
                $content = $response->getBody(); //stream goes to serializer
            } else {
                $content = (string) $response->getBody();
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\WebMI\RocketChatApiClient\RoomsApi\Model\GetApiV1ChannelsMessages200Response',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getApiV1ChannelsMessagesAsync($x_auth_token, $x_user_id, $room_id, $count = null, $sort = null, $offset = null, $mention_ids = null, $starred_ids = null, $pinned = null, string $contentType = self::contentTypes['getApiV1ChannelsMessages'][0])
    {
        return $this->getApiV1ChannelsMessagesAsyncWithHttpInfo($x_auth_token, $x_user_id, $room_id, $count, $sort, $offset, $mention_ids, $starred_ids, $pinned, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getApiV1ChannelsMessagesAsyncWithHttpInfo($x_auth_token, $x_user_id, $room_id, $count = null, $sort = null, $offset = null, $mention_ids = null, $starred_ids = null, $pinned = null, string $contentType = self::contentTypes['getApiV1ChannelsMessages'][0])
    {
        $returnType = '\WebMI\RocketChatApiClient\RoomsApi\Model\GetApiV1ChannelsMessages200Response';
        $request = $this->getApiV1ChannelsMessagesRequest($x_auth_token, $x_user_id, $room_id, $count, $sort, $offset, $mention_ids, $starred_ids, $pinned, $contentType);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function getApiV1ChannelsMessagesRequest($x_auth_token, $x_user_id, $room_id, $count = null, $sort = null, $offset = null, $mention_ids = null, $starred_ids = null, $pinned = null, string $contentType = self::contentTypes['getApiV1ChannelsMessages'][0])
    {
     ...
     * @throws \WebMI\RocketChatApiClient\RoomsApi\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return \WebMI\RocketChatApiClient\RoomsApi\Model\GetApiV1ChannelsModerators200Response|\WebMI\RocketChatApiClient\RoomsApi\Model\PostApiV1ChannelsCreate401Response
     */
     ...
     * @throws \WebMI\RocketChatApiClient\RoomsApi\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array of \WebMI\RocketChatApiClient\RoomsApi\Model\GetApiV1ChannelsModerators200Response|\WebMI\RocketChatApiClient\RoomsApi\Model\PostApiV1ChannelsCreate401Response, HTTP status code, HTTP response headers (array of strings)
     */
    public function getApiV1ChannelsModeratorsWithHttpInfo($x_auth_token, $x_user_id, $room_id = null, $room_name = null, string $contentType = self::contentTypes['getApiV1ChannelsModerators'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\WebMI\RocketChatApiClient\RoomsApi\Model\GetApiV1ChannelsModerators200Response' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\WebMI\RocketChatApiClient\RoomsApi\Model\GetApiV1ChannelsModerators200Response' !== 'string') {
                            try {
                                $content = json_decode($content, false, 512, JSON_THROW_ON_ERROR);
                            } catch (\JsonException $exception) {
                                throw new ApiException(
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\WebMI\RocketChatApiClient\RoomsApi\Model\GetApiV1ChannelsModerators200Response', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                case 401:
            ...
            $returnType = '\WebMI\RocketChatApiClient\RoomsApi\Model\GetApiV1ChannelsModerators200Response';
            if ($returnType === '\SplFileObject') {
                $content = $response->getBody(); //stream goes to serializer
            } else {
                $content = (string) $response->getBody();
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\WebMI\RocketChatApiClient\RoomsApi\Model\GetApiV1ChannelsModerators200Response',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     * @throws \WebMI\RocketChatApiClient\RoomsApi\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return \WebMI\RocketChatApiClient\RoomsApi\Model\GetApiV1ChannelsOnline200Response
     */
     ...
     * @throws \WebMI\RocketChatApiClient\RoomsApi\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array of \WebMI\RocketChatApiClient\RoomsApi\Model\GetApiV1ChannelsOnline200Response, HTTP status code, HTTP response headers (array of strings)
     */
     ...
     * @throws \WebMI\RocketChatApiClient\RoomsApi\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return \WebMI\RocketChatApiClient\RoomsApi\Model\GetApiV1ChannelsRoles200Response|\WebMI\RocketChatApiClient\RoomsApi\Model\PostApiV1ChannelsCreate401Response
     */
     ...
     * @throws \WebMI\RocketChatApiClient\RoomsApi\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array of \WebMI\RocketChatApiClient\RoomsApi\Model\GetApiV1ChannelsRoles200Response|\WebMI\RocketChatApiClient\RoomsApi\Model\PostApiV1ChannelsCreate401Response, HTTP status code, HTTP response headers (array of strings)
     */
    public function getApiV1ChannelsRolesWithHttpInfo($room_id = null, $room_name = null, string $contentType = self::contentTypes['getApiV1ChannelsRoles'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\WebMI\RocketChatApiClient\RoomsApi\Model\GetApiV1ChannelsRoles200Response' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\WebMI\RocketChatApiClient\RoomsApi\Model\GetApiV1ChannelsRoles200Response' !== 'string') {
                            try {
                                $content = json_decode($content, false, 512, JSON_THROW_ON_ERROR);
                            } catch (\JsonException $exception) {
                                throw new ApiException(
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\WebMI\RocketChatApiClient\RoomsApi\Model\GetApiV1ChannelsRoles200Response', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                case 401:
            ...
            $returnType = '\WebMI\RocketChatApiClient\RoomsApi\Model\GetApiV1ChannelsRoles200Response';
            if ($returnType === '\SplFileObject') {
                $content = $response->getBody(); //stream goes to serializer
            } else {
                $content = (string) $response->getBody();
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\WebMI\RocketChatApiClient\RoomsApi\Model\GetApiV1ChannelsRoles200Response',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     * @throws \WebMI\RocketChatApiClient\RoomsApi\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return \WebMI\RocketChatApiClient\RoomsApi\Model\GetChannelsMembersByHighestRole200Response
     */
     ...
     * @throws \WebMI\RocketChatApiClient\RoomsApi\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array of \WebMI\RocketChatApiClient\RoomsApi\Model\GetChannelsMembersByHighestRole200Response, HTTP status code, HTTP response headers (array of strings)
     */
     ...
     * @param  string $x_auth_token The &#x60;authToken&#x60; of the authenticated user. (required)
     * @param  string $x_user_id The &#x60;userId&#x60; of the authenticated user. (required)
     * @param  \WebMI\RocketChatApiClient\RoomsApi\Model\PosApiV1ChannelsRenameRequest|null $pos_api_v1_channels_rename_request pos_api_v1_channels_rename_request (optional)
     ...
     * @throws \WebMI\RocketChatApiClient\RoomsApi\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return \WebMI\RocketChatApiClient\RoomsApi\Model\PostApiV1ChannelsLeave200Response|\WebMI\RocketChatApiClient\RoomsApi\Model\PostApiV1ChannelsCreate401Response
     */
     ...
     * @param  string $x_auth_token The &#x60;authToken&#x60; of the authenticated user. (required)
     * @param  string $x_user_id The &#x60;userId&#x60; of the authenticated user. (required)
     * @param  \WebMI\RocketChatApiClient\RoomsApi\Model\PosApiV1ChannelsRenameRequest|null $pos_api_v1_channels_rename_request (optional)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['posApiV1ChannelsRename'] to see the possible values for this operation
     *
     * @throws \WebMI\RocketChatApiClient\RoomsApi\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array of \WebMI\RocketChatApiClient\RoomsApi\Model\PostApiV1ChannelsLeave200Response|\WebMI\RocketChatApiClient\RoomsApi\Model\PostApiV1ChannelsCreate401Response, HTTP status code, HTTP response headers (array of strings)
     */
    public function posApiV1ChannelsRenameWithHttpInfo($x_auth_token, $x_user_id, $pos_api_v1_channels_rename_request = null, string $contentType = self::contentTypes['posApiV1ChannelsRename'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\WebMI\RocketChatApiClient\RoomsApi\Model\PostApiV1ChannelsLeave200Response' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\WebMI\RocketChatApiClient\RoomsApi\Model\PostApiV1ChannelsLeave200Response' !== 'string') {
                            try {
                                $content = json_decode($content, false, 512, JSON_THROW_ON_ERROR);
                            } catch (\JsonException $exception) {
                                throw new ApiException(
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\WebMI\RocketChatApiClient\RoomsApi\Model\PostApiV1ChannelsLeave200Response', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                case 401:
            ...
            $returnType = '\WebMI\RocketChatApiClient\RoomsApi\Model\PostApiV1ChannelsLeave200Response';
            if ($returnType === '\SplFileObject') {
                $content = $response->getBody(); //stream goes to serializer
            } else {
                $content = (string) $response->getBody();
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\WebMI\RocketChatApiClient\RoomsApi\Model\PostApiV1ChannelsLeave200Response',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     * @param  string $x_auth_token The &#x60;authToken&#x60; of the authenticated user. (required)
     * @param  string $x_user_id The &#x60;userId&#x60; of the authenticated user. (required)
     * @param  \WebMI\RocketChatApiClient\RoomsApi\Model\PostApiV1ChannelsAddAllRequest|null $post_api_v1_channels_add_all_request post_api_v1_channels_add_all_request (optional)
     ...
     * @throws \WebMI\RocketChatApiClient\RoomsApi\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return \WebMI\RocketChatApiClient\RoomsApi\Model\PostApiV1ChannelsAddAll200Response|\WebMI\RocketChatApiClient\RoomsApi\Model\PostApiV1ChannelsCreate401Response
     */
     ...
     * @param  string $x_auth_token The &#x60;authToken&#x60; of the authenticated user. (required)
     * @param  string $x_user_id The &#x60;userId&#x60; of the authenticated user. (required)
     * @param  \WebMI\RocketChatApiClient\RoomsApi\Model\PostApiV1ChannelsAddAllRequest|null $post_api_v1_channels_add_all_request (optional)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['postApiV1ChannelsAddAll'] to see the possible values for this operation
     *
     * @throws \WebMI\RocketChatApiClient\RoomsApi\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array of \WebMI\RocketChatApiClient\RoomsApi\Model\PostApiV1ChannelsAddAll200Response|\WebMI\RocketChatApiClient\RoomsApi\Model\PostApiV1ChannelsCreate401Response, HTTP status code, HTTP response headers (array of strings)
     */
     ...
     * @param  string $x_auth_token The &#x60;authToken&#x60; of the authenticated user. (required)
     * @param  string $x_user_id The &#x60;userId&#x60; of the authenticated user. (required)
     * @param  \WebMI\RocketChatApiClient\RoomsApi\Model\PostApiV1ChannelsAddLeaderRequest|null $post_api_v1_channels_add_leader_request post_api_v1_channels_add_leader_request (optional)
     ...
     * @param  string $x_auth_token The &#x60;authToken&#x60; of the authenticated user. (required)
     * @param  string $x_user_id The &#x60;userId&#x60; of the authenticated user. (required)
     * @param  \WebMI\RocketChatApiClient\RoomsApi\Model\PostApiV1ChannelsAddLeaderRequest|null $post_api_v1_channels_add_leader_request (optional)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['postApiV1ChannelsAddLeader'] to see the possible values for this operation
     *
     * @throws \WebMI\RocketChatApiClient\RoomsApi\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     ...
     * @param  string $x_auth_token The &#x60;authToken&#x60; of the authenticated user. (required)
     * @param  string $x_user_id The &#x60;userId&#x60; of the authenticated user. (required)
     * @param  \WebMI\RocketChatApiClient\RoomsApi\Model\PostApiV1ChannelsAddModeratorRequest|null $post_api_v1_channels_add_moderator_request post_api_v1_channels_add_moderator_request (optional)
     ...
     * @param  string $x_auth_token The &#x60;authToken&#x60; of the authenticated user. (required)
     * @param  string $x_user_id The &#x60;userId&#x60; of the authenticated user. (required)
     * @param  \WebMI\RocketChatApiClient\RoomsApi\Model\PostApiV1ChannelsAddModeratorRequest|null $post_api_v1_channels_add_moderator_request (optional)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['postApiV1ChannelsAddModerator'] to see the possible values for this operation
     *
     * @throws \WebMI\RocketChatApiClient\RoomsApi\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     ...
     * @param  string $x_auth_token The &#x60;authToken&#x60; of the authenticated user. (required)
     * @param  string $x_user_id The &#x60;userId&#x60; of the authenticated user. (required)
     * @param  \WebMI\RocketChatApiClient\RoomsApi\Model\PostApiV1ChannelsAddOwnerRequest|null $post_api_v1_channels_add_owner_request post_api_v1_channels_add_owner_request (optional)
     ...
     * @throws \WebMI\RocketChatApiClient\RoomsApi\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return \WebMI\RocketChatApiClient\RoomsApi\Model\PostApiV1ChannelsAddLeader200Response|\WebMI\RocketChatApiClient\RoomsApi\Model\PostApiV1ChannelsAddOwner400Response|\WebMI\RocketChatApiClient\RoomsApi\Model\PostApiV1ChannelsCreate401Response
     */
     ...
     * @param  string $x_auth_token The &#x60;authToken&#x60; of the authenticated user. (required)
     * @param  string $x_user_id The &#x60;userId&#x60; of the authenticated user. (required)
     * @param  \WebMI\RocketChatApiClient\RoomsApi\Model\PostApiV1ChannelsAddOwnerRequest|null $post_api_v1_channels_add_owner_request (optional)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['postApiV1ChannelsAddOwner'] to see the possible values for this operation
     *
     * @throws \WebMI\RocketChatApiClient\RoomsApi\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array of \WebMI\RocketChatApiClient\RoomsApi\Model\PostApiV1ChannelsAddLeader200Response|\WebMI\RocketChatApiClient\RoomsApi\Model\PostApiV1ChannelsAddOwner400Response|\WebMI\RocketChatApiClient\RoomsApi\Model\PostApiV1ChannelsCreate401Response, HTTP status code, HTTP response headers (array of strings)
     */
     ...
     * @param  string $x_auth_token The &#x60;authToken&#x60; of the authenticated user. (required)
     * @param  string $x_user_id The &#x60;userId&#x60; of the authenticated user. (required)
     * @param  \WebMI\RocketChatApiClient\RoomsApi\Model\PostApiV1ChannelsArchiveRequest|null $post_api_v1_channels_archive_request post_api_v1_channels_archive_request (optional)
     ...
     * @param  string $x_auth_token The &#x60;authToken&#x60; of the authenticated user. (required)
     * @param  string $x_user_id The &#x60;userId&#x60; of the authenticated user. (required)
     * @param  \WebMI\RocketChatApiClient\RoomsApi\Model\PostApiV1ChannelsArchiveRequest|null $post_api_v1_channels_archive_request (optional)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['postApiV1ChannelsArchive'] to see the possible values for this operation
     *
     * @throws \WebMI\RocketChatApiClient\RoomsApi\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     ...
     * @param  string $x_auth_token The &#x60;authToken&#x60; of the authenticated user. (required)
     * @param  string $x_user_id The &#x60;userId&#x60; of the authenticated user. (required)
     * @param  \WebMI\RocketChatApiClient\RoomsApi\Model\PostApiV1ChannelsCloseRequest|null $post_api_v1_channels_close_request post_api_v1_channels_close_request (optional)
     ...
     * @throws \WebMI\RocketChatApiClient\RoomsApi\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return \WebMI\RocketChatApiClient\RoomsApi\Model\PostApiV1ChannelsAddLeader200Response|\WebMI\RocketChatApiClient\RoomsApi\Model\PostApiV1ChannelsClose400Response|\WebMI\RocketChatApiClient\RoomsApi\Model\PostApiV1ChannelsCreate401Response
     */
     ...
     * @param  string $x_auth_token The &#x60;authToken&#x60; of the authenticated user. (required)
     * @param  string $x_user_id The &#x60;userId&#x60; of the authenticated user. (required)
     * @param  \WebMI\RocketChatApiClient\RoomsApi\Model\PostApiV1ChannelsCloseRequest|null $post_api_v1_channels_close_request (optional)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['postApiV1ChannelsClose'] to see the possible values for this operation
     *
     * @throws \WebMI\RocketChatApiClient\RoomsApi\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     ...
     * @param  string $x_auth_token The &#x60;authToken&#x60; of the authenticated user. (required)
     * @param  string $x_user_id The &#x60;userId&#x60; of the authenticated user. (required)
     * @param  \WebMI\RocketChatApiClient\RoomsApi\Model\PostApiV1ChannelsConvertToTeamRequest|null $post_api_v1_channels_convert_to_team_request post_api_v1_channels_convert_to_team_request (optional)
     ...
     * @throws \WebMI\RocketChatApiClient\RoomsApi\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return \WebMI\RocketChatApiClient\RoomsApi\Model\PostApiV1ChannelsConvertToTeam200Response|\WebMI\RocketChatApiClient\RoomsApi\Model\PostApiV1ChannelsCreate401Response
     */
     ...
     * @param  string $x_auth_token The &#x60;authToken&#x60; of the authenticated user. (required)
     * @param  string $x_user_id The &#x60;userId&#x60; of the authenticated user. (required)
     * @param  \WebMI\RocketChatApiClient\RoomsApi\Model\PostApiV1ChannelsConvertToTeamRequest|null $post_api_v1_channels_convert_to_team_request (optional)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['postApiV1ChannelsConvertToTeam'] to see the possible values for this operation
     *
     * @throws \WebMI\RocketChatApiClient\RoomsApi\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array of \WebMI\RocketChatApiClient\RoomsApi\Model\PostApiV1ChannelsConvertToTeam200Response|\WebMI\RocketChatApiClient\RoomsApi\Model\PostApiV1ChannelsCreate401Response, HTTP status code, HTTP response headers (array of strings)
     */
     ...
     * @param  string $x_auth_token The &#x60;authToken&#x60; of the authenticated user. (required)
     * @param  string $x_user_id The &#x60;userId&#x60; of the authenticated user. (required)
     * @param  \WebMI\RocketChatApiClient\RoomsApi\Model\PostApiV1ChannelsCreateRequest|null $post_api_v1_channels_create_request post_api_v1_channels_create_request (optional)
     ...
     * @throws \WebMI\RocketChatApiClient\RoomsApi\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return \WebMI\RocketChatApiClient\RoomsApi\Model\PostApiV1ChannelsCreate200Response|\WebMI\RocketChatApiClient\RoomsApi\Model\PostApiV1ChannelsCreate401Response
     */
     ...
     * @param  string $x_auth_token The &#x60;authToken&#x60; of the authenticated user. (required)
     * @param  string $x_user_id The &#x60;userId&#x60; of the authenticated user. (required)
     * @param  \WebMI\RocketChatApiClient\RoomsApi\Model\PostApiV1ChannelsCreateRequest|null $post_api_v1_channels_create_request (optional)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['postApiV1ChannelsCreate'] to see the possible values for this operation
     *
     * @throws \WebMI\RocketChatApiClient\RoomsApi\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array of \WebMI\RocketChatApiClient\RoomsApi\Model\PostApiV1ChannelsCreate200Response|\WebMI\RocketChatApiClient\RoomsApi\Model\PostApiV1ChannelsCreate401Response, HTTP status code, HTTP response headers (array of strings)
     */
    public function postApiV1ChannelsCreateWithHttpInfo($x_auth_token, $x_user_id, $post_api_v1_channels_create_request = null, string $contentType = self::contentTypes['postApiV1ChannelsCreate'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\WebMI\RocketChatApiClient\RoomsApi\Model\PostApiV1ChannelsCreate200Response' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\WebMI\RocketChatApiClient\RoomsApi\Model\PostApiV1ChannelsCreate200Response' !== 'string') {
                            try {
                                $content = json_decode($content, false, 512, JSON_THROW_ON_ERROR);
                            } catch (\JsonException $exception) {
                                throw new ApiException(
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\WebMI\RocketChatApiClient\RoomsApi\Model\PostApiV1ChannelsCreate200Response', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                case 401:
            ...
            $returnType = '\WebMI\RocketChatApiClient\RoomsApi\Model\PostApiV1ChannelsCreate200Response';
            if ($returnType === '\SplFileObject') {
                $content = $response->getBody(); //stream goes to serializer
            } else {
                $content = (string) $response->getBody();
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\WebMI\RocketChatApiClient\RoomsApi\Model\PostApiV1ChannelsCreate200Response',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     * @param  string $x_auth_token The &#x60;authToken&#x60; of the authenticated user. (required)
     * @param  string $x_user_id The &#x60;userId&#x60; of the authenticated user. (required)
     * @param  \WebMI\RocketChatApiClient\RoomsApi\Model\PostApiV1ChannelsDeleteRequest|null $post_api_v1_channels_delete_request post_api_v1_channels_delete_request (optional)
     ...
     * @throws \WebMI\RocketChatApiClient\RoomsApi\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return \WebMI\RocketChatApiClient\RoomsApi\Model\PostApiV1ChannelsAddLeader200Response
     */
     ...
     * @param  string $x_auth_token The &#x60;authToken&#x60; of the authenticated user. (required)
     * @param  string $x_user_id The &#x60;userId&#x60; of the authenticated user. (required)
     * @param  \WebMI\RocketChatApiClient\RoomsApi\Model\PostApiV1ChannelsDeleteRequest|null $post_api_v1_channels_delete_request (optional)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['postApiV1ChannelsDelete'] to see the possible values for this operation
     *
     * @throws \WebMI\RocketChatApiClient\RoomsApi\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array of \WebMI\RocketChatApiClient\RoomsApi\Model\PostApiV1ChannelsAddLeader200Response, HTTP status code, HTTP response headers (array of strings)
     */
     ...
     * @param  string $x_auth_token The &#x60;authToken&#x60; of the authenticated user. (required)
     * @param  string $x_user_id The &#x60;userId&#x60; of the authenticated user. (required)
     * @param  \WebMI\RocketChatApiClient\RoomsApi\Model\PostApiV1ChannelsInviteRequest|null $post_api_v1_channels_invite_request post_api_v1_channels_invite_request (optional)
     ...
     * @throws \WebMI\RocketChatApiClient\RoomsApi\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return \WebMI\RocketChatApiClient\RoomsApi\Model\PostApiV1ChannelsInvite200Response
     */
     ...
     * @param  string $x_auth_token The &#x60;authToken&#x60; of the authenticated user. (required)
     * @param  string $x_user_id The &#x60;userId&#x60; of the authenticated user. (required)
     * @param  \WebMI\RocketChatApiClient\RoomsApi\Model\PostApiV1ChannelsInviteRequest|null $post_api_v1_channels_invite_request (optional)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['postApiV1ChannelsInvite'] to see the possible values for this operation
     *
     * @throws \WebMI\RocketChatApiClient\RoomsApi\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array of \WebMI\RocketChatApiClient\RoomsApi\Model\PostApiV1ChannelsInvite200Response, HTTP status code, HTTP response headers (array of strings)
     */
    public function postApiV1ChannelsInviteWithHttpInfo($x_auth_token, $x_user_id, $post_api_v1_channels_invite_request = null, string $contentType = self::contentTypes['postApiV1ChannelsInvite'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\WebMI\RocketChatApiClient\RoomsApi\Model\PostApiV1ChannelsInvite200Response' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\WebMI\RocketChatApiClient\RoomsApi\Model\PostApiV1ChannelsInvite200Response' !== 'string') {
                            try {
                                $content = json_decode($content, false, 512, JSON_THROW_ON_ERROR);
                            } catch (\JsonException $exception) {
                                throw new ApiException(
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\WebMI\RocketChatApiClient\RoomsApi\Model\PostApiV1ChannelsInvite200Response', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
            }
            ...
            $returnType = '\WebMI\RocketChatApiClient\RoomsApi\Model\PostApiV1ChannelsInvite200Response';
            if ($returnType === '\SplFileObject') {
                $content = $response->getBody(); //stream goes to serializer
            } else {
                $content = (string) $response->getBody();
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\WebMI\RocketChatApiClient\RoomsApi\Model\PostApiV1ChannelsInvite200Response',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     * @param  string $x_auth_token The &#x60;authToken&#x60; of the authenticated user. (required)
     * @param  string $x_user_id The &#x60;userId&#x60; of the authenticated user. (required)
     * @param  \WebMI\RocketChatApiClient\RoomsApi\Model\PostApiV1ChannelsJoinRequest|null $post_api_v1_channels_join_request post_api_v1_channels_join_request (optional)
     ...
     * @param  string $x_auth_token The &#x60;authToken&#x60; of the authenticated user. (required)
     * @param  string $x_user_id The &#x60;userId&#x60; of the authenticated user. (required)
     * @param  \WebMI\RocketChatApiClient\RoomsApi\Model\PostApiV1ChannelsJoinRequest|null $post_api_v1_channels_join_request (optional)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['postApiV1ChannelsJoin'] to see the possible values for this operation
     *
     * @throws \WebMI\RocketChatApiClient\RoomsApi\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     ...
     *
     * @param  \WebMI\RocketChatApiClient\RoomsApi\Model\PostApiV1ChannelsKickRequest|null $post_api_v1_channels_kick_request post_api_v1_channels_kick_request (optional)
     ...
     * Remove User from Channel
     *
     * @param  \WebMI\RocketChatApiClient\RoomsApi\Model\PostApiV1ChannelsKickRequest|null $post_api_v1_channels_kick_request (optional)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['postApiV1ChannelsKick'] to see the possible values for this operation
     *
     * @throws \WebMI\RocketChatApiClient\RoomsApi\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     ...
     * @param  string $x_auth_token The &#x60;authToken&#x60; of the authenticated user. (required)
     * @param  string $x_user_id The &#x60;userId&#x60; of the authenticated user. (required)
     * @param  \WebMI\RocketChatApiClient\RoomsApi\Model\PostApiV1ChannelsLeaveRequest|null $post_api_v1_channels_leave_request post_api_v1_channels_leave_request (optional)
     ...
     * @throws \WebMI\RocketChatApiClient\RoomsApi\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return \WebMI\RocketChatApiClient\RoomsApi\Model\PostApiV1ChannelsLeave200Response
     */
     ...
     * @param  string $x_auth_token The &#x60;authToken&#x60; of the authenticated user. (required)
     * @param  string $x_user_id The &#x60;userId&#x60; of the authenticated user. (required)
     * @param  \WebMI\RocketChatApiClient\RoomsApi\Model\PostApiV1ChannelsLeaveRequest|null $post_api_v1_channels_leave_request (optional)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['postApiV1ChannelsLeave'] to see the possible values for this operation
     *
     * @throws \WebMI\RocketChatApiClient\RoomsApi\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array of \WebMI\RocketChatApiClient\RoomsApi\Model\PostApiV1ChannelsLeave200Response, HTTP status code, HTTP response headers (array of strings)
     */
     ...
     * @param  string $x_auth_token The &#x60;authToken&#x60; of the authenticated user. (required)
     * @param  string $x_user_id The &#x60;userId&#x60; of the authenticated user. (required)
     * @param  \WebMI\RocketChatApiClient\RoomsApi\Model\PostApiV1ChannelsOpenRequest|null $post_api_v1_channels_open_request post_api_v1_channels_open_request (optional)
     ...
     * @param  string $x_auth_token The &#x60;authToken&#x60; of the authenticated user. (required)
     * @param  string $x_user_id The &#x60;userId&#x60; of the authenticated user. (required)
     * @param  \WebMI\RocketChatApiClient\RoomsApi\Model\PostApiV1ChannelsOpenRequest|null $post_api_v1_channels_open_request (optional)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['postApiV1ChannelsOpen'] to see the possible values for this operation
     *
     * @throws \WebMI\RocketChatApiClient\RoomsApi\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     ...
     * @param  string $x_auth_token The &#x60;authToken&#x60; of the authenticated user. (required)
     * @param  string $x_user_id The &#x60;userId&#x60; of the authenticated user. (required)
     * @param  \WebMI\RocketChatApiClient\RoomsApi\Model\PostApiV1ChannelsRemoveLeaderRequest|null $post_api_v1_channels_remove_leader_request post_api_v1_channels_remove_leader_request (optional)
     ...
     * @param  string $x_auth_token The &#x60;authToken&#x60; of the authenticated user. (required)
     * @param  string $x_user_id The &#x60;userId&#x60; of the authenticated user. (required)
     * @param  \WebMI\RocketChatApiClient\RoomsApi\Model\PostApiV1ChannelsRemoveLeaderRequest|null $post_api_v1_channels_remove_leader_request (optional)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['postApiV1ChannelsRemoveLeader'] to see the possible values for this operation
     *
     * @throws \WebMI\RocketChatApiClient\RoomsApi\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     ...
     * @param  string $x_user_id The &#x60;userId&#x60; of the authenticated user. (required)
     * @param  string $x_auth_token The &#x60;authToken&#x60; of the authenticated user. (required)
     * @param  \WebMI\RocketChatApiClient\RoomsApi\Model\PostApiV1ChannelsSetAnnouncementRequest|null $post_api_v1_channels_set_announcement_request post_api_v1_channels_set_announcement_request (optional)
     ...
     * @param  string $x_user_id The &#x60;userId&#x60; of the authenticated user. (required)
     * @param  string $x_auth_token The &#x60;authToken&#x60; of the authenticated user. (required)
     * @param  \WebMI\RocketChatApiClient\RoomsApi\Model\PostApiV1ChannelsSetAnnouncementRequest|null $post_api_v1_channels_set_announcement_request (optional)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['postApiV1ChannelsSetAnnouncement'] to see the possible values for this operation
     *
     * @throws \WebMI\RocketChatApiClient\RoomsApi\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     ...
     * @param  string $x_user_id The &#x60;userId&#x60; of the authenticated user. (required)
     * @param  string $x_auth_token The &#x60;authToken&#x60; of the authenticated user. (required)
     * @param  \WebMI\RocketChatApiClient\RoomsApi\Model\PostApiV1ChannelsSetCustomFieldsRequest|null $post_api_v1_channels_set_custom_fields_request post_api_v1_channels_set_custom_fields_request (optional)
     ...
     * @throws \WebMI\RocketChatApiClient\RoomsApi\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return \WebMI\RocketChatApiClient\RoomsApi\Model\PostApiV1ChannelsSetCustomFields200Response|\WebMI\RocketChatApiClient\RoomsApi\Model\PostApiV1ChannelsCreate401Response
     */
     ...
     * @param  string $x_user_id The &#x60;userId&#x60; of the authenticated user. (required)
     * @param  string $x_auth_token The &#x60;authToken&#x60; of the authenticated user. (required)
     * @param  \WebMI\RocketChatApiClient\RoomsApi\Model\PostApiV1ChannelsSetCustomFieldsRequest|null $post_api_v1_channels_set_custom_fields_request (optional)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['postApiV1ChannelsSetCustomFields'] to see the possible values for this operation
     *
     * @throws \WebMI\RocketChatApiClient\RoomsApi\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array of \WebMI\RocketChatApiClient\RoomsApi\Model\PostApiV1ChannelsSetCustomFields200Response|\WebMI\RocketChatApiClient\RoomsApi\Model\PostApiV1ChannelsCreate401Response, HTTP status code, HTTP response headers (array of strings)
     */
    public function postApiV1ChannelsSetCustomFieldsWithHttpInfo($x_user_id, $x_auth_token, $post_api_v1_channels_set_custom_fields_request = null, string $contentType = self::contentTypes['postApiV1ChannelsSetCustomFields'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\WebMI\RocketChatApiClient\RoomsApi\Model\PostApiV1ChannelsSetCustomFields200Response' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\WebMI\RocketChatApiClient\RoomsApi\Model\PostApiV1ChannelsSetCustomFields200Response' !== 'string') {
                            try {
                                $content = json_decode($content, false, 512, JSON_THROW_ON_ERROR);
                            } catch (\JsonException $exception) {
                                throw new ApiException(
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\WebMI\RocketChatApiClient\RoomsApi\Model\PostApiV1ChannelsSetCustomFields200Response', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                case 401:
            ...
            $returnType = '\WebMI\RocketChatApiClient\RoomsApi\Model\PostApiV1ChannelsSetCustomFields200Response';
            if ($returnType === '\SplFileObject') {
                $content = $response->getBody(); //stream goes to serializer
            } else {
                $content = (string) $response->getBody();
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\WebMI\RocketChatApiClient\RoomsApi\Model\PostApiV1ChannelsSetCustomFields200Response',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     * @param  string $x_auth_token The &#x60;authToken&#x60; of the authenticated user. (required)
     * @param  string $x_user_id The &#x60;userId&#x60; of the authenticated user. (required)
     * @param  \WebMI\RocketChatApiClient\RoomsApi\Model\PostApiV1ChannelsSetDefaultRequest|null $post_api_v1_channels_set_default_request post_api_v1_channels_set_default_request (optional)
     ...
     * @throws \WebMI\RocketChatApiClient\RoomsApi\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return \WebMI\RocketChatApiClient\RoomsApi\Model\PostApiV1ChannelsSetDefault200Response|\WebMI\RocketChatApiClient\RoomsApi\Model\PostApiV1ChannelsCreate401Response
     */
     ...
     * @param  string $x_auth_token The &#x60;authToken&#x60; of the authenticated user. (required)
     * @param  string $x_user_id The &#x60;userId&#x60; of the authenticated user. (required)
     * @param  \WebMI\RocketChatApiClient\RoomsApi\Model\PostApiV1ChannelsSetDefaultRequest|null $post_api_v1_channels_set_default_request (optional)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['postApiV1ChannelsSetDefault'] to see the possible values for this operation
     *
     * @throws \WebMI\RocketChatApiClient\RoomsApi\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array of \WebMI\RocketChatApiClient\RoomsApi\Model\PostApiV1ChannelsSetDefault200Response|\WebMI\RocketChatApiClient\RoomsApi\Model\PostApiV1ChannelsCreate401Response, HTTP status code, HTTP response headers (array of strings)
     */
    public function postApiV1ChannelsSetDefaultWithHttpInfo($x_auth_token, $x_user_id, $post_api_v1_channels_set_default_request = null, string $contentType = self::contentTypes['postApiV1ChannelsSetDefault'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\WebMI\RocketChatApiClient\RoomsApi\Model\PostApiV1ChannelsSetDefault200Response' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\WebMI\RocketChatApiClient\RoomsApi\Model\PostApiV1ChannelsSetDefault200Response' !== 'string') {
                            try {
                                $content = json_decode($content, false, 512, JSON_THROW_ON_ERROR);
                            } catch (\JsonException $exception) {
                                throw new ApiException(
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\WebMI\RocketChatApiClient\RoomsApi\Model\PostApiV1ChannelsSetDefault200Response', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                case 401:
            ...
            $returnType = '\WebMI\RocketChatApiClient\RoomsApi\Model\PostApiV1ChannelsSetDefault200Response';
            if ($returnType === '\SplFileObject') {
                $content = $response->getBody(); //stream goes to serializer
            } else {
                $content = (string) $response->getBody();
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\WebMI\RocketChatApiClient\RoomsApi\Model\PostApiV1ChannelsSetDefault200Response',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     * @param  string $x_auth_token The &#x60;authToken&#x60; of the authenticated user. (required)
     * @param  string $x_user_id The &#x60;userId&#x60; of the authenticated user. (required)
     * @param  \WebMI\RocketChatApiClient\RoomsApi\Model\PostApiV1ChannelsSetDescriptionRequest|null $post_api_v1_channels_set_description_request  (optional)
     ...
     * @param  string $x_auth_token The &#x60;authToken&#x60; of the authenticated user. (required)
     * @param  string $x_user_id The &#x60;userId&#x60; of the authenticated user. (required)
     * @param  \WebMI\RocketChatApiClient\RoomsApi\Model\PostApiV1ChannelsSetJoinCodeRequest|null $post_api_v1_channels_set_join_code_request post_api_v1_channels_set_join_code_request (optional)
     ...
     * @throws \WebMI\RocketChatApiClient\RoomsApi\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return \WebMI\RocketChatApiClient\RoomsApi\Model\PostApiV1ChannelsSetJoinCode200Response|\WebMI\RocketChatApiClient\RoomsApi\Model\PostApiV1ChannelsCreate401Response
     */
     ...
     * @param  string $x_auth_token The &#x60;authToken&#x60; of the authenticated user. (required)
     * @param  string $x_user_id The &#x60;userId&#x60; of the authenticated user. (required)
     * @param  \WebMI\RocketChatApiClient\RoomsApi\Model\PostApiV1ChannelsSetJoinCodeRequest|null $post_api_v1_channels_set_join_code_request (optional)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['postApiV1ChannelsSetJoinCode'] to see the possible values for this operation
     *
     * @throws \WebMI\RocketChatApiClient\RoomsApi\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array of \WebMI\RocketChatApiClient\RoomsApi\Model\PostApiV1ChannelsSetJoinCode200Response|\WebMI\RocketChatApiClient\RoomsApi\Model\PostApiV1ChannelsCreate401Response, HTTP status code, HTTP response headers (array of strings)
     */
    public function postApiV1ChannelsSetJoinCodeWithHttpInfo($x_auth_token, $x_user_id, $post_api_v1_channels_set_join_code_request = null, string $contentType = self::contentTypes['postApiV1ChannelsSetJoinCode'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\WebMI\RocketChatApiClient\RoomsApi\Model\PostApiV1ChannelsSetJoinCode200Response' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\WebMI\RocketChatApiClient\RoomsApi\Model\PostApiV1ChannelsSetJoinCode200Response' !== 'string') {
                            try {
                                $content = json_decode($content, false, 512, JSON_THROW_ON_ERROR);
                            } catch (\JsonException $exception) {
                                throw new ApiException(
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\WebMI\RocketChatApiClient\RoomsApi\Model\PostApiV1ChannelsSetJoinCode200Response', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                case 401:
            ...
            $returnType = '\WebMI\RocketChatApiClient\RoomsApi\Model\PostApiV1ChannelsSetJoinCode200Response';
            if ($returnType === '\SplFileObject') {
                $content = $response->getBody(); //stream goes to serializer
            } else {
                $content = (string) $response->getBody();
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\WebMI\RocketChatApiClient\RoomsApi\Model\PostApiV1ChannelsSetJoinCode200Response',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     * @param  string $x_auth_token The &#x60;authToken&#x60; of the authenticated user. (required)
     * @param  string $x_user_id The &#x60;userId&#x60; of the authenticated user. (required)
     * @param  \WebMI\RocketChatApiClient\RoomsApi\Model\PostApiV1ChannelsSetPurposeRequest|null $post_api_v1_channels_set_purpose_request post_api_v1_channels_set_purpose_request (optional)
     ...
     * @throws \WebMI\RocketChatApiClient\RoomsApi\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return \WebMI\RocketChatApiClient\RoomsApi\Model\PostApiV1ChannelsSetPurpose200Response|\WebMI\RocketChatApiClient\RoomsApi\Model\PostApiV1ChannelsCreate401Response
     */
     ...
     * @param  string $x_auth_token The &#x60;authToken&#x60; of the authenticated user. (required)
     * @param  string $x_user_id The &#x60;userId&#x60; of the authenticated user. (required)
     * @param  \WebMI\RocketChatApiClient\RoomsApi\Model\PostApiV1ChannelsSetPurposeRequest|null $post_api_v1_channels_set_purpose_request (optional)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['postApiV1ChannelsSetPurpose'] to see the possible values for this operation
     *
     * @throws \WebMI\RocketChatApiClient\RoomsApi\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array of \WebMI\RocketChatApiClient\RoomsApi\Model\PostApiV1ChannelsSetPurpose200Response|\WebMI\RocketChatApiClient\RoomsApi\Model\PostApiV1ChannelsCreate401Response, HTTP status code, HTTP response headers (array of strings)
     */
     ...
     * @param  string $x_auth_token The &#x60;authToken&#x60; of the authenticated user. (required)
     * @param  string $x_user_id The &#x60;userId&#x60; of the authenticated user. (required)
     * @param  \WebMI\RocketChatApiClient\RoomsApi\Model\PostApiV1ChannelsSetReadOnlyRequest|null $post_api_v1_channels_set_read_only_request post_api_v1_channels_set_read_only_request (optional)
     ...
     * @throws \WebMI\RocketChatApiClient\RoomsApi\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return \WebMI\RocketChatApiClient\RoomsApi\Model\PostApiV1ChannelsSetReadOnly200Response|\WebMI\RocketChatApiClient\RoomsApi\Model\PostApiV1ChannelsCreate401Response
     */
     ...
     * @param  string $x_auth_token The &#x60;authToken&#x60; of the authenticated user. (required)
     * @param  string $x_user_id The &#x60;userId&#x60; of the authenticated user. (required)
     * @param  \WebMI\RocketChatApiClient\RoomsApi\Model\PostApiV1ChannelsSetReadOnlyRequest|null $post_api_v1_channels_set_read_only_request (optional)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['postApiV1ChannelsSetReadOnly'] to see the possible values for this operation
     *
     * @throws \WebMI\RocketChatApiClient\RoomsApi\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array of \WebMI\RocketChatApiClient\RoomsApi\Model\PostApiV1ChannelsSetReadOnly200Response|\WebMI\RocketChatApiClient\RoomsApi\Model\PostApiV1ChannelsCreate401Response, HTTP status code, HTTP response headers (array of strings)
     */
    public function postApiV1ChannelsSetReadOnlyWithHttpInfo($x_auth_token, $x_user_id, $post_api_v1_channels_set_read_only_request = null, string $contentType = self::contentTypes['postApiV1ChannelsSetReadOnly'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\WebMI\RocketChatApiClient\RoomsApi\Model\PostApiV1ChannelsSetReadOnly200Response' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\WebMI\RocketChatApiClient\RoomsApi\Model\PostApiV1ChannelsSetReadOnly200Response' !== 'string') {
                            try {
                                $content = json_decode($content, false, 512, JSON_THROW_ON_ERROR);
                            } catch (\JsonException $exception) {
                                throw new ApiException(
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\WebMI\RocketChatApiClient\RoomsApi\Model\PostApiV1ChannelsSetReadOnly200Response', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                case 401:
            ...
            $returnType = '\WebMI\RocketChatApiClient\RoomsApi\Model\PostApiV1ChannelsSetReadOnly200Response';
            if ($returnType === '\SplFileObject') {
                $content = $response->getBody(); //stream goes to serializer
            } else {
                $content = (string) $response->getBody();
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\WebMI\RocketChatApiClient\RoomsApi\Model\PostApiV1ChannelsSetReadOnly200Response',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     * @param  string $x_auth_token The &#x60;authToken&#x60; of the authenticated user. (required)
     * @param  string $x_user_id The &#x60;userId&#x60; of the authenticated user. (required)
     * @param  \WebMI\RocketChatApiClient\RoomsApi\Model\PostApiV1ChannelsSetTopicRequest|null $post_api_v1_channels_set_topic_request post_api_v1_channels_set_topic_request (optional)
     ...
     * @param  string $x_auth_token The &#x60;authToken&#x60; of the authenticated user. (required)
     * @param  string $x_user_id The &#x60;userId&#x60; of the authenticated user. (required)
     * @param  \WebMI\RocketChatApiClient\RoomsApi\Model\PostApiV1ChannelsSetTopicRequest|null $post_api_v1_channels_set_topic_request (optional)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['postApiV1ChannelsSetTopic'] to see the possible values for this operation
     *
     * @throws \WebMI\RocketChatApiClient\RoomsApi\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     ...
     * @param  string $x_auth_token The &#x60;authToken&#x60; of the authenticated user. (required)
     * @param  string $x_user_id The &#x60;userId&#x60; of the authenticated user. (required)
     * @param  \WebMI\RocketChatApiClient\RoomsApi\Model\PostApiV1ChannelsSetTypeRequest|null $post_api_v1_channels_set_type_request  (optional)
     ...
     * @throws \WebMI\RocketChatApiClient\RoomsApi\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return \WebMI\RocketChatApiClient\RoomsApi\Model\PostApiV1ChannelsSetReadOnly200Response
     */
     ...
     * @throws \WebMI\RocketChatApiClient\RoomsApi\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array of \WebMI\RocketChatApiClient\RoomsApi\Model\PostApiV1ChannelsSetReadOnly200Response, HTTP status code, HTTP response headers (array of strings)
     */
     ...
     * @param  string $x_auth_token The &#x60;authToken&#x60; of the authenticated user. (required)
     * @param  string $x_user_id The &#x60;userId&#x60; of the authenticated user. (required)
     * @param  \WebMI\RocketChatApiClient\RoomsApi\Model\PostApiV1ChannelsUnarchiveRequest|null $post_api_v1_channels_unarchive_request post_api_v1_channels_unarchive_request (optional)
     ...
     * @param  string $x_auth_token The &#x60;authToken&#x60; of the authenticated user. (required)
     * @param  string $x_user_id The &#x60;userId&#x60; of the authenticated user. (required)
     * @param  \WebMI\RocketChatApiClient\RoomsApi\Model\PostApiV1ChannelsUnarchiveRequest|null $post_api_v1_channels_unarchive_request (optional)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['postApiV1ChannelsUnarchive'] to see the possible values for this operation
     *
     * @throws \WebMI\RocketChatApiClient\RoomsApi\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
