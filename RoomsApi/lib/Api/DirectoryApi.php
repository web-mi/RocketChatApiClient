...
class DirectoryApi
{
     ...
     * @param  string|null $text The search term to be filtered (optional)
     * @param  string|null $type It can be &#x60;channels&#x60; or &#x60;users&#x60;. When &#x60;type&#x60; is users you can send an additional workspace field, that can be local (default) or all. Workspace&#x3D;all will work only if &lt;a href&#x3D;\&quot;https://docs.rocket.chat/use-rocket.chat/rocket.chat-federation\&quot; target&#x3D;\&quot;_blank\&quot;&gt;federation&lt;/a&gt; is enabled. (optional)
     * @param  string|null $workspace It can be &#x60;local&#x60; or &#x60;all&#x60;( if federation is enabled). It is &#x60;local&#x60; by default. (optional)
     ...
     */
    public function getApiV1Directory($x_auth_token, $x_user_id, $query, $text = null, $type = null, $workspace = null, $offset = null, $count = null, $sort = null, $fields = null, string $contentType = self::contentTypes['getApiV1Directory'][0])
    {
        list($response) = $this->getApiV1DirectoryWithHttpInfo($x_auth_token, $x_user_id, $query, $text, $type, $workspace, $offset, $count, $sort, $fields, $contentType);
        return $response;
    }
     ...
     */
    public function getApiV1DirectoryWithHttpInfo($x_auth_token, $x_user_id, $query, $text = null, $type = null, $workspace = null, $offset = null, $count = null, $sort = null, $fields = null, string $contentType = self::contentTypes['getApiV1Directory'][0])
    {
        $request = $this->getApiV1DirectoryRequest($x_auth_token, $x_user_id, $query, $text, $type, $workspace, $offset, $count, $sort, $fields, $contentType);
     ...
     */
    public function getApiV1DirectoryAsync($x_auth_token, $x_user_id, $query, $text = null, $type = null, $workspace = null, $offset = null, $count = null, $sort = null, $fields = null, string $contentType = self::contentTypes['getApiV1Directory'][0])
    {
        return $this->getApiV1DirectoryAsyncWithHttpInfo($x_auth_token, $x_user_id, $query, $text, $type, $workspace, $offset, $count, $sort, $fields, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getApiV1DirectoryAsyncWithHttpInfo($x_auth_token, $x_user_id, $query, $text = null, $type = null, $workspace = null, $offset = null, $count = null, $sort = null, $fields = null, string $contentType = self::contentTypes['getApiV1Directory'][0])
    {
        $returnType = '\WebMI\RocketChatApiClient\RoomsApi\Model\GetApiV1Directory200Response';
        $request = $this->getApiV1DirectoryRequest($x_auth_token, $x_user_id, $query, $text, $type, $workspace, $offset, $count, $sort, $fields, $contentType);
     ...
     */
    public function getApiV1DirectoryRequest($x_auth_token, $x_user_id, $query, $text = null, $type = null, $workspace = null, $offset = null, $count = null, $sort = null, $fields = null, string $contentType = self::contentTypes['getApiV1Directory'][0])
    {
