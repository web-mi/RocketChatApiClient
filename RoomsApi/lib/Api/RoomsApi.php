...
class RoomsApi
{
     ...
     * @param  string $x_auth_token The &#x60;authToken&#x60; of the authenticated user. (required)
     * @param  string $x_user_id The &#x60;userId&#x60; of the authenticated user. (required)
     * @param  \WebMI\RocketChatApiClient\RoomsApi\Model\GetApiV1RoomsCleanHistoryRequest $get_api_v1_rooms_clean_history_request get_api_v1_rooms_clean_history_request (optional)
     ...
     * @param  string $x_auth_token The &#x60;authToken&#x60; of the authenticated user. (required)
     * @param  string $x_user_id The &#x60;userId&#x60; of the authenticated user. (required)
     * @param  \WebMI\RocketChatApiClient\RoomsApi\Model\GetApiV1RoomsCleanHistoryRequest $get_api_v1_rooms_clean_history_request (optional)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['getApiV1RoomsCleanHistory'] to see the possible values for this operation
     *
     * @throws \WebMI\RocketChatApiClient\RoomsApi\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     ...
     * @param  string $x_auth_token The &#x60;authToken&#x60; of the authenticated user. (required)
     * @param  string $x_user_id The &#x60;userId&#x60; of the authenticated user. (required)
     * @param  \WebMI\RocketChatApiClient\RoomsApi\Model\GetApiV1RoomsDeleteRequest $get_api_v1_rooms_delete_request get_api_v1_rooms_delete_request (optional)
     ...
     * @param  string $x_auth_token The &#x60;authToken&#x60; of the authenticated user. (required)
     * @param  string $x_user_id The &#x60;userId&#x60; of the authenticated user. (required)
     * @param  \WebMI\RocketChatApiClient\RoomsApi\Model\GetApiV1RoomsDeleteRequest $get_api_v1_rooms_delete_request (optional)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['getApiV1RoomsDelete'] to see the possible values for this operation
     *
     * @throws \WebMI\RocketChatApiClient\RoomsApi\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     ...
     * @param  string $x_auth_token The &#x60;authToken&#x60; of the authenticated user. (required)
     * @param  string $x_user_id The &#x60;userId&#x60; of the authenticated user. (required)
     * @param  \WebMI\RocketChatApiClient\RoomsApi\Model\PostApiV1RoomsAutocompleteChannelAndPrivateRequest $post_api_v1_rooms_autocomplete_channel_and_private_request post_api_v1_rooms_autocomplete_channel_and_private_request (optional)
     ...
     * @param  string $x_auth_token The &#x60;authToken&#x60; of the authenticated user. (required)
     * @param  string $x_user_id The &#x60;userId&#x60; of the authenticated user. (required)
     * @param  \WebMI\RocketChatApiClient\RoomsApi\Model\PostApiV1RoomsAutocompleteChannelAndPrivateRequest $post_api_v1_rooms_autocomplete_channel_and_private_request (optional)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['postApiV1RoomsAutocompleteChannelAndPrivate'] to see the possible values for this operation
     *
     * @throws \WebMI\RocketChatApiClient\RoomsApi\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     ...
     * @param  string $x_auth_token The &#x60;authToken&#x60; of the authenticated user. (required)
     * @param  string $x_user_id The &#x60;userId&#x60; of the authenticated user. (required)
     * @param  \WebMI\RocketChatApiClient\RoomsApi\Model\PostApiV1RoomsCreateDiscussionRequest $post_api_v1_rooms_create_discussion_request post_api_v1_rooms_create_discussion_request (optional)
     ...
     * @param  string $x_auth_token The &#x60;authToken&#x60; of the authenticated user. (required)
     * @param  string $x_user_id The &#x60;userId&#x60; of the authenticated user. (required)
     * @param  \WebMI\RocketChatApiClient\RoomsApi\Model\PostApiV1RoomsCreateDiscussionRequest $post_api_v1_rooms_create_discussion_request (optional)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['postApiV1RoomsCreateDiscussion'] to see the possible values for this operation
     *
     * @throws \WebMI\RocketChatApiClient\RoomsApi\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     ...
     * @param  string $x_auth_token The &#x60;authToken&#x60; of the authenticated user. (required)
     * @param  string $x_user_id The &#x60;userId&#x60; of the authenticated user. (required)
     * @param  \WebMI\RocketChatApiClient\RoomsApi\Model\PostApiV1RoomsExportRequest $post_api_v1_rooms_export_request post_api_v1_rooms_export_request (optional)
     ...
     * @param  string $x_auth_token The &#x60;authToken&#x60; of the authenticated user. (required)
     * @param  string $x_user_id The &#x60;userId&#x60; of the authenticated user. (required)
     * @param  \WebMI\RocketChatApiClient\RoomsApi\Model\PostApiV1RoomsExportRequest $post_api_v1_rooms_export_request (optional)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['postApiV1RoomsExport'] to see the possible values for this operation
     *
     * @throws \WebMI\RocketChatApiClient\RoomsApi\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     ...
     * @param  string $x_auth_token The &#x60;authToken&#x60; of the authenticated user. (required)
     * @param  string $x_user_id The &#x60;userId&#x60; of the authenticated user. (required)
     * @param  \WebMI\RocketChatApiClient\RoomsApi\Model\PostApiV1RoomsFavoriteRequest $post_api_v1_rooms_favorite_request post_api_v1_rooms_favorite_request (optional)
     ...
     * @param  string $x_auth_token The &#x60;authToken&#x60; of the authenticated user. (required)
     * @param  string $x_user_id The &#x60;userId&#x60; of the authenticated user. (required)
     * @param  \WebMI\RocketChatApiClient\RoomsApi\Model\PostApiV1RoomsFavoriteRequest $post_api_v1_rooms_favorite_request (optional)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['postApiV1RoomsFavorite'] to see the possible values for this operation
     *
     * @throws \WebMI\RocketChatApiClient\RoomsApi\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     ...
     * @param  string $x_auth_token The &#x60;authToken&#x60; of the authenticated user. (required)
     * @param  string $x_user_id The &#x60;userId&#x60; of the authenticated user. (required)
     * @param  \WebMI\RocketChatApiClient\RoomsApi\Model\PostApiV1RoomsLeaveRequest $post_api_v1_rooms_leave_request post_api_v1_rooms_leave_request (optional)
     ...
     * @param  string $x_auth_token The &#x60;authToken&#x60; of the authenticated user. (required)
     * @param  string $x_user_id The &#x60;userId&#x60; of the authenticated user. (required)
     * @param  \WebMI\RocketChatApiClient\RoomsApi\Model\PostApiV1RoomsLeaveRequest $post_api_v1_rooms_leave_request (optional)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['postApiV1RoomsLeave'] to see the possible values for this operation
     *
     * @throws \WebMI\RocketChatApiClient\RoomsApi\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     ...
     * @param  string $x_auth_token The &#x60;authToken&#x60; of the authenticated user. (required)
     * @param  string $x_user_id The &#x60;userId&#x60; of the authenticated user. (required)
     * @param  \WebMI\RocketChatApiClient\RoomsApi\Model\PostApiV1RoomsMuteUserRequest $post_api_v1_rooms_mute_user_request post_api_v1_rooms_mute_user_request (optional)
     ...
     * @param  string $x_auth_token The &#x60;authToken&#x60; of the authenticated user. (required)
     * @param  string $x_user_id The &#x60;userId&#x60; of the authenticated user. (required)
     * @param  \WebMI\RocketChatApiClient\RoomsApi\Model\PostApiV1RoomsMuteUserRequest $post_api_v1_rooms_mute_user_request (optional)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['postApiV1RoomsMuteUser'] to see the possible values for this operation
     *
     * @throws \WebMI\RocketChatApiClient\RoomsApi\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     ...
     * @param  string $x_auth_token The &#x60;authToken&#x60; of the authenticated user. (required)
     * @param  string $x_user_id The &#x60;userId&#x60; of the authenticated user. (required)
     * @param  \WebMI\RocketChatApiClient\RoomsApi\Model\PostApiV1RoomsSaveNotificationRequest $post_api_v1_rooms_save_notification_request post_api_v1_rooms_save_notification_request (optional)
     ...
     * @param  string $x_auth_token The &#x60;authToken&#x60; of the authenticated user. (required)
     * @param  string $x_user_id The &#x60;userId&#x60; of the authenticated user. (required)
     * @param  \WebMI\RocketChatApiClient\RoomsApi\Model\PostApiV1RoomsSaveNotificationRequest $post_api_v1_rooms_save_notification_request (optional)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['postApiV1RoomsSaveNotification'] to see the possible values for this operation
     *
     * @throws \WebMI\RocketChatApiClient\RoomsApi\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     ...
     * @param  string $x_auth_token The &#x60;authToken&#x60; of the authenticated user. (required)
     * @param  string $x_user_id The &#x60;userId&#x60; of the authenticated user. (required)
     * @param  \WebMI\RocketChatApiClient\RoomsApi\Model\PostApiV1RoomsSaveRoomSettingsRequest $post_api_v1_rooms_save_room_settings_request post_api_v1_rooms_save_room_settings_request (optional)
     ...
     * @param  string $x_auth_token The &#x60;authToken&#x60; of the authenticated user. (required)
     * @param  string $x_user_id The &#x60;userId&#x60; of the authenticated user. (required)
     * @param  \WebMI\RocketChatApiClient\RoomsApi\Model\PostApiV1RoomsSaveRoomSettingsRequest $post_api_v1_rooms_save_room_settings_request (optional)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['postApiV1RoomsSaveRoomSettings'] to see the possible values for this operation
     *
     * @throws \WebMI\RocketChatApiClient\RoomsApi\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     ...
     * @param  string $x_auth_token The &#x60;authToken&#x60; of the authenticated user. (required)
     * @param  string $x_user_id The &#x60;userId&#x60; of the authenticated user. (required)
     * @param  \WebMI\RocketChatApiClient\RoomsApi\Model\PostApiV1RoomsUnmuteUserRequest $post_api_v1_rooms_unmute_user_request post_api_v1_rooms_unmute_user_request (optional)
     ...
     * @param  string $x_auth_token The &#x60;authToken&#x60; of the authenticated user. (required)
     * @param  string $x_user_id The &#x60;userId&#x60; of the authenticated user. (required)
     * @param  \WebMI\RocketChatApiClient\RoomsApi\Model\PostApiV1RoomsUnmuteUserRequest $post_api_v1_rooms_unmute_user_request (optional)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['postApiV1RoomsUnmuteUser'] to see the possible values for this operation
     *
     * @throws \WebMI\RocketChatApiClient\RoomsApi\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
