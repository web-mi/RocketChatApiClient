...
class RoomsApi
{
     ...
     * @param  string|null $filter Filter the results using the text that you want to view. (optional)
     ...
     * @return \WebMI\RocketChatApiClient\RoomsApi\Model\GetApiV1AuditRoomsMembers200Response|\WebMI\RocketChatApiClient\RoomsApi\Model\PostApiV1ChannelsAddLeader400Response|\WebMI\RocketChatApiClient\RoomsApi\Model\PostApiV1ChannelsCreate401Response|\WebMI\RocketChatApiClient\RoomsApi\Model\PostApiV1ChannelsClose400Response
     */
     ...
     * @throws \WebMI\RocketChatApiClient\RoomsApi\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array of \WebMI\RocketChatApiClient\RoomsApi\Model\GetApiV1AuditRoomsMembers200Response|\WebMI\RocketChatApiClient\RoomsApi\Model\PostApiV1ChannelsAddLeader400Response|\WebMI\RocketChatApiClient\RoomsApi\Model\PostApiV1ChannelsCreate401Response|\WebMI\RocketChatApiClient\RoomsApi\Model\PostApiV1ChannelsClose400Response, HTTP status code, HTTP response headers (array of strings)
     */
    public function getApiV1AuditRoomsMembersWithHttpInfo($x_auth_token, $x_user_id, $room_id, $filter = null, $count = null, $offset = null, $sort = null, string $contentType = self::contentTypes['getApiV1AuditRoomsMembers'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\WebMI\RocketChatApiClient\RoomsApi\Model\GetApiV1AuditRoomsMembers200Response' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\WebMI\RocketChatApiClient\RoomsApi\Model\GetApiV1AuditRoomsMembers200Response' !== 'string') {
                            try {
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\WebMI\RocketChatApiClient\RoomsApi\Model\GetApiV1AuditRoomsMembers200Response', []),
            ...
            $returnType = '\WebMI\RocketChatApiClient\RoomsApi\Model\GetApiV1AuditRoomsMembers200Response';
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\WebMI\RocketChatApiClient\RoomsApi\Model\GetApiV1AuditRoomsMembers200Response',
     ...
     * @param  string $x_auth_token The &#x60;authToken&#x60; of the authenticated user. (required)
     * @param  string $x_user_id The &#x60;userId&#x60; of the authenticated user. (required)
     * @param  string[]|null $types The room types. The possible room types are:  - &#x60;d&#x60;: Direct messages  - &#x60;c&#x60;: Public channel  - &#x60;p&#x60;: Private channel  - &#x60;discussions&#x60;: Team or channel discussions  - &#x60;teams&#x60;: Workspace teams  - &#x60;l&#x60;: Livechat  - &#x60;v&#x60;: Omnichannel VoIP rooms (optional)
     * @param  string|null $filter The rooms name (optional)
     * @param  int|null $count The number of items to return. (optional)
     * @param  mixed|null $sort List of fields to order by, and in which direction. This is a JSON object, with properties listed in desired order, with values of 1 for ascending, or -1 for descending. For example, {\&quot;value\&quot;: -1, \&quot;_id\&quot;: 1} (optional)
     * @param  int|null $offset Number of items to \&quot;skip\&quot; in the query, i.e. requests return count items, skipping the first offset items. (optional)
     ...
     * @throws \WebMI\RocketChatApiClient\RoomsApi\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return \WebMI\RocketChatApiClient\RoomsApi\Model\GetApiV1RoomsAdminRooms200Response|\WebMI\RocketChatApiClient\RoomsApi\Model\PostApiV1ChannelsCreate401Response
     */
     ...
     * @throws \WebMI\RocketChatApiClient\RoomsApi\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array of \WebMI\RocketChatApiClient\RoomsApi\Model\GetApiV1RoomsAdminRooms200Response|\WebMI\RocketChatApiClient\RoomsApi\Model\PostApiV1ChannelsCreate401Response, HTTP status code, HTTP response headers (array of strings)
     */
    public function getApiV1RoomsAdminRoomsWithHttpInfo($x_auth_token, $x_user_id, $types = null, $filter = null, $count = null, $sort = null, $offset = null, string $contentType = self::contentTypes['getApiV1RoomsAdminRooms'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\WebMI\RocketChatApiClient\RoomsApi\Model\GetApiV1RoomsAdminRooms200Response' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\WebMI\RocketChatApiClient\RoomsApi\Model\GetApiV1RoomsAdminRooms200Response' !== 'string') {
                            try {
                                $content = json_decode($content, false, 512, JSON_THROW_ON_ERROR);
                            } catch (\JsonException $exception) {
                                throw new ApiException(
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\WebMI\RocketChatApiClient\RoomsApi\Model\GetApiV1RoomsAdminRooms200Response', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                case 401:
            ...
            $returnType = '\WebMI\RocketChatApiClient\RoomsApi\Model\GetApiV1RoomsAdminRooms200Response';
            if ($returnType === '\SplFileObject') {
                $content = $response->getBody(); //stream goes to serializer
            } else {
                $content = (string) $response->getBody();
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\WebMI\RocketChatApiClient\RoomsApi\Model\GetApiV1RoomsAdminRooms200Response',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     * @throws \WebMI\RocketChatApiClient\RoomsApi\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return \WebMI\RocketChatApiClient\RoomsApi\Model\GetApiV1RoomsAdminRoomsGetRoom200Response|\WebMI\RocketChatApiClient\RoomsApi\Model\PostApiV1ChannelsCreate401Response|\WebMI\RocketChatApiClient\RoomsApi\Model\PostApiV1ChannelsClose400Response
     */
     ...
     * @throws \WebMI\RocketChatApiClient\RoomsApi\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array of \WebMI\RocketChatApiClient\RoomsApi\Model\GetApiV1RoomsAdminRoomsGetRoom200Response|\WebMI\RocketChatApiClient\RoomsApi\Model\PostApiV1ChannelsCreate401Response|\WebMI\RocketChatApiClient\RoomsApi\Model\PostApiV1ChannelsClose400Response, HTTP status code, HTTP response headers (array of strings)
     */
    public function getApiV1RoomsAdminRoomsGetRoomWithHttpInfo($x_auth_token, $x_user_id, $rid, string $contentType = self::contentTypes['getApiV1RoomsAdminRoomsGetRoom'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\WebMI\RocketChatApiClient\RoomsApi\Model\GetApiV1RoomsAdminRoomsGetRoom200Response' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\WebMI\RocketChatApiClient\RoomsApi\Model\GetApiV1RoomsAdminRoomsGetRoom200Response' !== 'string') {
                            try {
                                $content = json_decode($content, false, 512, JSON_THROW_ON_ERROR);
                            } catch (\JsonException $exception) {
                                throw new ApiException(
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\WebMI\RocketChatApiClient\RoomsApi\Model\GetApiV1RoomsAdminRoomsGetRoom200Response', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                case 401:
            ...
            $returnType = '\WebMI\RocketChatApiClient\RoomsApi\Model\GetApiV1RoomsAdminRoomsGetRoom200Response';
            if ($returnType === '\SplFileObject') {
                $content = $response->getBody(); //stream goes to serializer
            } else {
                $content = (string) $response->getBody();
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\WebMI\RocketChatApiClient\RoomsApi\Model\GetApiV1RoomsAdminRoomsGetRoom200Response',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     * @throws \WebMI\RocketChatApiClient\RoomsApi\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return \WebMI\RocketChatApiClient\RoomsApi\Model\GetApiV1RoomsAutocompleteAvailableForTeams200Response|\WebMI\RocketChatApiClient\RoomsApi\Model\PostApiV1ChannelsClose400Response|\WebMI\RocketChatApiClient\RoomsApi\Model\PostApiV1ChannelsCreate401Response
     */
     ...
     * @throws \WebMI\RocketChatApiClient\RoomsApi\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array of \WebMI\RocketChatApiClient\RoomsApi\Model\GetApiV1RoomsAutocompleteAvailableForTeams200Response|\WebMI\RocketChatApiClient\RoomsApi\Model\PostApiV1ChannelsClose400Response|\WebMI\RocketChatApiClient\RoomsApi\Model\PostApiV1ChannelsCreate401Response, HTTP status code, HTTP response headers (array of strings)
     */
    public function getApiV1RoomsAutocompleteAdminRoomsWithHttpInfo($x_auth_token, $x_user_id, $selector, string $contentType = self::contentTypes['getApiV1RoomsAutocompleteAdminRooms'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\WebMI\RocketChatApiClient\RoomsApi\Model\GetApiV1RoomsAutocompleteAvailableForTeams200Response' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\WebMI\RocketChatApiClient\RoomsApi\Model\GetApiV1RoomsAutocompleteAvailableForTeams200Response' !== 'string') {
                            try {
                                $content = json_decode($content, false, 512, JSON_THROW_ON_ERROR);
                            } catch (\JsonException $exception) {
                                throw new ApiException(
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\WebMI\RocketChatApiClient\RoomsApi\Model\GetApiV1RoomsAutocompleteAvailableForTeams200Response', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                case 400:
            ...
            $returnType = '\WebMI\RocketChatApiClient\RoomsApi\Model\GetApiV1RoomsAutocompleteAvailableForTeams200Response';
            if ($returnType === '\SplFileObject') {
                $content = $response->getBody(); //stream goes to serializer
            } else {
                $content = (string) $response->getBody();
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\WebMI\RocketChatApiClient\RoomsApi\Model\GetApiV1RoomsAutocompleteAvailableForTeams200Response',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     * @throws \WebMI\RocketChatApiClient\RoomsApi\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return \WebMI\RocketChatApiClient\RoomsApi\Model\GetApiV1RoomsAutocompleteAvailableForTeams200Response|\WebMI\RocketChatApiClient\RoomsApi\Model\PostApiV1ChannelsCreate401Response
     */
     ...
     * @throws \WebMI\RocketChatApiClient\RoomsApi\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array of \WebMI\RocketChatApiClient\RoomsApi\Model\GetApiV1RoomsAutocompleteAvailableForTeams200Response|\WebMI\RocketChatApiClient\RoomsApi\Model\PostApiV1ChannelsCreate401Response, HTTP status code, HTTP response headers (array of strings)
     */
     ...
     * @param  string $x_auth_token The &#x60;authToken&#x60; of the authenticated user. (required)
     * @param  string $x_user_id The &#x60;userId&#x60; of the authenticated user. (required)
     * @param  \WebMI\RocketChatApiClient\RoomsApi\Model\GetApiV1RoomsCleanHistoryRequest|null $get_api_v1_rooms_clean_history_request get_api_v1_rooms_clean_history_request (optional)
     ...
     * @param  string $x_auth_token The &#x60;authToken&#x60; of the authenticated user. (required)
     * @param  string $x_user_id The &#x60;userId&#x60; of the authenticated user. (required)
     * @param  \WebMI\RocketChatApiClient\RoomsApi\Model\GetApiV1RoomsCleanHistoryRequest|null $get_api_v1_rooms_clean_history_request (optional)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['getApiV1RoomsCleanHistory'] to see the possible values for this operation
     *
     * @throws \WebMI\RocketChatApiClient\RoomsApi\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     ...
     * @param  string $x_auth_token The &#x60;authToken&#x60; of the authenticated user. (required)
     * @param  string $x_user_id The &#x60;userId&#x60; of the authenticated user. (required)
     * @param  \WebMI\RocketChatApiClient\RoomsApi\Model\GetApiV1RoomsDeleteRequest|null $get_api_v1_rooms_delete_request get_api_v1_rooms_delete_request (optional)
     ...
     * @param  string $x_auth_token The &#x60;authToken&#x60; of the authenticated user. (required)
     * @param  string $x_user_id The &#x60;userId&#x60; of the authenticated user. (required)
     * @param  \WebMI\RocketChatApiClient\RoomsApi\Model\GetApiV1RoomsDeleteRequest|null $get_api_v1_rooms_delete_request (optional)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['getApiV1RoomsDelete'] to see the possible values for this operation
     *
     * @throws \WebMI\RocketChatApiClient\RoomsApi\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     ...
     * @param  string $x_auth_token The &#x60;authToken&#x60; of the authenticated user. (required)
     * @param  string $x_user_id The &#x60;userId&#x60; of the authenticated user. (required)
     * @param  string|null $updated_since A date as an ISO string. When you provide the &#x60;updatedSince&#x60; query parameter, then the update and remove in the response will contain only those updated and removed since the specified date and time. (optional)
     ...
     * @throws \WebMI\RocketChatApiClient\RoomsApi\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return \WebMI\RocketChatApiClient\RoomsApi\Model\GetApiV1RoomsGet200Response|\WebMI\RocketChatApiClient\RoomsApi\Model\PostApiV1ChannelsCreate401Response
     */
     ...
     * @throws \WebMI\RocketChatApiClient\RoomsApi\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array of \WebMI\RocketChatApiClient\RoomsApi\Model\GetApiV1RoomsGet200Response|\WebMI\RocketChatApiClient\RoomsApi\Model\PostApiV1ChannelsCreate401Response, HTTP status code, HTTP response headers (array of strings)
     */
    public function getApiV1RoomsGetWithHttpInfo($x_auth_token, $x_user_id, $updated_since = null, string $contentType = self::contentTypes['getApiV1RoomsGet'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\WebMI\RocketChatApiClient\RoomsApi\Model\GetApiV1RoomsGet200Response' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\WebMI\RocketChatApiClient\RoomsApi\Model\GetApiV1RoomsGet200Response' !== 'string') {
                            try {
                                $content = json_decode($content, false, 512, JSON_THROW_ON_ERROR);
                            } catch (\JsonException $exception) {
                                throw new ApiException(
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\WebMI\RocketChatApiClient\RoomsApi\Model\GetApiV1RoomsGet200Response', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                case 401:
            ...
            $returnType = '\WebMI\RocketChatApiClient\RoomsApi\Model\GetApiV1RoomsGet200Response';
            if ($returnType === '\SplFileObject') {
                $content = $response->getBody(); //stream goes to serializer
            } else {
                $content = (string) $response->getBody();
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\WebMI\RocketChatApiClient\RoomsApi\Model\GetApiV1RoomsGet200Response',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     * @throws \WebMI\RocketChatApiClient\RoomsApi\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return \WebMI\RocketChatApiClient\RoomsApi\Model\GetApiV1RoomsGetDiscussions200Response|\WebMI\RocketChatApiClient\RoomsApi\Model\PostApiV1ChannelsCreate401Response
     */
     ...
     * @throws \WebMI\RocketChatApiClient\RoomsApi\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array of \WebMI\RocketChatApiClient\RoomsApi\Model\GetApiV1RoomsGetDiscussions200Response|\WebMI\RocketChatApiClient\RoomsApi\Model\PostApiV1ChannelsCreate401Response, HTTP status code, HTTP response headers (array of strings)
     */
    public function getApiV1RoomsGetDiscussionsWithHttpInfo($x_auth_token, $x_user_id, $room_name = null, $room_id = null, $query = null, $count = null, $fields = null, $offset = null, $sort = null, string $contentType = self::contentTypes['getApiV1RoomsGetDiscussions'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\WebMI\RocketChatApiClient\RoomsApi\Model\GetApiV1RoomsGetDiscussions200Response' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\WebMI\RocketChatApiClient\RoomsApi\Model\GetApiV1RoomsGetDiscussions200Response' !== 'string') {
                            try {
                                $content = json_decode($content, false, 512, JSON_THROW_ON_ERROR);
                            } catch (\JsonException $exception) {
                                throw new ApiException(
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\WebMI\RocketChatApiClient\RoomsApi\Model\GetApiV1RoomsGetDiscussions200Response', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                case 401:
            ...
            $returnType = '\WebMI\RocketChatApiClient\RoomsApi\Model\GetApiV1RoomsGetDiscussions200Response';
            if ($returnType === '\SplFileObject') {
                $content = $response->getBody(); //stream goes to serializer
            } else {
                $content = (string) $response->getBody();
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\WebMI\RocketChatApiClient\RoomsApi\Model\GetApiV1RoomsGetDiscussions200Response',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     * @param  string|null $starting_from_id Filter images using the file ID. (optional)
     * @param  int|null $offset Number of items to \&quot;skip\&quot; in the query, i.e. requests return count items, skipping the first offset items. (optional)
     * @param  int|null $count The number of items to return. (optional)
     ...
     * @throws \WebMI\RocketChatApiClient\RoomsApi\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return \WebMI\RocketChatApiClient\RoomsApi\Model\GetApiV1RoomsImages200Response|\WebMI\RocketChatApiClient\RoomsApi\Model\PostApiV1ChannelsAddLeader400Response|\WebMI\RocketChatApiClient\RoomsApi\Model\PostApiV1ChannelsCreate401Response
     */
     ...
     * @throws \WebMI\RocketChatApiClient\RoomsApi\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array of \WebMI\RocketChatApiClient\RoomsApi\Model\GetApiV1RoomsImages200Response|\WebMI\RocketChatApiClient\RoomsApi\Model\PostApiV1ChannelsAddLeader400Response|\WebMI\RocketChatApiClient\RoomsApi\Model\PostApiV1ChannelsCreate401Response, HTTP status code, HTTP response headers (array of strings)
     */
    public function getApiV1RoomsImagesWithHttpInfo($x_auth_token, $x_user_id, $room_id, $starting_from_id = null, $offset = null, $count = null, string $contentType = self::contentTypes['getApiV1RoomsImages'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\WebMI\RocketChatApiClient\RoomsApi\Model\GetApiV1RoomsImages200Response' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\WebMI\RocketChatApiClient\RoomsApi\Model\GetApiV1RoomsImages200Response' !== 'string') {
                            try {
                                $content = json_decode($content, false, 512, JSON_THROW_ON_ERROR);
                            } catch (\JsonException $exception) {
                                throw new ApiException(
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\WebMI\RocketChatApiClient\RoomsApi\Model\GetApiV1RoomsImages200Response', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                case 400:
            ...
            $returnType = '\WebMI\RocketChatApiClient\RoomsApi\Model\GetApiV1RoomsImages200Response';
            if ($returnType === '\SplFileObject') {
                $content = $response->getBody(); //stream goes to serializer
            } else {
                $content = (string) $response->getBody();
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\WebMI\RocketChatApiClient\RoomsApi\Model\GetApiV1RoomsImages200Response',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     * @throws \WebMI\RocketChatApiClient\RoomsApi\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return \WebMI\RocketChatApiClient\RoomsApi\Model\GetApiV1RoomsInfo200Response|\WebMI\RocketChatApiClient\RoomsApi\Model\PostApiV1ChannelsAddLeader400Response|\WebMI\RocketChatApiClient\RoomsApi\Model\PostApiV1ChannelsCreate401Response
     */
     ...
     * @throws \WebMI\RocketChatApiClient\RoomsApi\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array of \WebMI\RocketChatApiClient\RoomsApi\Model\GetApiV1RoomsInfo200Response|\WebMI\RocketChatApiClient\RoomsApi\Model\PostApiV1ChannelsAddLeader400Response|\WebMI\RocketChatApiClient\RoomsApi\Model\PostApiV1ChannelsCreate401Response, HTTP status code, HTTP response headers (array of strings)
     */
    public function getApiV1RoomsInfoWithHttpInfo($x_user_id, $x_auth_token, $room_id = null, $room_name = null, $fields = null, string $contentType = self::contentTypes['getApiV1RoomsInfo'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\WebMI\RocketChatApiClient\RoomsApi\Model\GetApiV1RoomsInfo200Response' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\WebMI\RocketChatApiClient\RoomsApi\Model\GetApiV1RoomsInfo200Response' !== 'string') {
                            try {
                                $content = json_decode($content, false, 512, JSON_THROW_ON_ERROR);
                            } catch (\JsonException $exception) {
                                throw new ApiException(
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\WebMI\RocketChatApiClient\RoomsApi\Model\GetApiV1RoomsInfo200Response', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                case 400:
            ...
            $returnType = '\WebMI\RocketChatApiClient\RoomsApi\Model\GetApiV1RoomsInfo200Response';
            if ($returnType === '\SplFileObject') {
                $content = $response->getBody(); //stream goes to serializer
            } else {
                $content = (string) $response->getBody();
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\WebMI\RocketChatApiClient\RoomsApi\Model\GetApiV1RoomsInfo200Response',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     * @throws \WebMI\RocketChatApiClient\RoomsApi\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return \WebMI\RocketChatApiClient\RoomsApi\Model\GetApiV1RoomsNameExists200Response|\WebMI\RocketChatApiClient\RoomsApi\Model\PostApiV1ChannelsAddLeader400Response|\WebMI\RocketChatApiClient\RoomsApi\Model\PostApiV1ChannelsCreate401Response
     */
     ...
     * @throws \WebMI\RocketChatApiClient\RoomsApi\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array of \WebMI\RocketChatApiClient\RoomsApi\Model\GetApiV1RoomsNameExists200Response|\WebMI\RocketChatApiClient\RoomsApi\Model\PostApiV1ChannelsAddLeader400Response|\WebMI\RocketChatApiClient\RoomsApi\Model\PostApiV1ChannelsCreate401Response, HTTP status code, HTTP response headers (array of strings)
     */
    public function getApiV1RoomsNameExistsWithHttpInfo($x_auth_token, $x_user_id, $room_name, string $contentType = self::contentTypes['getApiV1RoomsNameExists'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\WebMI\RocketChatApiClient\RoomsApi\Model\GetApiV1RoomsNameExists200Response' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\WebMI\RocketChatApiClient\RoomsApi\Model\GetApiV1RoomsNameExists200Response' !== 'string') {
                            try {
                                $content = json_decode($content, false, 512, JSON_THROW_ON_ERROR);
                            } catch (\JsonException $exception) {
                                throw new ApiException(
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\WebMI\RocketChatApiClient\RoomsApi\Model\GetApiV1RoomsNameExists200Response', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                case 400:
            ...
            $returnType = '\WebMI\RocketChatApiClient\RoomsApi\Model\GetApiV1RoomsNameExists200Response';
            if ($returnType === '\SplFileObject') {
                $content = $response->getBody(); //stream goes to serializer
            } else {
                $content = (string) $response->getBody();
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\WebMI\RocketChatApiClient\RoomsApi\Model\GetApiV1RoomsNameExists200Response',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     * @param  string|null $msg A message text to be sent with the file. (optional)
     * @param  string|null $description A description of the file. (optional)
     * @param  string|null $tmid The thread message ID (if you want to upload a file to a thread). (optional)
     ...
     * @throws \WebMI\RocketChatApiClient\RoomsApi\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return \WebMI\RocketChatApiClient\RoomsApi\Model\GetApiV1RoomsUploadRid200Response|\WebMI\RocketChatApiClient\RoomsApi\Model\PostApiV1ChannelsClose400Response|\WebMI\RocketChatApiClient\RoomsApi\Model\PostApiV1ChannelsCreate401Response
     * @deprecated
     */
     ...
     * @throws \WebMI\RocketChatApiClient\RoomsApi\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array of \WebMI\RocketChatApiClient\RoomsApi\Model\GetApiV1RoomsUploadRid200Response|\WebMI\RocketChatApiClient\RoomsApi\Model\PostApiV1ChannelsClose400Response|\WebMI\RocketChatApiClient\RoomsApi\Model\PostApiV1ChannelsCreate401Response, HTTP status code, HTTP response headers (array of strings)
     * @deprecated
     */
    public function getApiV1RoomsUploadRidWithHttpInfo($x_auth_token, $x_user_id, $rid, $file, $msg = null, $description = null, $tmid = null, $custom_fields = null, string $contentType = self::contentTypes['getApiV1RoomsUploadRid'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\WebMI\RocketChatApiClient\RoomsApi\Model\GetApiV1RoomsUploadRid200Response' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\WebMI\RocketChatApiClient\RoomsApi\Model\GetApiV1RoomsUploadRid200Response' !== 'string') {
                            try {
                                $content = json_decode($content, false, 512, JSON_THROW_ON_ERROR);
                            } catch (\JsonException $exception) {
                                throw new ApiException(
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\WebMI\RocketChatApiClient\RoomsApi\Model\GetApiV1RoomsUploadRid200Response', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                case 400:
            ...
            $returnType = '\WebMI\RocketChatApiClient\RoomsApi\Model\GetApiV1RoomsUploadRid200Response';
            if ($returnType === '\SplFileObject') {
                $content = $response->getBody(); //stream goes to serializer
            } else {
                $content = (string) $response->getBody();
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\WebMI\RocketChatApiClient\RoomsApi\Model\GetApiV1RoomsUploadRid200Response',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
    ...
    public function getApiV1RoomsUploadRidRequest($x_auth_token, $x_user_id, $rid, $file, $msg = null, $description = null, $tmid = null, $custom_fields = null, string $contentType = self::contentTypes['getApiV1RoomsUploadRid'][0])
    {
        ...
        // form params
        if ($msg !== null) {
            $formParams = array_merge($formParams, ObjectSerializer::toFormValue('msg', $msg));
        }
        // form params
        if ($description !== null) {
        ...
        // form params
        if ($tmid !== null) {
            $formParams = array_merge($formParams, ObjectSerializer::toFormValue('tmid', $tmid));
        }
        // form params
        if ($custom_fields !== null) {
            $formParams = array_merge($formParams, ObjectSerializer::toFormValue('customFields', $custom_fields));
        }
     ...
     * @param  string $x_auth_token The &#x60;authToken&#x60; of the authenticated user. (required)
     * @param  string $x_user_id The &#x60;userId&#x60; of the authenticated user. (required)
     * @param  \WebMI\RocketChatApiClient\RoomsApi\Model\PostApiV1RoomsAutocompleteChannelAndPrivateRequest|null $post_api_v1_rooms_autocomplete_channel_and_private_request post_api_v1_rooms_autocomplete_channel_and_private_request (optional)
     ...
     * @param  string $x_auth_token The &#x60;authToken&#x60; of the authenticated user. (required)
     * @param  string $x_user_id The &#x60;userId&#x60; of the authenticated user. (required)
     * @param  \WebMI\RocketChatApiClient\RoomsApi\Model\PostApiV1RoomsAutocompleteChannelAndPrivateRequest|null $post_api_v1_rooms_autocomplete_channel_and_private_request (optional)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['postApiV1RoomsAutocompleteChannelAndPrivate'] to see the possible values for this operation
     *
     * @throws \WebMI\RocketChatApiClient\RoomsApi\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     ...
     * @param  string $x_auth_token The &#x60;authToken&#x60; of the authenticated user. (required)
     * @param  string $x_user_id The &#x60;userId&#x60; of the authenticated user. (required)
     * @param  \WebMI\RocketChatApiClient\RoomsApi\Model\PostApiV1RoomsCreateDiscussionRequest|null $post_api_v1_rooms_create_discussion_request post_api_v1_rooms_create_discussion_request (optional)
     ...
     * @throws \WebMI\RocketChatApiClient\RoomsApi\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return \WebMI\RocketChatApiClient\RoomsApi\Model\PostApiV1RoomsCreateDiscussion200Response|\WebMI\RocketChatApiClient\RoomsApi\Model\PostApiV1ChannelsCreate401Response
     */
     ...
     * @param  string $x_auth_token The &#x60;authToken&#x60; of the authenticated user. (required)
     * @param  string $x_user_id The &#x60;userId&#x60; of the authenticated user. (required)
     * @param  \WebMI\RocketChatApiClient\RoomsApi\Model\PostApiV1RoomsCreateDiscussionRequest|null $post_api_v1_rooms_create_discussion_request (optional)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['postApiV1RoomsCreateDiscussion'] to see the possible values for this operation
     *
     * @throws \WebMI\RocketChatApiClient\RoomsApi\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array of \WebMI\RocketChatApiClient\RoomsApi\Model\PostApiV1RoomsCreateDiscussion200Response|\WebMI\RocketChatApiClient\RoomsApi\Model\PostApiV1ChannelsCreate401Response, HTTP status code, HTTP response headers (array of strings)
     */
    public function postApiV1RoomsCreateDiscussionWithHttpInfo($x_auth_token, $x_user_id, $post_api_v1_rooms_create_discussion_request = null, string $contentType = self::contentTypes['postApiV1RoomsCreateDiscussion'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\WebMI\RocketChatApiClient\RoomsApi\Model\PostApiV1RoomsCreateDiscussion200Response' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\WebMI\RocketChatApiClient\RoomsApi\Model\PostApiV1RoomsCreateDiscussion200Response' !== 'string') {
                            try {
                                $content = json_decode($content, false, 512, JSON_THROW_ON_ERROR);
                            } catch (\JsonException $exception) {
                                throw new ApiException(
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\WebMI\RocketChatApiClient\RoomsApi\Model\PostApiV1RoomsCreateDiscussion200Response', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                case 401:
            ...
            $returnType = '\WebMI\RocketChatApiClient\RoomsApi\Model\PostApiV1RoomsCreateDiscussion200Response';
            if ($returnType === '\SplFileObject') {
                $content = $response->getBody(); //stream goes to serializer
            } else {
                $content = (string) $response->getBody();
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\WebMI\RocketChatApiClient\RoomsApi\Model\PostApiV1RoomsCreateDiscussion200Response',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     * @param  string $x_auth_token The &#x60;authToken&#x60; of the authenticated user. (required)
     * @param  string $x_user_id The &#x60;userId&#x60; of the authenticated user. (required)
     * @param  \WebMI\RocketChatApiClient\RoomsApi\Model\PostApiV1RoomsExportRequest|null $post_api_v1_rooms_export_request post_api_v1_rooms_export_request (optional)
     ...
     * @throws \WebMI\RocketChatApiClient\RoomsApi\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return \WebMI\RocketChatApiClient\RoomsApi\Model\PostApiV1ChannelsAddLeader200Response|\WebMI\RocketChatApiClient\RoomsApi\Model\PostApiV1ChannelsAddLeader400Response|\WebMI\RocketChatApiClient\RoomsApi\Model\PostApiV1ChannelsCreate401Response|\WebMI\RocketChatApiClient\RoomsApi\Model\PostApiV1ChannelsClose400Response
     */
     ...
     * @param  string $x_auth_token The &#x60;authToken&#x60; of the authenticated user. (required)
     * @param  string $x_user_id The &#x60;userId&#x60; of the authenticated user. (required)
     * @param  \WebMI\RocketChatApiClient\RoomsApi\Model\PostApiV1RoomsExportRequest|null $post_api_v1_rooms_export_request (optional)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['postApiV1RoomsExport'] to see the possible values for this operation
     *
     * @throws \WebMI\RocketChatApiClient\RoomsApi\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     ...
     * @param  string $x_auth_token The &#x60;authToken&#x60; of the authenticated user. (required)
     * @param  string $x_user_id The &#x60;userId&#x60; of the authenticated user. (required)
     * @param  \WebMI\RocketChatApiClient\RoomsApi\Model\PostApiV1RoomsFavoriteRequest|null $post_api_v1_rooms_favorite_request post_api_v1_rooms_favorite_request (optional)
     ...
     * @param  string $x_auth_token The &#x60;authToken&#x60; of the authenticated user. (required)
     * @param  string $x_user_id The &#x60;userId&#x60; of the authenticated user. (required)
     * @param  \WebMI\RocketChatApiClient\RoomsApi\Model\PostApiV1RoomsFavoriteRequest|null $post_api_v1_rooms_favorite_request (optional)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['postApiV1RoomsFavorite'] to see the possible values for this operation
     *
     * @throws \WebMI\RocketChatApiClient\RoomsApi\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     ...
     * @param  string $x_auth_token The &#x60;authToken&#x60; of the authenticated user. (required)
     * @param  string $x_user_id The &#x60;userId&#x60; of the authenticated user. (required)
     * @param  \WebMI\RocketChatApiClient\RoomsApi\Model\PostApiV1RoomsHideRequest|null $post_api_v1_rooms_hide_request post_api_v1_rooms_hide_request (optional)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['postApiV1RoomsHide'] to see the possible values for this operation
     *
     * @throws \WebMI\RocketChatApiClient\RoomsApi\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return \WebMI\RocketChatApiClient\RoomsApi\Model\PostApiV1RoomsHide200Response|\WebMI\RocketChatApiClient\RoomsApi\Model\PostApiV1RoomsHide400Response|\WebMI\RocketChatApiClient\RoomsApi\Model\PostApiV1RoomsHide401Response
     */
    public function postApiV1RoomsHide($x_auth_token, $x_user_id, $post_api_v1_rooms_hide_request = null, string $contentType = self::contentTypes['postApiV1RoomsHide'][0])
    {
        list($response) = $this->postApiV1RoomsHideWithHttpInfo($x_auth_token, $x_user_id, $post_api_v1_rooms_hide_request, $contentType);
        return $response;
    }
     ...
     * @param  string $x_auth_token The &#x60;authToken&#x60; of the authenticated user. (required)
     * @param  string $x_user_id The &#x60;userId&#x60; of the authenticated user. (required)
     * @param  \WebMI\RocketChatApiClient\RoomsApi\Model\PostApiV1RoomsHideRequest|null $post_api_v1_rooms_hide_request (optional)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['postApiV1RoomsHide'] to see the possible values for this operation
     *
     * @throws \WebMI\RocketChatApiClient\RoomsApi\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array of \WebMI\RocketChatApiClient\RoomsApi\Model\PostApiV1RoomsHide200Response|\WebMI\RocketChatApiClient\RoomsApi\Model\PostApiV1RoomsHide400Response|\WebMI\RocketChatApiClient\RoomsApi\Model\PostApiV1RoomsHide401Response, HTTP status code, HTTP response headers (array of strings)
     */
    public function postApiV1RoomsHideWithHttpInfo($x_auth_token, $x_user_id, $post_api_v1_rooms_hide_request = null, string $contentType = self::contentTypes['postApiV1RoomsHide'][0])
    {
        $request = $this->postApiV1RoomsHideRequest($x_auth_token, $x_user_id, $post_api_v1_rooms_hide_request, $contentType);
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\WebMI\RocketChatApiClient\RoomsApi\Model\PostApiV1RoomsHide200Response' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\WebMI\RocketChatApiClient\RoomsApi\Model\PostApiV1RoomsHide200Response' !== 'string') {
                            try {
                                $content = json_decode($content, false, 512, JSON_THROW_ON_ERROR);
                            } catch (\JsonException $exception) {
                                throw new ApiException(
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\WebMI\RocketChatApiClient\RoomsApi\Model\PostApiV1RoomsHide200Response', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                case 400:
                    if ('\WebMI\RocketChatApiClient\RoomsApi\Model\PostApiV1RoomsHide400Response' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\WebMI\RocketChatApiClient\RoomsApi\Model\PostApiV1RoomsHide400Response' !== 'string') {
                            try {
                                $content = json_decode($content, false, 512, JSON_THROW_ON_ERROR);
                            } catch (\JsonException $exception) {
                                throw new ApiException(
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\WebMI\RocketChatApiClient\RoomsApi\Model\PostApiV1RoomsHide400Response', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                case 401:
                    if ('\WebMI\RocketChatApiClient\RoomsApi\Model\PostApiV1RoomsHide401Response' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\WebMI\RocketChatApiClient\RoomsApi\Model\PostApiV1RoomsHide401Response' !== 'string') {
                            try {
                                $content = json_decode($content, false, 512, JSON_THROW_ON_ERROR);
                            } catch (\JsonException $exception) {
                                throw new ApiException(
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\WebMI\RocketChatApiClient\RoomsApi\Model\PostApiV1RoomsHide401Response', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
            }
            ...
            $returnType = '\WebMI\RocketChatApiClient\RoomsApi\Model\PostApiV1RoomsHide200Response';
            if ($returnType === '\SplFileObject') {
                $content = $response->getBody(); //stream goes to serializer
            } else {
                $content = (string) $response->getBody();
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\WebMI\RocketChatApiClient\RoomsApi\Model\PostApiV1RoomsHide200Response',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
                case 400:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\WebMI\RocketChatApiClient\RoomsApi\Model\PostApiV1RoomsHide400Response',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
                case 401:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\WebMI\RocketChatApiClient\RoomsApi\Model\PostApiV1RoomsHide401Response',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function postApiV1RoomsHideAsync($x_auth_token, $x_user_id, $post_api_v1_rooms_hide_request = null, string $contentType = self::contentTypes['postApiV1RoomsHide'][0])
    {
        return $this->postApiV1RoomsHideAsyncWithHttpInfo($x_auth_token, $x_user_id, $post_api_v1_rooms_hide_request, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function postApiV1RoomsHideAsyncWithHttpInfo($x_auth_token, $x_user_id, $post_api_v1_rooms_hide_request = null, string $contentType = self::contentTypes['postApiV1RoomsHide'][0])
    {
        $returnType = '\WebMI\RocketChatApiClient\RoomsApi\Model\PostApiV1RoomsHide200Response';
        $request = $this->postApiV1RoomsHideRequest($x_auth_token, $x_user_id, $post_api_v1_rooms_hide_request, $contentType);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function postApiV1RoomsHideRequest($x_auth_token, $x_user_id, $post_api_v1_rooms_hide_request = null, string $contentType = self::contentTypes['postApiV1RoomsHide'][0])
    {
        ...
        // for model (json/xml)
        if (isset($post_api_v1_rooms_hide_request)) {
            if (stripos($headers['Content-Type'], 'application/json') !== false) {
                # if Content-Type contains "application/json", json_encode the body
                $httpBody = \GuzzleHttp\Utils::jsonEncode(ObjectSerializer::sanitizeForSerialization($post_api_v1_rooms_hide_request));
            } else {
                $httpBody = $post_api_v1_rooms_hide_request;
            }
        } elseif (count($formParams) > 0) {
            if ($multipart) {
                $multipartContents = [];
     ...
     * @param  string $x_auth_token The &#x60;authToken&#x60; of the authenticated user. (required)
     * @param  string $x_user_id The &#x60;userId&#x60; of the authenticated user. (required)
     * @param  \WebMI\RocketChatApiClient\RoomsApi\Model\PostApiV1RoomsLeaveRequest|null $post_api_v1_rooms_leave_request post_api_v1_rooms_leave_request (optional)
     ...
     * @param  string $x_auth_token The &#x60;authToken&#x60; of the authenticated user. (required)
     * @param  string $x_user_id The &#x60;userId&#x60; of the authenticated user. (required)
     * @param  \WebMI\RocketChatApiClient\RoomsApi\Model\PostApiV1RoomsLeaveRequest|null $post_api_v1_rooms_leave_request (optional)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['postApiV1RoomsLeave'] to see the possible values for this operation
     *
     * @throws \WebMI\RocketChatApiClient\RoomsApi\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     ...
     * @param  string $x_user_id The &#x60;userId&#x60; of the authenticated user. (required)
     * @param  \SplFileObject $file The file to upload (required)
     * @param  string $msg The text to be added to the file message. (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['postApiV1RoomsMedia'] to see the possible values for this operation
     *
     * @throws \WebMI\RocketChatApiClient\RoomsApi\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return \WebMI\RocketChatApiClient\RoomsApi\Model\PostApiV1RoomsMedia200Response
     */
    public function postApiV1RoomsMedia($rid, $x_auth_token, $x_user_id, $file, $msg, string $contentType = self::contentTypes['postApiV1RoomsMedia'][0])
    {
        list($response) = $this->postApiV1RoomsMediaWithHttpInfo($rid, $x_auth_token, $x_user_id, $file, $msg, $contentType);
        return $response;
    }
     ...
     * @throws \WebMI\RocketChatApiClient\RoomsApi\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array of \WebMI\RocketChatApiClient\RoomsApi\Model\PostApiV1RoomsMedia200Response, HTTP status code, HTTP response headers (array of strings)
     */
    public function postApiV1RoomsMediaWithHttpInfo($rid, $x_auth_token, $x_user_id, $file, $msg, string $contentType = self::contentTypes['postApiV1RoomsMedia'][0])
    {
        $request = $this->postApiV1RoomsMediaRequest($rid, $x_auth_token, $x_user_id, $file, $msg, $contentType);
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\WebMI\RocketChatApiClient\RoomsApi\Model\PostApiV1RoomsMedia200Response' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\WebMI\RocketChatApiClient\RoomsApi\Model\PostApiV1RoomsMedia200Response' !== 'string') {
                            try {
                                $content = json_decode($content, false, 512, JSON_THROW_ON_ERROR);
                            } catch (\JsonException $exception) {
                                throw new ApiException(
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\WebMI\RocketChatApiClient\RoomsApi\Model\PostApiV1RoomsMedia200Response', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
            }
            ...
            $returnType = '\WebMI\RocketChatApiClient\RoomsApi\Model\PostApiV1RoomsMedia200Response';
            if ($returnType === '\SplFileObject') {
                $content = $response->getBody(); //stream goes to serializer
            } else {
                $content = (string) $response->getBody();
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\WebMI\RocketChatApiClient\RoomsApi\Model\PostApiV1RoomsMedia200Response',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function postApiV1RoomsMediaAsync($rid, $x_auth_token, $x_user_id, $file, $msg, string $contentType = self::contentTypes['postApiV1RoomsMedia'][0])
    {
        return $this->postApiV1RoomsMediaAsyncWithHttpInfo($rid, $x_auth_token, $x_user_id, $file, $msg, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function postApiV1RoomsMediaAsyncWithHttpInfo($rid, $x_auth_token, $x_user_id, $file, $msg, string $contentType = self::contentTypes['postApiV1RoomsMedia'][0])
    {
        $returnType = '\WebMI\RocketChatApiClient\RoomsApi\Model\PostApiV1RoomsMedia200Response';
        $request = $this->postApiV1RoomsMediaRequest($rid, $x_auth_token, $x_user_id, $file, $msg, $contentType);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function postApiV1RoomsMediaRequest($rid, $x_auth_token, $x_user_id, $file, $msg, string $contentType = self::contentTypes['postApiV1RoomsMedia'][0])
    {
        ...
        if ($file === null || (is_array($file) && count($file) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $file when calling postApiV1RoomsMedia'
            );
        }
        ...
        if ($msg === null || (is_array($msg) && count($msg) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $msg when calling postApiV1RoomsMedia'
            );
        }
     ...
     * @param  string $x_auth_token The &#x60;authToken&#x60; of the authenticated user. (required)
     * @param  string $x_user_id The &#x60;userId&#x60; of the authenticated user. (required)
     * @param  \WebMI\RocketChatApiClient\RoomsApi\Model\PostApiV1RoomsMuteUserRequest|null $post_api_v1_rooms_mute_user_request post_api_v1_rooms_mute_user_request (optional)
     ...
     * @param  string $x_auth_token The &#x60;authToken&#x60; of the authenticated user. (required)
     * @param  string $x_user_id The &#x60;userId&#x60; of the authenticated user. (required)
     * @param  \WebMI\RocketChatApiClient\RoomsApi\Model\PostApiV1RoomsMuteUserRequest|null $post_api_v1_rooms_mute_user_request (optional)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['postApiV1RoomsMuteUser'] to see the possible values for this operation
     *
     * @throws \WebMI\RocketChatApiClient\RoomsApi\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     ...
     * @param  string $x_auth_token The &#x60;authToken&#x60; of the authenticated user. (required)
     * @param  string $x_user_id The &#x60;userId&#x60; of the authenticated user. (required)
     * @param  \WebMI\RocketChatApiClient\RoomsApi\Model\PostApiV1RoomsSaveNotificationRequest|null $post_api_v1_rooms_save_notification_request post_api_v1_rooms_save_notification_request (optional)
     ...
     * @param  string $x_auth_token The &#x60;authToken&#x60; of the authenticated user. (required)
     * @param  string $x_user_id The &#x60;userId&#x60; of the authenticated user. (required)
     * @param  \WebMI\RocketChatApiClient\RoomsApi\Model\PostApiV1RoomsSaveNotificationRequest|null $post_api_v1_rooms_save_notification_request (optional)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['postApiV1RoomsSaveNotification'] to see the possible values for this operation
     *
     * @throws \WebMI\RocketChatApiClient\RoomsApi\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     ...
     * @param  string $x_auth_token The &#x60;authToken&#x60; of the authenticated user. (required)
     * @param  string $x_user_id The &#x60;userId&#x60; of the authenticated user. (required)
     * @param  \WebMI\RocketChatApiClient\RoomsApi\Model\PostApiV1RoomsSaveRoomSettingsRequest|null $post_api_v1_rooms_save_room_settings_request post_api_v1_rooms_save_room_settings_request (optional)
     ...
     * @throws \WebMI\RocketChatApiClient\RoomsApi\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return \WebMI\RocketChatApiClient\RoomsApi\Model\PostApiV1RoomsSaveRoomSettings200Response|\WebMI\RocketChatApiClient\RoomsApi\Model\PostApiV1ChannelsAddLeader400Response|\WebMI\RocketChatApiClient\RoomsApi\Model\PostApiV1ChannelsCreate401Response
     */
     ...
     * @param  string $x_auth_token The &#x60;authToken&#x60; of the authenticated user. (required)
     * @param  string $x_user_id The &#x60;userId&#x60; of the authenticated user. (required)
     * @param  \WebMI\RocketChatApiClient\RoomsApi\Model\PostApiV1RoomsSaveRoomSettingsRequest|null $post_api_v1_rooms_save_room_settings_request (optional)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['postApiV1RoomsSaveRoomSettings'] to see the possible values for this operation
     *
     * @throws \WebMI\RocketChatApiClient\RoomsApi\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array of \WebMI\RocketChatApiClient\RoomsApi\Model\PostApiV1RoomsSaveRoomSettings200Response|\WebMI\RocketChatApiClient\RoomsApi\Model\PostApiV1ChannelsAddLeader400Response|\WebMI\RocketChatApiClient\RoomsApi\Model\PostApiV1ChannelsCreate401Response, HTTP status code, HTTP response headers (array of strings)
     */
    public function postApiV1RoomsSaveRoomSettingsWithHttpInfo($x_auth_token, $x_user_id, $post_api_v1_rooms_save_room_settings_request = null, string $contentType = self::contentTypes['postApiV1RoomsSaveRoomSettings'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\WebMI\RocketChatApiClient\RoomsApi\Model\PostApiV1RoomsSaveRoomSettings200Response' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\WebMI\RocketChatApiClient\RoomsApi\Model\PostApiV1RoomsSaveRoomSettings200Response' !== 'string') {
                            try {
                                $content = json_decode($content, false, 512, JSON_THROW_ON_ERROR);
                            } catch (\JsonException $exception) {
                                throw new ApiException(
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\WebMI\RocketChatApiClient\RoomsApi\Model\PostApiV1RoomsSaveRoomSettings200Response', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                case 400:
            ...
            $returnType = '\WebMI\RocketChatApiClient\RoomsApi\Model\PostApiV1RoomsSaveRoomSettings200Response';
            if ($returnType === '\SplFileObject') {
                $content = $response->getBody(); //stream goes to serializer
            } else {
                $content = (string) $response->getBody();
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\WebMI\RocketChatApiClient\RoomsApi\Model\PostApiV1RoomsSaveRoomSettings200Response',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     * @param  string $x_auth_token The &#x60;authToken&#x60; of the authenticated user. (required)
     * @param  string $x_user_id The &#x60;userId&#x60; of the authenticated user. (required)
     * @param  \WebMI\RocketChatApiClient\RoomsApi\Model\PostApiV1RoomsUnmuteUserRequest|null $post_api_v1_rooms_unmute_user_request post_api_v1_rooms_unmute_user_request (optional)
     ...
     * @param  string $x_auth_token The &#x60;authToken&#x60; of the authenticated user. (required)
     * @param  string $x_user_id The &#x60;userId&#x60; of the authenticated user. (required)
     * @param  \WebMI\RocketChatApiClient\RoomsApi\Model\PostApiV1RoomsUnmuteUserRequest|null $post_api_v1_rooms_unmute_user_request (optional)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['postApiV1RoomsUnmuteUser'] to see the possible values for this operation
     *
     * @throws \WebMI\RocketChatApiClient\RoomsApi\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
