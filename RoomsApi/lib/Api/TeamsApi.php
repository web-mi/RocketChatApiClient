...
class TeamsApi
{
     ...
     * @param  string $x_auth_token The &#x60;authToken&#x60; of the authenticated user. (required)
     * @param  string $x_user_id The &#x60;userId&#x60; of the authenticated user. (required)
     * @param  \WebMI\RocketChatApiClient\RoomsApi\Model\PostApiV1TeamsAddMembersRequest $post_api_v1_teams_add_members_request post_api_v1_teams_add_members_request (optional)
     ...
     * @param  string $x_auth_token The &#x60;authToken&#x60; of the authenticated user. (required)
     * @param  string $x_user_id The &#x60;userId&#x60; of the authenticated user. (required)
     * @param  \WebMI\RocketChatApiClient\RoomsApi\Model\PostApiV1TeamsAddMembersRequest $post_api_v1_teams_add_members_request (optional)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['postApiV1TeamsAddMembers'] to see the possible values for this operation
     *
     * @throws \WebMI\RocketChatApiClient\RoomsApi\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     ...
     * @param  string $x_auth_token The &#x60;authToken&#x60; of the authenticated user. (required)
     * @param  string $x_user_id The &#x60;userId&#x60; of the authenticated user. (required)
     * @param  \WebMI\RocketChatApiClient\RoomsApi\Model\PostApiV1TeamsAddRoomsRequest $post_api_v1_teams_add_rooms_request post_api_v1_teams_add_rooms_request (optional)
     ...
     * @param  string $x_auth_token The &#x60;authToken&#x60; of the authenticated user. (required)
     * @param  string $x_user_id The &#x60;userId&#x60; of the authenticated user. (required)
     * @param  \WebMI\RocketChatApiClient\RoomsApi\Model\PostApiV1TeamsAddRoomsRequest $post_api_v1_teams_add_rooms_request (optional)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['postApiV1TeamsAddRooms'] to see the possible values for this operation
     *
     * @throws \WebMI\RocketChatApiClient\RoomsApi\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     ...
     * @param  string $x_auth_token The &#x60;authToken&#x60; of the authenticated user. (required)
     * @param  string $x_user_id The &#x60;userId&#x60; of the authenticated user. (required)
     * @param  \WebMI\RocketChatApiClient\RoomsApi\Model\PostApiV1TeamsConvertToChannelRequest $post_api_v1_teams_convert_to_channel_request post_api_v1_teams_convert_to_channel_request (optional)
     ...
     * @param  string $x_auth_token The &#x60;authToken&#x60; of the authenticated user. (required)
     * @param  string $x_user_id The &#x60;userId&#x60; of the authenticated user. (required)
     * @param  \WebMI\RocketChatApiClient\RoomsApi\Model\PostApiV1TeamsConvertToChannelRequest $post_api_v1_teams_convert_to_channel_request (optional)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['postApiV1TeamsConvertToChannel'] to see the possible values for this operation
     *
     * @throws \WebMI\RocketChatApiClient\RoomsApi\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     ...
     * @param  string $x_auth_token The &#x60;authToken&#x60; of the authenticated user. (required)
     * @param  string $x_user_id The &#x60;userId&#x60; of the authenticated user. (required)
     * @param  \WebMI\RocketChatApiClient\RoomsApi\Model\PostApiV1TeamsCreateRequest $post_api_v1_teams_create_request post_api_v1_teams_create_request (optional)
     ...
     * @param  string $x_auth_token The &#x60;authToken&#x60; of the authenticated user. (required)
     * @param  string $x_user_id The &#x60;userId&#x60; of the authenticated user. (required)
     * @param  \WebMI\RocketChatApiClient\RoomsApi\Model\PostApiV1TeamsCreateRequest $post_api_v1_teams_create_request (optional)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['postApiV1TeamsCreate'] to see the possible values for this operation
     *
     * @throws \WebMI\RocketChatApiClient\RoomsApi\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     ...
     * @param  string $x_auth_token The &#x60;authToken&#x60; of the authenticated user. (required)
     * @param  string $x_user_id The &#x60;userId&#x60; of the authenticated user. (required)
     * @param  \WebMI\RocketChatApiClient\RoomsApi\Model\PostApiV1TeamsLeaveRequest $post_api_v1_teams_leave_request post_api_v1_teams_leave_request (optional)
     ...
     * @param  string $x_auth_token The &#x60;authToken&#x60; of the authenticated user. (required)
     * @param  string $x_user_id The &#x60;userId&#x60; of the authenticated user. (required)
     * @param  \WebMI\RocketChatApiClient\RoomsApi\Model\PostApiV1TeamsLeaveRequest $post_api_v1_teams_leave_request (optional)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['postApiV1TeamsLeave'] to see the possible values for this operation
     *
     * @throws \WebMI\RocketChatApiClient\RoomsApi\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     ...
     * @param  string $x_auth_token The &#x60;authToken&#x60; of the authenticated user. (required)
     * @param  string $x_user_id The &#x60;userId&#x60; of the authenticated user. (required)
     * @param  \WebMI\RocketChatApiClient\RoomsApi\Model\PostApiV1TeamsRemoveMemberRequest $post_api_v1_teams_remove_member_request  (optional)
     ...
     * @param  string $x_user_id The &#x60;userId&#x60; of the authenticated user. (required)
     * @param  string $x_auth_token The &#x60;authToken&#x60; of the authenticated user. (required)
     * @param  \WebMI\RocketChatApiClient\RoomsApi\Model\PostApiV1TeamsRemoveRoomRequest $post_api_v1_teams_remove_room_request post_api_v1_teams_remove_room_request (optional)
     ...
     * @param  string $x_user_id The &#x60;userId&#x60; of the authenticated user. (required)
     * @param  string $x_auth_token The &#x60;authToken&#x60; of the authenticated user. (required)
     * @param  \WebMI\RocketChatApiClient\RoomsApi\Model\PostApiV1TeamsRemoveRoomRequest $post_api_v1_teams_remove_room_request (optional)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['postApiV1TeamsRemoveRoom'] to see the possible values for this operation
     *
     * @throws \WebMI\RocketChatApiClient\RoomsApi\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     ...
     * @param  string $x_auth_token The &#x60;authToken&#x60; of the authenticated user. (required)
     * @param  string $x_user_id The &#x60;userId&#x60; of the authenticated user. (required)
     * @param  \WebMI\RocketChatApiClient\RoomsApi\Model\PostApiV1TeamsUpdateRequest $post_api_v1_teams_update_request post_api_v1_teams_update_request (optional)
     ...
     * @param  string $x_auth_token The &#x60;authToken&#x60; of the authenticated user. (required)
     * @param  string $x_user_id The &#x60;userId&#x60; of the authenticated user. (required)
     * @param  \WebMI\RocketChatApiClient\RoomsApi\Model\PostApiV1TeamsUpdateRequest $post_api_v1_teams_update_request (optional)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['postApiV1TeamsUpdate'] to see the possible values for this operation
     *
     * @throws \WebMI\RocketChatApiClient\RoomsApi\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     ...
     * @param  string $x_auth_token The &#x60;authToken&#x60; of the authenticated user. (required)
     * @param  string $x_user_id The &#x60;userId&#x60; of the authenticated user. (required)
     * @param  \WebMI\RocketChatApiClient\RoomsApi\Model\PostApiV1TeamsUpdateRoomRequest $post_api_v1_teams_update_room_request post_api_v1_teams_update_room_request (optional)
     ...
     * @param  string $x_auth_token The &#x60;authToken&#x60; of the authenticated user. (required)
     * @param  string $x_user_id The &#x60;userId&#x60; of the authenticated user. (required)
     * @param  \WebMI\RocketChatApiClient\RoomsApi\Model\PostApiV1TeamsUpdateRoomRequest $post_api_v1_teams_update_room_request (optional)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['postApiV1TeamsUpdateRoom'] to see the possible values for this operation
     *
     * @throws \WebMI\RocketChatApiClient\RoomsApi\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
