...
class TeamsApi
{
     ...
     * @return \WebMI\RocketChatApiClient\RoomsApi\Model\GetApiV1TeamsAutocomplete200Response|\WebMI\RocketChatApiClient\RoomsApi\Model\PostApiV1ChannelsCreate401Response
     */
     ...
     * @throws \WebMI\RocketChatApiClient\RoomsApi\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array of \WebMI\RocketChatApiClient\RoomsApi\Model\GetApiV1TeamsAutocomplete200Response|\WebMI\RocketChatApiClient\RoomsApi\Model\PostApiV1ChannelsCreate401Response, HTTP status code, HTTP response headers (array of strings)
     */
    public function getApiV1TeamsAutocompleteWithHttpInfo($x_auth_token, $x_user_id, $name, string $contentType = self::contentTypes['getApiV1TeamsAutocomplete'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\WebMI\RocketChatApiClient\RoomsApi\Model\GetApiV1TeamsAutocomplete200Response' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\WebMI\RocketChatApiClient\RoomsApi\Model\GetApiV1TeamsAutocomplete200Response' !== 'string') {
                            try {
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\WebMI\RocketChatApiClient\RoomsApi\Model\GetApiV1TeamsAutocomplete200Response', []),
            ...
            $returnType = '\WebMI\RocketChatApiClient\RoomsApi\Model\GetApiV1TeamsAutocomplete200Response';
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\WebMI\RocketChatApiClient\RoomsApi\Model\GetApiV1TeamsAutocomplete200Response',
     ...
     * @param  string $x_auth_token The &#x60;authToken&#x60; of the authenticated user. (required)
     * @param  string $x_user_id The &#x60;userId&#x60; of the authenticated user. (required)
     * @param  string|null $team_id The team id.  It is required if the &#x60;teamName&#x60; is not provided. (optional)
     * @param  string|null $team_name The team name.  It is required if the &#x60;teamId&#x60; is not provided. (optional)
     ...
     * @throws \WebMI\RocketChatApiClient\RoomsApi\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return \WebMI\RocketChatApiClient\RoomsApi\Model\GetApiV1TeamsInfo200Response|\WebMI\RocketChatApiClient\RoomsApi\Model\PostApiV1ChannelsCreate401Response
     */
     ...
     * @throws \WebMI\RocketChatApiClient\RoomsApi\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array of \WebMI\RocketChatApiClient\RoomsApi\Model\GetApiV1TeamsInfo200Response|\WebMI\RocketChatApiClient\RoomsApi\Model\PostApiV1ChannelsCreate401Response, HTTP status code, HTTP response headers (array of strings)
     */
    public function getApiV1TeamsInfoWithHttpInfo($x_auth_token, $x_user_id, $team_id = null, $team_name = null, string $contentType = self::contentTypes['getApiV1TeamsInfo'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\WebMI\RocketChatApiClient\RoomsApi\Model\GetApiV1TeamsInfo200Response' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\WebMI\RocketChatApiClient\RoomsApi\Model\GetApiV1TeamsInfo200Response' !== 'string') {
                            try {
                                $content = json_decode($content, false, 512, JSON_THROW_ON_ERROR);
                            } catch (\JsonException $exception) {
                                throw new ApiException(
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\WebMI\RocketChatApiClient\RoomsApi\Model\GetApiV1TeamsInfo200Response', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                case 401:
            ...
            $returnType = '\WebMI\RocketChatApiClient\RoomsApi\Model\GetApiV1TeamsInfo200Response';
            if ($returnType === '\SplFileObject') {
                $content = $response->getBody(); //stream goes to serializer
            } else {
                $content = (string) $response->getBody();
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\WebMI\RocketChatApiClient\RoomsApi\Model\GetApiV1TeamsInfo200Response',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     * @throws \WebMI\RocketChatApiClient\RoomsApi\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return \WebMI\RocketChatApiClient\RoomsApi\Model\GetApiV1TeamsListAll200Response|\WebMI\RocketChatApiClient\RoomsApi\Model\PostApiV1ChannelsCreate401Response
     */
     ...
     * @throws \WebMI\RocketChatApiClient\RoomsApi\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array of \WebMI\RocketChatApiClient\RoomsApi\Model\GetApiV1TeamsListAll200Response|\WebMI\RocketChatApiClient\RoomsApi\Model\PostApiV1ChannelsCreate401Response, HTTP status code, HTTP response headers (array of strings)
     */
    public function getApiV1TeamsListWithHttpInfo($x_auth_token, $x_user_id, $sort = null, $offset = null, $count = null, $query = null, string $contentType = self::contentTypes['getApiV1TeamsList'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\WebMI\RocketChatApiClient\RoomsApi\Model\GetApiV1TeamsListAll200Response' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\WebMI\RocketChatApiClient\RoomsApi\Model\GetApiV1TeamsListAll200Response' !== 'string') {
                            try {
                                $content = json_decode($content, false, 512, JSON_THROW_ON_ERROR);
                            } catch (\JsonException $exception) {
                                throw new ApiException(
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\WebMI\RocketChatApiClient\RoomsApi\Model\GetApiV1TeamsListAll200Response', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                case 401:
            ...
            $returnType = '\WebMI\RocketChatApiClient\RoomsApi\Model\GetApiV1TeamsListAll200Response';
            if ($returnType === '\SplFileObject') {
                $content = $response->getBody(); //stream goes to serializer
            } else {
                $content = (string) $response->getBody();
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\WebMI\RocketChatApiClient\RoomsApi\Model\GetApiV1TeamsListAll200Response',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     * @param  int|null $count The number of items to return. (optional)
     * @param  mixed|null $sort List of fields to order by, and in which direction. This is a JSON object, with properties listed in desired order, with values of 1 for ascending, or -1 for descending. For example, {\&quot;value\&quot;: -1, \&quot;_id\&quot;: 1} (optional)
     * @param  string|null $filter Filter the results using the text you want to find. (optional)
     * @param  string|null $type You can choose the type of rooms you want in the response. Enter the value as &#x60;channels&#x60; or &#x60;discussions&#x60;. If you don&#39;t enter any value, both types are returned. (optional)
     * @param  string|null $room_id The room ID. This parameter is required if you have not provided the &#x60;teamId&#x60; or the &#x60;teamName&#x60;. (optional)
     ...
     * @throws \WebMI\RocketChatApiClient\RoomsApi\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return \WebMI\RocketChatApiClient\RoomsApi\Model\GetApiV1TeamsListChildren200Response|\WebMI\RocketChatApiClient\RoomsApi\Model\PostApiV1ChannelsAddLeader400Response|\WebMI\RocketChatApiClient\RoomsApi\Model\PostApiV1ChannelsCreate401Response
     */
     ...
     * @throws \WebMI\RocketChatApiClient\RoomsApi\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array of \WebMI\RocketChatApiClient\RoomsApi\Model\GetApiV1TeamsListChildren200Response|\WebMI\RocketChatApiClient\RoomsApi\Model\PostApiV1ChannelsAddLeader400Response|\WebMI\RocketChatApiClient\RoomsApi\Model\PostApiV1ChannelsCreate401Response, HTTP status code, HTTP response headers (array of strings)
     */
    public function getApiV1TeamsListChildrenWithHttpInfo($x_user_id, $x_auth_token, $team_name = null, $team_id = null, $offset = null, $count = null, $sort = null, $filter = null, $type = null, $room_id = null, string $contentType = self::contentTypes['getApiV1TeamsListChildren'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\WebMI\RocketChatApiClient\RoomsApi\Model\GetApiV1TeamsListChildren200Response' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\WebMI\RocketChatApiClient\RoomsApi\Model\GetApiV1TeamsListChildren200Response' !== 'string') {
                            try {
                                $content = json_decode($content, false, 512, JSON_THROW_ON_ERROR);
                            } catch (\JsonException $exception) {
                                throw new ApiException(
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\WebMI\RocketChatApiClient\RoomsApi\Model\GetApiV1TeamsListChildren200Response', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                case 400:
            ...
            $returnType = '\WebMI\RocketChatApiClient\RoomsApi\Model\GetApiV1TeamsListChildren200Response';
            if ($returnType === '\SplFileObject') {
                $content = $response->getBody(); //stream goes to serializer
            } else {
                $content = (string) $response->getBody();
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\WebMI\RocketChatApiClient\RoomsApi\Model\GetApiV1TeamsListChildren200Response',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     * @param  string|null $team_id The team id.  It is required if the &#x60;teamName&#x60; is not provided. (optional)
     * @param  string|null $team_name The team name.  It is required if the &#x60;teamId&#x60; is not provided. (optional)
     * @param  string|null $type The room&#39;s type (search filter). (optional)
     * @param  int|null $count The number of items to return. (optional)
     * @param  int|null $offset Number of items to \&quot;skip\&quot; in the query, i.e. requests return count items, skipping the first offset items. (optional)
     ...
     * @throws \WebMI\RocketChatApiClient\RoomsApi\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return \WebMI\RocketChatApiClient\RoomsApi\Model\GetApiV1TeamsListRooms200Response|\WebMI\RocketChatApiClient\RoomsApi\Model\PostApiV1ChannelsCreate401Response
     */
     ...
     * @throws \WebMI\RocketChatApiClient\RoomsApi\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array of \WebMI\RocketChatApiClient\RoomsApi\Model\GetApiV1TeamsListRooms200Response|\WebMI\RocketChatApiClient\RoomsApi\Model\PostApiV1ChannelsCreate401Response, HTTP status code, HTTP response headers (array of strings)
     */
    public function getApiV1TeamsListRoomsWithHttpInfo($x_auth_token, $x_user_id, $team_id = null, $team_name = null, $type = null, $count = null, $offset = null, string $contentType = self::contentTypes['getApiV1TeamsListRooms'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\WebMI\RocketChatApiClient\RoomsApi\Model\GetApiV1TeamsListRooms200Response' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\WebMI\RocketChatApiClient\RoomsApi\Model\GetApiV1TeamsListRooms200Response' !== 'string') {
                            try {
                                $content = json_decode($content, false, 512, JSON_THROW_ON_ERROR);
                            } catch (\JsonException $exception) {
                                throw new ApiException(
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\WebMI\RocketChatApiClient\RoomsApi\Model\GetApiV1TeamsListRooms200Response', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                case 401:
            ...
            $returnType = '\WebMI\RocketChatApiClient\RoomsApi\Model\GetApiV1TeamsListRooms200Response';
            if ($returnType === '\SplFileObject') {
                $content = $response->getBody(); //stream goes to serializer
            } else {
                $content = (string) $response->getBody();
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\WebMI\RocketChatApiClient\RoomsApi\Model\GetApiV1TeamsListRooms200Response',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     * @throws \WebMI\RocketChatApiClient\RoomsApi\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return \WebMI\RocketChatApiClient\RoomsApi\Model\GetApiV1TeamsListRoomsOfUser200Response|\WebMI\RocketChatApiClient\RoomsApi\Model\PostApiV1ChannelsCreate401Response
     */
     ...
     * @throws \WebMI\RocketChatApiClient\RoomsApi\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array of \WebMI\RocketChatApiClient\RoomsApi\Model\GetApiV1TeamsListRoomsOfUser200Response|\WebMI\RocketChatApiClient\RoomsApi\Model\PostApiV1ChannelsCreate401Response, HTTP status code, HTTP response headers (array of strings)
     */
    public function getApiV1TeamsListRoomsOfUserWithHttpInfo($x_user_id, $x_auth_token, $user_id, $team_name = null, $team_id = null, $offset = null, $count = null, string $contentType = self::contentTypes['getApiV1TeamsListRoomsOfUser'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\WebMI\RocketChatApiClient\RoomsApi\Model\GetApiV1TeamsListRoomsOfUser200Response' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\WebMI\RocketChatApiClient\RoomsApi\Model\GetApiV1TeamsListRoomsOfUser200Response' !== 'string') {
                            try {
                                $content = json_decode($content, false, 512, JSON_THROW_ON_ERROR);
                            } catch (\JsonException $exception) {
                                throw new ApiException(
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\WebMI\RocketChatApiClient\RoomsApi\Model\GetApiV1TeamsListRoomsOfUser200Response', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                case 401:
            ...
            $returnType = '\WebMI\RocketChatApiClient\RoomsApi\Model\GetApiV1TeamsListRoomsOfUser200Response';
            if ($returnType === '\SplFileObject') {
                $content = $response->getBody(); //stream goes to serializer
            } else {
                $content = (string) $response->getBody();
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\WebMI\RocketChatApiClient\RoomsApi\Model\GetApiV1TeamsListRoomsOfUser200Response',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     * @param  string|null $team_name The team name.  It is required if the &#x60;teamId&#x60; is not provided. (optional)
     * @param  string|null $team_id The team id.  It is required if the &#x60;teamName&#x60; is not provided. (optional)
     * @param  string|null $name Search filter for the user&#39;s name (optional)
     * @param  string|null $username Search filter for the user&#39;s username (optional)
     * @param  string[]|null $status Search filter for the user&#39;s status (optional)
     ...
     * @throws \WebMI\RocketChatApiClient\RoomsApi\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return \WebMI\RocketChatApiClient\RoomsApi\Model\GetApiV1TeamsMembers200Response|\WebMI\RocketChatApiClient\RoomsApi\Model\PostApiV1ChannelsCreate401Response
     */
     ...
     * @throws \WebMI\RocketChatApiClient\RoomsApi\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array of \WebMI\RocketChatApiClient\RoomsApi\Model\GetApiV1TeamsMembers200Response|\WebMI\RocketChatApiClient\RoomsApi\Model\PostApiV1ChannelsCreate401Response, HTTP status code, HTTP response headers (array of strings)
     */
    public function getApiV1TeamsMembersWithHttpInfo($x_auth_token, $x_user_id, $team_name = null, $team_id = null, $name = null, $username = null, $status = null, string $contentType = self::contentTypes['getApiV1TeamsMembers'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\WebMI\RocketChatApiClient\RoomsApi\Model\GetApiV1TeamsMembers200Response' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\WebMI\RocketChatApiClient\RoomsApi\Model\GetApiV1TeamsMembers200Response' !== 'string') {
                            try {
                                $content = json_decode($content, false, 512, JSON_THROW_ON_ERROR);
                            } catch (\JsonException $exception) {
                                throw new ApiException(
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\WebMI\RocketChatApiClient\RoomsApi\Model\GetApiV1TeamsMembers200Response', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                case 401:
            ...
            $returnType = '\WebMI\RocketChatApiClient\RoomsApi\Model\GetApiV1TeamsMembers200Response';
            if ($returnType === '\SplFileObject') {
                $content = $response->getBody(); //stream goes to serializer
            } else {
                $content = (string) $response->getBody();
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\WebMI\RocketChatApiClient\RoomsApi\Model\GetApiV1TeamsMembers200Response',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     * @param  string $x_auth_token The &#x60;authToken&#x60; of the authenticated user. (required)
     * @param  string $x_user_id The &#x60;userId&#x60; of the authenticated user. (required)
     * @param  \WebMI\RocketChatApiClient\RoomsApi\Model\PostApiV1TeamsAddMembersRequest|null $post_api_v1_teams_add_members_request post_api_v1_teams_add_members_request (optional)
     ...
     * @param  string $x_auth_token The &#x60;authToken&#x60; of the authenticated user. (required)
     * @param  string $x_user_id The &#x60;userId&#x60; of the authenticated user. (required)
     * @param  \WebMI\RocketChatApiClient\RoomsApi\Model\PostApiV1TeamsAddMembersRequest|null $post_api_v1_teams_add_members_request (optional)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['postApiV1TeamsAddMembers'] to see the possible values for this operation
     *
     * @throws \WebMI\RocketChatApiClient\RoomsApi\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     ...
     * @param  string $x_auth_token The &#x60;authToken&#x60; of the authenticated user. (required)
     * @param  string $x_user_id The &#x60;userId&#x60; of the authenticated user. (required)
     * @param  \WebMI\RocketChatApiClient\RoomsApi\Model\PostApiV1TeamsAddRoomsRequest|null $post_api_v1_teams_add_rooms_request post_api_v1_teams_add_rooms_request (optional)
     ...
     * @throws \WebMI\RocketChatApiClient\RoomsApi\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return \WebMI\RocketChatApiClient\RoomsApi\Model\PostApiV1TeamsAddRooms200Response|\WebMI\RocketChatApiClient\RoomsApi\Model\PostApiV1ChannelsCreate401Response
     */
     ...
     * @param  string $x_auth_token The &#x60;authToken&#x60; of the authenticated user. (required)
     * @param  string $x_user_id The &#x60;userId&#x60; of the authenticated user. (required)
     * @param  \WebMI\RocketChatApiClient\RoomsApi\Model\PostApiV1TeamsAddRoomsRequest|null $post_api_v1_teams_add_rooms_request (optional)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['postApiV1TeamsAddRooms'] to see the possible values for this operation
     *
     * @throws \WebMI\RocketChatApiClient\RoomsApi\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array of \WebMI\RocketChatApiClient\RoomsApi\Model\PostApiV1TeamsAddRooms200Response|\WebMI\RocketChatApiClient\RoomsApi\Model\PostApiV1ChannelsCreate401Response, HTTP status code, HTTP response headers (array of strings)
     */
    public function postApiV1TeamsAddRoomsWithHttpInfo($x_auth_token, $x_user_id, $post_api_v1_teams_add_rooms_request = null, string $contentType = self::contentTypes['postApiV1TeamsAddRooms'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\WebMI\RocketChatApiClient\RoomsApi\Model\PostApiV1TeamsAddRooms200Response' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\WebMI\RocketChatApiClient\RoomsApi\Model\PostApiV1TeamsAddRooms200Response' !== 'string') {
                            try {
                                $content = json_decode($content, false, 512, JSON_THROW_ON_ERROR);
                            } catch (\JsonException $exception) {
                                throw new ApiException(
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\WebMI\RocketChatApiClient\RoomsApi\Model\PostApiV1TeamsAddRooms200Response', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                case 401:
            ...
            $returnType = '\WebMI\RocketChatApiClient\RoomsApi\Model\PostApiV1TeamsAddRooms200Response';
            if ($returnType === '\SplFileObject') {
                $content = $response->getBody(); //stream goes to serializer
            } else {
                $content = (string) $response->getBody();
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\WebMI\RocketChatApiClient\RoomsApi\Model\PostApiV1TeamsAddRooms200Response',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     * @param  string $x_auth_token The &#x60;authToken&#x60; of the authenticated user. (required)
     * @param  string $x_user_id The &#x60;userId&#x60; of the authenticated user. (required)
     * @param  \WebMI\RocketChatApiClient\RoomsApi\Model\PostApiV1TeamsConvertToChannelRequest|null $post_api_v1_teams_convert_to_channel_request post_api_v1_teams_convert_to_channel_request (optional)
     ...
     * @param  string $x_auth_token The &#x60;authToken&#x60; of the authenticated user. (required)
     * @param  string $x_user_id The &#x60;userId&#x60; of the authenticated user. (required)
     * @param  \WebMI\RocketChatApiClient\RoomsApi\Model\PostApiV1TeamsConvertToChannelRequest|null $post_api_v1_teams_convert_to_channel_request (optional)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['postApiV1TeamsConvertToChannel'] to see the possible values for this operation
     *
     * @throws \WebMI\RocketChatApiClient\RoomsApi\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     ...
     * @param  string $x_auth_token The &#x60;authToken&#x60; of the authenticated user. (required)
     * @param  string $x_user_id The &#x60;userId&#x60; of the authenticated user. (required)
     * @param  \WebMI\RocketChatApiClient\RoomsApi\Model\PostApiV1TeamsCreateRequest|null $post_api_v1_teams_create_request post_api_v1_teams_create_request (optional)
     ...
     * @param  string $x_auth_token The &#x60;authToken&#x60; of the authenticated user. (required)
     * @param  string $x_user_id The &#x60;userId&#x60; of the authenticated user. (required)
     * @param  \WebMI\RocketChatApiClient\RoomsApi\Model\PostApiV1TeamsCreateRequest|null $post_api_v1_teams_create_request (optional)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['postApiV1TeamsCreate'] to see the possible values for this operation
     *
     * @throws \WebMI\RocketChatApiClient\RoomsApi\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     ...
     * @param  string $x_auth_token The &#x60;authToken&#x60; of the authenticated user. (required)
     * @param  string $x_user_id The &#x60;userId&#x60; of the authenticated user. (required)
     * @param  \WebMI\RocketChatApiClient\RoomsApi\Model\PostApiV1TeamsDeleteRequest|null $post_api_v1_teams_delete_request post_api_v1_teams_delete_request (optional)
     ...
     * @param  string $x_auth_token The &#x60;authToken&#x60; of the authenticated user. (required)
     * @param  string $x_user_id The &#x60;userId&#x60; of the authenticated user. (required)
     * @param  \WebMI\RocketChatApiClient\RoomsApi\Model\PostApiV1TeamsDeleteRequest|null $post_api_v1_teams_delete_request (optional)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['postApiV1TeamsDelete'] to see the possible values for this operation
     *
     * @throws \WebMI\RocketChatApiClient\RoomsApi\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     ...
     * @param  string $x_auth_token The &#x60;authToken&#x60; of the authenticated user. (required)
     * @param  string $x_user_id The &#x60;userId&#x60; of the authenticated user. (required)
     * @param  \WebMI\RocketChatApiClient\RoomsApi\Model\PostApiV1TeamsLeaveRequest|null $post_api_v1_teams_leave_request post_api_v1_teams_leave_request (optional)
     ...
     * @param  string $x_auth_token The &#x60;authToken&#x60; of the authenticated user. (required)
     * @param  string $x_user_id The &#x60;userId&#x60; of the authenticated user. (required)
     * @param  \WebMI\RocketChatApiClient\RoomsApi\Model\PostApiV1TeamsLeaveRequest|null $post_api_v1_teams_leave_request (optional)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['postApiV1TeamsLeave'] to see the possible values for this operation
     *
     * @throws \WebMI\RocketChatApiClient\RoomsApi\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     ...
     * @param  string $x_auth_token The &#x60;authToken&#x60; of the authenticated user. (required)
     * @param  string $x_user_id The &#x60;userId&#x60; of the authenticated user. (required)
     * @param  \WebMI\RocketChatApiClient\RoomsApi\Model\PostApiV1TeamsRemoveMemberRequest|null $post_api_v1_teams_remove_member_request  (optional)
     ...
     * @param  string $x_user_id The &#x60;userId&#x60; of the authenticated user. (required)
     * @param  string $x_auth_token The &#x60;authToken&#x60; of the authenticated user. (required)
     * @param  \WebMI\RocketChatApiClient\RoomsApi\Model\PostApiV1TeamsRemoveRoomRequest|null $post_api_v1_teams_remove_room_request post_api_v1_teams_remove_room_request (optional)
     ...
     * @throws \WebMI\RocketChatApiClient\RoomsApi\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return \WebMI\RocketChatApiClient\RoomsApi\Model\PostApiV1TeamsRemoveRoom200Response|\WebMI\RocketChatApiClient\RoomsApi\Model\PostApiV1ChannelsCreate401Response
     */
     ...
     * @param  string $x_user_id The &#x60;userId&#x60; of the authenticated user. (required)
     * @param  string $x_auth_token The &#x60;authToken&#x60; of the authenticated user. (required)
     * @param  \WebMI\RocketChatApiClient\RoomsApi\Model\PostApiV1TeamsRemoveRoomRequest|null $post_api_v1_teams_remove_room_request (optional)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['postApiV1TeamsRemoveRoom'] to see the possible values for this operation
     *
     * @throws \WebMI\RocketChatApiClient\RoomsApi\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array of \WebMI\RocketChatApiClient\RoomsApi\Model\PostApiV1TeamsRemoveRoom200Response|\WebMI\RocketChatApiClient\RoomsApi\Model\PostApiV1ChannelsCreate401Response, HTTP status code, HTTP response headers (array of strings)
     */
    public function postApiV1TeamsRemoveRoomWithHttpInfo($x_user_id, $x_auth_token, $post_api_v1_teams_remove_room_request = null, string $contentType = self::contentTypes['postApiV1TeamsRemoveRoom'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\WebMI\RocketChatApiClient\RoomsApi\Model\PostApiV1TeamsRemoveRoom200Response' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\WebMI\RocketChatApiClient\RoomsApi\Model\PostApiV1TeamsRemoveRoom200Response' !== 'string') {
                            try {
                                $content = json_decode($content, false, 512, JSON_THROW_ON_ERROR);
                            } catch (\JsonException $exception) {
                                throw new ApiException(
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\WebMI\RocketChatApiClient\RoomsApi\Model\PostApiV1TeamsRemoveRoom200Response', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                case 401:
            ...
            $returnType = '\WebMI\RocketChatApiClient\RoomsApi\Model\PostApiV1TeamsRemoveRoom200Response';
            if ($returnType === '\SplFileObject') {
                $content = $response->getBody(); //stream goes to serializer
            } else {
                $content = (string) $response->getBody();
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\WebMI\RocketChatApiClient\RoomsApi\Model\PostApiV1TeamsRemoveRoom200Response',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     * @param  string $x_auth_token The &#x60;authToken&#x60; of the authenticated user. (required)
     * @param  string $x_user_id The &#x60;userId&#x60; of the authenticated user. (required)
     * @param  \WebMI\RocketChatApiClient\RoomsApi\Model\PostApiV1TeamsUpdateRequest|null $post_api_v1_teams_update_request post_api_v1_teams_update_request (optional)
     ...
     * @param  string $x_auth_token The &#x60;authToken&#x60; of the authenticated user. (required)
     * @param  string $x_user_id The &#x60;userId&#x60; of the authenticated user. (required)
     * @param  \WebMI\RocketChatApiClient\RoomsApi\Model\PostApiV1TeamsUpdateRequest|null $post_api_v1_teams_update_request (optional)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['postApiV1TeamsUpdate'] to see the possible values for this operation
     *
     * @throws \WebMI\RocketChatApiClient\RoomsApi\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     ...
     * @param  string $x_auth_token The &#x60;authToken&#x60; of the authenticated user. (required)
     * @param  string $x_user_id The &#x60;userId&#x60; of the authenticated user. (required)
     * @param  \WebMI\RocketChatApiClient\RoomsApi\Model\PostApiV1TeamsUpdateRoomRequest|null $post_api_v1_teams_update_room_request post_api_v1_teams_update_room_request (optional)
     ...
     * @throws \WebMI\RocketChatApiClient\RoomsApi\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return \WebMI\RocketChatApiClient\RoomsApi\Model\PostApiV1TeamsUpdateRoom200Response|\WebMI\RocketChatApiClient\RoomsApi\Model\PostApiV1ChannelsCreate401Response
     */
     ...
     * @param  string $x_auth_token The &#x60;authToken&#x60; of the authenticated user. (required)
     * @param  string $x_user_id The &#x60;userId&#x60; of the authenticated user. (required)
     * @param  \WebMI\RocketChatApiClient\RoomsApi\Model\PostApiV1TeamsUpdateRoomRequest|null $post_api_v1_teams_update_room_request (optional)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['postApiV1TeamsUpdateRoom'] to see the possible values for this operation
     *
     * @throws \WebMI\RocketChatApiClient\RoomsApi\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array of \WebMI\RocketChatApiClient\RoomsApi\Model\PostApiV1TeamsUpdateRoom200Response|\WebMI\RocketChatApiClient\RoomsApi\Model\PostApiV1ChannelsCreate401Response, HTTP status code, HTTP response headers (array of strings)
     */
    public function postApiV1TeamsUpdateRoomWithHttpInfo($x_auth_token, $x_user_id, $post_api_v1_teams_update_room_request = null, string $contentType = self::contentTypes['postApiV1TeamsUpdateRoom'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\WebMI\RocketChatApiClient\RoomsApi\Model\PostApiV1TeamsUpdateRoom200Response' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\WebMI\RocketChatApiClient\RoomsApi\Model\PostApiV1TeamsUpdateRoom200Response' !== 'string') {
                            try {
                                $content = json_decode($content, false, 512, JSON_THROW_ON_ERROR);
                            } catch (\JsonException $exception) {
                                throw new ApiException(
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\WebMI\RocketChatApiClient\RoomsApi\Model\PostApiV1TeamsUpdateRoom200Response', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                case 401:
            ...
            $returnType = '\WebMI\RocketChatApiClient\RoomsApi\Model\PostApiV1TeamsUpdateRoom200Response';
            if ($returnType === '\SplFileObject') {
                $content = $response->getBody(); //stream goes to serializer
            } else {
                $content = (string) $response->getBody();
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\WebMI\RocketChatApiClient\RoomsApi\Model\PostApiV1TeamsUpdateRoom200Response',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
