...
class ModerationApi
{
     ...
     * @throws \RocketChatSettingsApi\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return \RocketChatSettingsApi\Model\GetApiV1ModerationReports200Response|\RocketChatSettingsApi\Model\GetApiV1Settings401Response|\RocketChatSettingsApi\Model\PostApiV1CloudManualRegister400Response
     */
     ...
     * @throws \RocketChatSettingsApi\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array of \RocketChatSettingsApi\Model\GetApiV1ModerationReports200Response|\RocketChatSettingsApi\Model\GetApiV1Settings401Response|\RocketChatSettingsApi\Model\PostApiV1CloudManualRegister400Response, HTTP status code, HTTP response headers (array of strings)
     */
    public function getApiV1ModerationReportsWithHttpInfo($x_user_id, $x_auth_token, $msg_id, $offset = null, $count = null, $sort = null, string $contentType = self::contentTypes['getApiV1ModerationReports'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\RocketChatSettingsApi\Model\GetApiV1ModerationReports200Response' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\RocketChatSettingsApi\Model\GetApiV1ModerationReports200Response' !== 'string') {
                            try {
                                $content = json_decode($content, false, 512, JSON_THROW_ON_ERROR);
                            } catch (\JsonException $exception) {
                                throw new ApiException(
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\RocketChatSettingsApi\Model\GetApiV1ModerationReports200Response', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                case 401:
            ...
            $returnType = '\RocketChatSettingsApi\Model\GetApiV1ModerationReports200Response';
            if ($returnType === '\SplFileObject') {
                $content = $response->getBody(); //stream goes to serializer
            } else {
                $content = (string) $response->getBody();
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\RocketChatSettingsApi\Model\GetApiV1ModerationReports200Response',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     * @throws \RocketChatSettingsApi\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return \RocketChatSettingsApi\Model\GetApiV1ModerationReportsByUsers200Response|\RocketChatSettingsApi\Model\GetApiV1Settings401Response|\RocketChatSettingsApi\Model\PostApiV1CloudManualRegister400Response
     */
     ...
     * @throws \RocketChatSettingsApi\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array of \RocketChatSettingsApi\Model\GetApiV1ModerationReportsByUsers200Response|\RocketChatSettingsApi\Model\GetApiV1Settings401Response|\RocketChatSettingsApi\Model\PostApiV1CloudManualRegister400Response, HTTP status code, HTTP response headers (array of strings)
     */
    public function getApiV1ModerationReportsByUsersWithHttpInfo($x_user_id, $x_auth_token, $oldest = null, $latest = null, $offset = null, $count = null, $sort = null, string $contentType = self::contentTypes['getApiV1ModerationReportsByUsers'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\RocketChatSettingsApi\Model\GetApiV1ModerationReportsByUsers200Response' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\RocketChatSettingsApi\Model\GetApiV1ModerationReportsByUsers200Response' !== 'string') {
                            try {
                                $content = json_decode($content, false, 512, JSON_THROW_ON_ERROR);
                            } catch (\JsonException $exception) {
                                throw new ApiException(
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\RocketChatSettingsApi\Model\GetApiV1ModerationReportsByUsers200Response', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                case 401:
            ...
            $returnType = '\RocketChatSettingsApi\Model\GetApiV1ModerationReportsByUsers200Response';
            if ($returnType === '\SplFileObject') {
                $content = $response->getBody(); //stream goes to serializer
            } else {
                $content = (string) $response->getBody();
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\RocketChatSettingsApi\Model\GetApiV1ModerationReportsByUsers200Response',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     * @throws \RocketChatSettingsApi\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return \RocketChatSettingsApi\Model\GetApiV1ModerationUserReportedMessages200Response|\RocketChatSettingsApi\Model\GetApiV1Settings401Response|\RocketChatSettingsApi\Model\PostApiV1CloudManualRegister400Response
     */
     ...
     * @throws \RocketChatSettingsApi\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array of \RocketChatSettingsApi\Model\GetApiV1ModerationUserReportedMessages200Response|\RocketChatSettingsApi\Model\GetApiV1Settings401Response|\RocketChatSettingsApi\Model\PostApiV1CloudManualRegister400Response, HTTP status code, HTTP response headers (array of strings)
     */
    public function getApiV1ModerationUserReportedMessagesWithHttpInfo($x_user_id, $x_auth_token, $user_id, $offset = null, $count = null, $sort = null, string $contentType = self::contentTypes['getApiV1ModerationUserReportedMessages'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\RocketChatSettingsApi\Model\GetApiV1ModerationUserReportedMessages200Response' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\RocketChatSettingsApi\Model\GetApiV1ModerationUserReportedMessages200Response' !== 'string') {
                            try {
                                $content = json_decode($content, false, 512, JSON_THROW_ON_ERROR);
                            } catch (\JsonException $exception) {
                                throw new ApiException(
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\RocketChatSettingsApi\Model\GetApiV1ModerationUserReportedMessages200Response', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                case 401:
            ...
            $returnType = '\RocketChatSettingsApi\Model\GetApiV1ModerationUserReportedMessages200Response';
            if ($returnType === '\SplFileObject') {
                $content = $response->getBody(); //stream goes to serializer
            } else {
                $content = (string) $response->getBody();
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\RocketChatSettingsApi\Model\GetApiV1ModerationUserReportedMessages200Response',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     * @param  string $x_user_id The user ID. (required)
     * @param  string $x_auth_token The authentication token. (required)
     * @param  \RocketChatSettingsApi\Model\PostApiV1ModerationDismissReportsRequest $post_api_v1_moderation_dismiss_reports_request post_api_v1_moderation_dismiss_reports_request (optional)
     ...
     * @param  string $x_user_id The user ID. (required)
     * @param  string $x_auth_token The authentication token. (required)
     * @param  \RocketChatSettingsApi\Model\PostApiV1ModerationDismissReportsRequest $post_api_v1_moderation_dismiss_reports_request (optional)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['postApiV1ModerationDismissReports'] to see the possible values for this operation
     *
     * @throws \RocketChatSettingsApi\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     ...
     * @param  string $x_user_id The user ID. (required)
     * @param  string $x_auth_token The authentication token. (required)
     * @param  \RocketChatSettingsApi\Model\PostApiV1ModerationUserDeleteReportedMessagesRequest $post_api_v1_moderation_user_delete_reported_messages_request post_api_v1_moderation_user_delete_reported_messages_request (optional)
     ...
     * @param  string $x_user_id The user ID. (required)
     * @param  string $x_auth_token The authentication token. (required)
     * @param  \RocketChatSettingsApi\Model\PostApiV1ModerationUserDeleteReportedMessagesRequest $post_api_v1_moderation_user_delete_reported_messages_request (optional)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['postApiV1ModerationUserDeleteReportedMessages'] to see the possible values for this operation
     *
     * @throws \RocketChatSettingsApi\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
