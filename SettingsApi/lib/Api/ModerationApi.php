...
class ModerationApi
{
     ...
     * @param  string $x_user_id The user ID. (required)
     * @param  string $x_auth_token The authentication token. (required)
     * @param  string|null $oldest It represents the oldest point in time for which you want to retrieve moderation reports. (optional)
     * @param  string|null $latest It represents the oldest point in time for which you want to retrieve moderation reports. (optional)
     * @param  int|null $offset Number of items to \&quot;skip\&quot; in the query, i.e. requests return count items, skipping the first offset items. (optional)
     * @param  int|null $count How many items to return. (optional)
     * @param  mixed|null $sort List of fields to order by, and in which direction. This is a JSON object, with properties listed in desired order, with values of 1 for ascending, or -1 for descending. For example, {\&quot;value\&quot;: -1, \&quot;_id\&quot;: 1} (optional)
     ...
     * @param  string $x_user_id The user ID. (required)
     * @param  string $x_auth_token The authentication token. (required)
     * @param  \WebMI\RocketChatApiClient\SettingsApi\Model\PostApiV1ModerationDismissReportsRequest|null $post_api_v1_moderation_dismiss_reports_request post_api_v1_moderation_dismiss_reports_request (optional)
     ...
     * @param  string $x_user_id The user ID. (required)
     * @param  string $x_auth_token The authentication token. (required)
     * @param  \WebMI\RocketChatApiClient\SettingsApi\Model\PostApiV1ModerationDismissReportsRequest|null $post_api_v1_moderation_dismiss_reports_request (optional)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['postApiV1ModerationDismissReports'] to see the possible values for this operation
     *
     * @throws \WebMI\RocketChatApiClient\SettingsApi\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     ...
     * @param  string $x_user_id The user ID. (required)
     * @param  string $x_auth_token The authentication token. (required)
     * @param  \WebMI\RocketChatApiClient\SettingsApi\Model\PostApiV1ModerationUserDeleteReportedMessagesRequest|null $post_api_v1_moderation_user_delete_reported_messages_request post_api_v1_moderation_user_delete_reported_messages_request (optional)
     ...
     * @param  string $x_user_id The user ID. (required)
     * @param  string $x_auth_token The authentication token. (required)
     * @param  \WebMI\RocketChatApiClient\SettingsApi\Model\PostApiV1ModerationUserDeleteReportedMessagesRequest|null $post_api_v1_moderation_user_delete_reported_messages_request (optional)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['postApiV1ModerationUserDeleteReportedMessages'] to see the possible values for this operation
     *
     * @throws \WebMI\RocketChatApiClient\SettingsApi\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
