...
class CloudApi
{
    ...
    /**
     * Operation postApiV1CloudManualRegister
     *
     ...
     * @param  \WebMI\RocketChatApiClient\SettingsApi\Model\PostApiV1CloudManualRegisterRequest|null $post_api_v1_cloud_manual_register_request post_api_v1_cloud_manual_register_request (optional)
    ...
    {
        list($response) = $this->postApiV1CloudManualRegisterWithHttpInfo($x_user_id, $x_auth_token, $post_api_v1_cloud_manual_register_request, $contentType);
        return $response;
    }

    /**
     * Operation postApiV1CloudManualRegisterWithHttpInfo
     *
     * Manual Cloud Register
     *
     * @param  string $x_user_id The user ID. (required)
     * @param  string $x_auth_token The authentication token. (required)
     * @param  \WebMI\RocketChatApiClient\SettingsApi\Model\PostApiV1CloudManualRegisterRequest|null $post_api_v1_cloud_manual_register_request (optional)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['postApiV1CloudManualRegister'] to see the possible values for this operation
     *
     * @throws \WebMI\RocketChatApiClient\SettingsApi\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
    ...
    /**
     * Operation postApiV1CloudManualRegisterAsync
     *
     * Manual Cloud Register
     *
     * @param  string $x_user_id The user ID. (required)
     ...
     */
    public function postApiV1CloudManualRegisterAsync($x_user_id, $x_auth_token, $post_api_v1_cloud_manual_register_request = null, string $contentType = self::contentTypes['postApiV1CloudManualRegister'][0])
    {
        return $this->postApiV1CloudManualRegisterAsyncWithHttpInfo($x_user_id, $x_auth_token, $post_api_v1_cloud_manual_register_request, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation postApiV1CloudManualRegisterAsyncWithHttpInfo
     *
     * Manual Cloud Register
     *
     * @param  string $x_user_id The user ID. (required)
    ...
    /**
     * Create request for operation 'postApiV1CloudManualRegister'
     *
     * @param  string $x_user_id The user ID. (required)
     * @param  string $x_auth_token The authentication token. (required)
     * @param  \WebMI\RocketChatApiClient\SettingsApi\Model\PostApiV1CloudManualRegisterRequest|null $post_api_v1_cloud_manual_register_request (optional)
     ...
     */
    public function postApiV1CloudManualRegisterRequest($x_user_id, $x_auth_token, $post_api_v1_cloud_manual_register_request = null, string $contentType = self::contentTypes['postApiV1CloudManualRegister'][0])
    {

        // verify the required parameter 'x_user_id' is set
        if ($x_user_id === null || (is_array($x_user_id) && count($x_user_id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $x_user_id when calling postApiV1CloudManualRegister'
            );
        }
        ...
        if ($x_auth_token === null || (is_array($x_auth_token) && count($x_auth_token) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $x_auth_token when calling postApiV1CloudManualRegister'
            );
        }



        $resourcePath = '/api/v1/cloud.manualRegister';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
        ...
        // for model (json/xml)
        if (isset($post_api_v1_cloud_manual_register_request)) {
            if (stripos($headers['Content-Type'], 'application/json') !== false) {
                # if Content-Type contains "application/json", json_encode the body
                $httpBody = \GuzzleHttp\Utils::jsonEncode(ObjectSerializer::sanitizeForSerialization($post_api_v1_cloud_manual_register_request));
            } else {
                $httpBody = $post_api_v1_cloud_manual_register_request;
            }
