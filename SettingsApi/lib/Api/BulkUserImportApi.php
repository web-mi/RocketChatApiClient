...
class BulkUserImportApi
{
     ...
     * @return \RocketChatSettingsApi\Model\GetApiV1ImportStatus200Response|\RocketChatSettingsApi\Model\GetApiV1Settings401Response|\RocketChatSettingsApi\Model\PostApiV1CloudManualRegister400Response
     */
     ...
     * @throws \RocketChatSettingsApi\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array of \RocketChatSettingsApi\Model\GetApiV1ImportStatus200Response|\RocketChatSettingsApi\Model\GetApiV1Settings401Response|\RocketChatSettingsApi\Model\PostApiV1CloudManualRegister400Response, HTTP status code, HTTP response headers (array of strings)
     */
    public function getApiV1ImportStatusWithHttpInfo($x_user_id, $x_auth_token, string $contentType = self::contentTypes['getApiV1ImportStatus'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\RocketChatSettingsApi\Model\GetApiV1ImportStatus200Response' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\RocketChatSettingsApi\Model\GetApiV1ImportStatus200Response' !== 'string') {
                            try {
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\RocketChatSettingsApi\Model\GetApiV1ImportStatus200Response', []),
            ...
            $returnType = '\RocketChatSettingsApi\Model\GetApiV1ImportStatus200Response';
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\RocketChatSettingsApi\Model\GetApiV1ImportStatus200Response',
     ...
     * @throws \RocketChatSettingsApi\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return \RocketChatSettingsApi\Model\PostApiV1ImportNew200Response|\RocketChatSettingsApi\Model\GetApiV1Settings401Response|\RocketChatSettingsApi\Model\PostApiV1CloudManualRegister400Response
     */
     ...
     * @throws \RocketChatSettingsApi\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array of \RocketChatSettingsApi\Model\PostApiV1ImportNew200Response|\RocketChatSettingsApi\Model\GetApiV1Settings401Response|\RocketChatSettingsApi\Model\PostApiV1CloudManualRegister400Response, HTTP status code, HTTP response headers (array of strings)
     */
    public function postApiV1ImportNewWithHttpInfo($x_user_id, $x_auth_token, string $contentType = self::contentTypes['postApiV1ImportNew'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\RocketChatSettingsApi\Model\PostApiV1ImportNew200Response' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\RocketChatSettingsApi\Model\PostApiV1ImportNew200Response' !== 'string') {
                            try {
                                $content = json_decode($content, false, 512, JSON_THROW_ON_ERROR);
                            } catch (\JsonException $exception) {
                                throw new ApiException(
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\RocketChatSettingsApi\Model\PostApiV1ImportNew200Response', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                case 401:
            ...
            $returnType = '\RocketChatSettingsApi\Model\PostApiV1ImportNew200Response';
            if ($returnType === '\SplFileObject') {
                $content = $response->getBody(); //stream goes to serializer
            } else {
                $content = (string) $response->getBody();
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\RocketChatSettingsApi\Model\PostApiV1ImportNew200Response',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
