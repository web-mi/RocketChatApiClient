...
class DNSApi
{
    ...
    /**
     * Operation postApiV1DnsResolveSrv
     *
    ...
    {
        list($response) = $this->postApiV1DnsResolveSrvWithHttpInfo($x_user_id, $x_auth_token, $url, $contentType);
        return $response;
    }

    /**
     * Operation postApiV1DnsResolveSrvWithHttpInfo
     *
     * Resolve DNS URL Records
     *
     * @param  string $x_user_id The user ID. (required)
    ...
    /**
     * Operation postApiV1DnsResolveSrvAsync
     *
     * Resolve DNS URL Records
     *
     * @param  string $x_user_id The user ID. (required)
     ...
     */
    public function postApiV1DnsResolveSrvAsync($x_user_id, $x_auth_token, $url, string $contentType = self::contentTypes['postApiV1DnsResolveSrv'][0])
    {
        return $this->postApiV1DnsResolveSrvAsyncWithHttpInfo($x_user_id, $x_auth_token, $url, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation postApiV1DnsResolveSrvAsyncWithHttpInfo
     *
     * Resolve DNS URL Records
     *
     * @param  string $x_user_id The user ID. (required)
    ...
    /**
     * Create request for operation 'postApiV1DnsResolveSrv'
     *
     * @param  string $x_user_id The user ID. (required)
     * @param  string $x_auth_token The authentication token. (required)
     * @param  string $url The hostname. (required)
     ...
     */
    public function postApiV1DnsResolveSrvRequest($x_user_id, $x_auth_token, $url, string $contentType = self::contentTypes['postApiV1DnsResolveSrv'][0])
    {

        // verify the required parameter 'x_user_id' is set
        if ($x_user_id === null || (is_array($x_user_id) && count($x_user_id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $x_user_id when calling postApiV1DnsResolveSrv'
            );
        }
        ...
        if ($x_auth_token === null || (is_array($x_auth_token) && count($x_auth_token) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $x_auth_token when calling postApiV1DnsResolveSrv'
            );
        }
        ...
        if ($url === null || (is_array($url) && count($url) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $url when calling postApiV1DnsResolveSrv'
            );
        }


        $resourcePath = '/api/v1/dns.resolve.srv';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    /**
     * Operation postApiV1DnsResolveTxt
     *
    ...
    {
        list($response) = $this->postApiV1DnsResolveTxtWithHttpInfo($x_user_id, $x_auth_token, $url, $contentType);
        return $response;
    }

    /**
     * Operation postApiV1DnsResolveTxtWithHttpInfo
     *
     * Resolve DNS Text Records
     *
     * @param  string $x_user_id The user ID. (required)
    ...
    /**
     * Operation postApiV1DnsResolveTxtAsync
     *
     * Resolve DNS Text Records
     *
     * @param  string $x_user_id The user ID. (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function postApiV1DnsResolveTxtAsync($x_user_id, $x_auth_token, $url, string $contentType = self::contentTypes['postApiV1DnsResolveTxt'][0])
    {
        return $this->postApiV1DnsResolveTxtAsyncWithHttpInfo($x_user_id, $x_auth_token, $url, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation postApiV1DnsResolveTxtAsyncWithHttpInfo
     *
     * Resolve DNS Text Records
     *
     * @param  string $x_user_id The user ID. (required)
    ...
    /**
     * Create request for operation 'postApiV1DnsResolveTxt'
     *
     * @param  string $x_user_id The user ID. (required)
     * @param  string $x_auth_token The authentication token. (required)
     * @param  string $url The hostname. (required)
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function postApiV1DnsResolveTxtRequest($x_user_id, $x_auth_token, $url, string $contentType = self::contentTypes['postApiV1DnsResolveTxt'][0])
    {

        // verify the required parameter 'x_user_id' is set
        if ($x_user_id === null || (is_array($x_user_id) && count($x_user_id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $x_user_id when calling postApiV1DnsResolveTxt'
            );
        }
        ...
        if ($x_auth_token === null || (is_array($x_auth_token) && count($x_auth_token) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $x_auth_token when calling postApiV1DnsResolveTxt'
            );
        }
        ...
        if ($url === null || (is_array($url) && count($url) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $url when calling postApiV1DnsResolveTxt'
            );
        }


        $resourcePath = '/api/v1/dns.resolve.txt';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
