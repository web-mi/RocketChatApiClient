<?php
/**
 * PostApiV1FederationAddServerByUserRequest
 *
 * PHP version 7.4
 *
 * @category Class
...
/**
 * PostApiV1FederationAddServerByUserRequest Class Doc Comment
 *
 * @category Class
 * @package  WebMIRocketChatApiClientSettingsApi
 * @author   OpenAPI Generator team
 ...
 */
class PostApiV1FederationAddServerByUserRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'post_api_v1_federation_addServerByUser_request';
    ...
    */
     ...
     * Sets server_name
     *
     * @param string $server_name The public server name.
     *
     * @return self
     */
