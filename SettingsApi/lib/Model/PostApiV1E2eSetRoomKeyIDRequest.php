<?php
/**
 * PostApiV1E2eSetRoomKeyIDRequest
 *
 * PHP version 7.4
 *
 * @category Class
...
/**
 * PostApiV1E2eSetRoomKeyIDRequest Class Doc Comment
 *
 * @category Class
 * @package  WebMI\RocketChatApiClient\SettingsApi
 * @author   OpenAPI Generator team
 ...
 */
class PostApiV1E2eSetRoomKeyIDRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'post_api_v1_e2e_setRoomKeyID_request';
    ...
    */
     ...
     * Sets key_id
     *
     * @param string $key_id The key that you want to set for the room. Enter a unique string.
     *
     * @return self
     */
