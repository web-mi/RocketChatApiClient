<?php
/**
 * PostApiV1StartImportRequestInputChannels
 *
 * PHP version 7.4
 *
 * @category Class
...
/**
 * PostApiV1StartImportRequestInputChannels Class Doc Comment
 *
 * @category Class
 ...
 */
class PostApiV1StartImportRequestInputChannels implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'post_api_v1_startImport_request_input_channels';
    ...
    */
     ...
     * Sets all
     *
     * @param bool|null $all Set to `true` to import all channels.
     *
     * @return self
     */
     ...
     * Sets list
     *
     * @param string[]|null $list When `all` is false, list the record IDs of channels to be imported.
     *
     * @return self
     */
