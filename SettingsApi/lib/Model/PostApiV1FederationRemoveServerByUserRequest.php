<?php
/**
 * PostApiV1FederationRemoveServerByUserRequest
 *
 * PHP version 7.4
 *
 * @category Class
...
/**
 * PostApiV1FederationRemoveServerByUserRequest Class Doc Comment
 *
 * @category Class
 * @package  WebMIRocketChatApiClientSettingsApi
 * @author   OpenAPI Generator team
 ...
 */
class PostApiV1FederationRemoveServerByUserRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'post_api_v1_federation_removeServerByUser_request';
    ...
    */
     ...
     * Sets server_name
     *
     * @param string $server_name The public server name that you want to remove.
     *
     * @return self
     */
