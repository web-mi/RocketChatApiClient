<?php
/**
 * PostApiV1StartImportRequestInputUsers
 *
 * PHP version 7.4
 *
 * @category Class
...
/**
 * PostApiV1StartImportRequestInputUsers Class Doc Comment
 *
 * @category Class
 ...
 */
class PostApiV1StartImportRequestInputUsers implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'post_api_v1_startImport_request_input_users';
    ...
    */
     ...
     * Sets all
     *
     * @param bool|null $all Set to `true` to import all users.
     *
     * @return self
     */
     ...
     * Sets list
     *
     * @param string[]|null $list When `all` is false, list the record IDs of users to be imported.
     *
     * @return self
     */
