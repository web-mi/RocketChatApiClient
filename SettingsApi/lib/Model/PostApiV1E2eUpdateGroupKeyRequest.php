<?php
/**
 * PostApiV1E2eUpdateGroupKeyRequest
 *
 * PHP version 7.4
 *
 * @category Class
...
/**
 * PostApiV1E2eUpdateGroupKeyRequest Class Doc Comment
 *
 * @category Class
 * @package  WebMIRocketChatApiClientSettingsApi
 * @author   OpenAPI Generator team
 ...
 */
class PostApiV1E2eUpdateGroupKeyRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'post_api_v1_e2e_updateGroupKey_request';
    ...
    */
     ...
     * Sets uid
     *
     * @param string $uid The user ID whose key you want to update.
     *
     * @return self
     */
     ...
     * Sets key
     *
     * @param string $key The updated key.
     *
     * @return self
     */
