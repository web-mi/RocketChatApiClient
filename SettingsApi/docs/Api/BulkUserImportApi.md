# RocketChatSettingsApi\BulkUserImportApi
...
```php
getApiV1ImportStatus($x_user_id, $x_auth_token): \RocketChatSettingsApi\Model\GetApiV1ImportStatus200Response
```
...
$apiInstance = new RocketChatSettingsApi\Api\BulkUserImportApi(
...
[**\RocketChatSettingsApi\Model\GetApiV1ImportStatus200Response**](../Model/GetApiV1ImportStatus200Response.md)
...
```php
postApiV1ImportAddUsers($x_user_id, $x_auth_token, $post_api_v1_import_add_users_request): \RocketChatSettingsApi\Model\PostApiV1SettingsAddCustomOAuth200Response
```
...
```php
postApiV1ImportClear($x_user_id, $x_auth_token): \RocketChatSettingsApi\Model\PostApiV1SettingsAddCustomOAuth200Response
```
...
```php
postApiV1ImportNew($x_user_id, $x_auth_token): \RocketChatSettingsApi\Model\PostApiV1ImportNew200Response
```
...
[**\RocketChatSettingsApi\Model\PostApiV1ImportNew200Response**](../Model/PostApiV1ImportNew200Response.md)
...
```php
postApiV1ImportRun($x_user_id, $x_auth_token): \RocketChatSettingsApi\Model\PostApiV1SettingsAddCustomOAuth200Response
```
