# RocketChatSettingsApi\ImportApi
...
```php
getApiV1GetCurrentImportOperation($x_user_id, $x_auth_token): \RocketChatSettingsApi\Model\GetApiV1GetCurrentImportOperation200Response
```
...
$apiInstance = new RocketChatSettingsApi\Api\ImportApi(
...
[**\RocketChatSettingsApi\Model\GetApiV1GetCurrentImportOperation200Response**](../Model/GetApiV1GetCurrentImportOperation200Response.md)
...
```php
getApiV1GetImportFileData($x_user_id, $x_auth_token): \RocketChatSettingsApi\Model\GetApiV1GetImportFileData200Response
```
...
[**\RocketChatSettingsApi\Model\GetApiV1GetImportFileData200Response**](../Model/GetApiV1GetImportFileData200Response.md)
...
```php
getApiV1GetImportProgress($x_user_id, $x_auth_token): \RocketChatSettingsApi\Model\GetApiV1GetImportProgress200Response
```
...
[**\RocketChatSettingsApi\Model\GetApiV1GetImportProgress200Response**](../Model/GetApiV1GetImportProgress200Response.md)
...
```php
getApiV1GetLatestImportOperations($x_user_id, $x_auth_token): \RocketChatSettingsApi\Model\GetApiV1GetLatestImportOperations200ResponseInner[]
```
...
[**\RocketChatSettingsApi\Model\GetApiV1GetLatestImportOperations200ResponseInner[]**](../Model/GetApiV1GetLatestImportOperations200ResponseInner.md)
...
```php
postApiV1DownloadPendingAvatars($x_user_id, $x_auth_token): \RocketChatSettingsApi\Model\PostApiV1DownloadPendingFiles200Response
```
...
[**\RocketChatSettingsApi\Model\PostApiV1DownloadPendingFiles200Response**](../Model/PostApiV1DownloadPendingFiles200Response.md)
...
```php
postApiV1DownloadPendingFiles($x_user_id, $x_auth_token): \RocketChatSettingsApi\Model\PostApiV1DownloadPendingFiles200Response
```
...
```php
postApiV1DownloadPublicImportFile($x_user_id, $x_auth_token, $post_api_v1_download_public_import_file_request): \RocketChatSettingsApi\Model\PostApiV1SettingsAddCustomOAuth200Response
```
...
$x_user_id = CkCPNctrgCDfmWLqC; // string | The user ID.
$x_auth_token = 1Dd4iN_ClKn5jl-xPC36snQ4s9Zd5GZnXCQuCNSKcVE; // string | The authentication token.
$post_api_v1_download_public_import_file_request = {"fileUrl":"https://www.freepik.com/photos/dog","importerKey":"pending-avatars"}; // \RocketChatSettingsApi\Model\PostApiV1DownloadPublicImportFileRequest
...
| **x_user_id** | **string**| The user ID. | |
| **x_auth_token** | **string**| The authentication token. | |
| **post_api_v1_download_public_import_file_request** | [**\RocketChatSettingsApi\Model\PostApiV1DownloadPublicImportFileRequest**](../Model/PostApiV1DownloadPublicImportFileRequest.md)|  | [optional] |
...
```php
postApiV1StartImport($x_user_id, $x_auth_token, $post_api_v1_start_import_request): \RocketChatSettingsApi\Model\PostApiV1SettingsAddCustomOAuth200Response
```
...
$x_user_id = CkCPNctrgCDfmWLqC; // string | The user ID.
$x_auth_token = 1Dd4iN_ClKn5jl-xPC36snQ4s9Zd5GZnXCQuCNSKcVE; // string | The authentication token.
$post_api_v1_start_import_request = {"input":{"users":[{"user_id":"testbh","username":"testbh","email":"testbh@gmail.com","is_deleted":false,"is_bot":false,"do_import":true,"is_email_taken":false}],"channels":[{"channel_id":"WDuJLFkjwk6L7LdFC","name":"dlp","is_archived":false,"do_import":true,"is_private":false,"is_direct":false}]}}; // \RocketChatSettingsApi\Model\PostApiV1StartImportRequest
...
| **x_user_id** | **string**| The user ID. | |
| **x_auth_token** | **string**| The authentication token. | |
| **post_api_v1_start_import_request** | [**\RocketChatSettingsApi\Model\PostApiV1StartImportRequest**](../Model/PostApiV1StartImportRequest.md)|  | [optional] |
...
```php
postApiV1UploadImportFile($x_user_id, $x_auth_token, $post_api_v1_upload_import_file_request): \RocketChatSettingsApi\Model\PostApiV1SettingsAddCustomOAuth200Response
```
...
$x_user_id = CkCPNctrgCDfmWLqC; // string | The user ID.
$x_auth_token = 1Dd4iN_ClKn5jl-xPC36snQ4s9Zd5GZnXCQuCNSKcVE; // string | The authentication token.
$post_api_v1_upload_import_file_request = {"binaryContent":"/testfile.csv","importerKey":"csv","fileName":"Testfile","contentType":"text/csv"}; // \RocketChatSettingsApi\Model\PostApiV1UploadImportFileRequest
...
| **x_user_id** | **string**| The user ID. | |
| **x_auth_token** | **string**| The authentication token. | |
| **post_api_v1_upload_import_file_request** | [**\RocketChatSettingsApi\Model\PostApiV1UploadImportFileRequest**](../Model/PostApiV1UploadImportFileRequest.md)|  | [optional] |
