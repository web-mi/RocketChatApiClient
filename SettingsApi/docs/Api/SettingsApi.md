...
```php
getApiV1SettingsPublic($offset, $count, $sort, $fields, $_id): \WebMI\RocketChatApiClient\SettingsApi\Model\GetApiV1SettingsPublic200Response
```
...
$_id = Site_Url, LDAP_Enable; // string | Filter by the `_id` of the settings.
