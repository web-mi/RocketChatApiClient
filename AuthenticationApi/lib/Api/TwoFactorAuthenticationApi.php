...
class TwoFactorAuthenticationApi
{
     ...
     * @return \RocketChatAuthenticationApi\Model\PostApiV1Users2faEnableEmail200Response|\RocketChatAuthenticationApi\Model\PostApiV1Users2faDisableEmail400Response
     */
     ...
     * @throws \RocketChatAuthenticationApi\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array of \RocketChatAuthenticationApi\Model\PostApiV1Users2faEnableEmail200Response|\RocketChatAuthenticationApi\Model\PostApiV1Users2faDisableEmail400Response, HTTP status code, HTTP response headers (array of strings)
     */
    public function postApiV1Users2faDisableEmailWithHttpInfo($x_auth_token, $x_user_id, $x_2fa_code, $x_2fa_method, string $contentType = self::contentTypes['postApiV1Users2faDisableEmail'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\RocketChatAuthenticationApi\Model\PostApiV1Users2faEnableEmail200Response' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\RocketChatAuthenticationApi\Model\PostApiV1Users2faEnableEmail200Response' !== 'string') {
                            try {
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\RocketChatAuthenticationApi\Model\PostApiV1Users2faEnableEmail200Response', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                case 400:
                    if ('\RocketChatAuthenticationApi\Model\PostApiV1Users2faDisableEmail400Response' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\RocketChatAuthenticationApi\Model\PostApiV1Users2faDisableEmail400Response' !== 'string') {
                            try {
                                $content = json_decode($content, false, 512, JSON_THROW_ON_ERROR);
                            } catch (\JsonException $exception) {
                                throw new ApiException(
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\RocketChatAuthenticationApi\Model\PostApiV1Users2faDisableEmail400Response', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
            }

            $returnType = '\RocketChatAuthenticationApi\Model\PostApiV1Users2faEnableEmail200Response';
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\RocketChatAuthenticationApi\Model\PostApiV1Users2faEnableEmail200Response',
                ...
                case 400:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\RocketChatAuthenticationApi\Model\PostApiV1Users2faDisableEmail400Response',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     * @throws \RocketChatAuthenticationApi\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return \RocketChatAuthenticationApi\Model\PostApiV1Users2faEnableEmail200Response|\RocketChatAuthenticationApi\Model\PostApiV1Users2faEnableEmail401Response
     */
     ...
     * @throws \RocketChatAuthenticationApi\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array of \RocketChatAuthenticationApi\Model\PostApiV1Users2faEnableEmail200Response|\RocketChatAuthenticationApi\Model\PostApiV1Users2faEnableEmail401Response, HTTP status code, HTTP response headers (array of strings)
     */
    public function postApiV1Users2faEnableEmailWithHttpInfo($x_auth_token, $x_user_id, string $contentType = self::contentTypes['postApiV1Users2faEnableEmail'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                ...
                case 401:
                    if ('\RocketChatAuthenticationApi\Model\PostApiV1Users2faEnableEmail401Response' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\RocketChatAuthenticationApi\Model\PostApiV1Users2faEnableEmail401Response' !== 'string') {
                            try {
                                $content = json_decode($content, false, 512, JSON_THROW_ON_ERROR);
                            } catch (\JsonException $exception) {
                                throw new ApiException(
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\RocketChatAuthenticationApi\Model\PostApiV1Users2faEnableEmail401Response', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
            }
            ...
            switch ($e->getCode()) {
                ...
                case 401:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\RocketChatAuthenticationApi\Model\PostApiV1Users2faEnableEmail401Response',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     *
     * @param  \RocketChatAuthenticationApi\Model\PostApiV1Users2faSendEmailCodeRequest $post_api_v1_users2fa_send_email_code_request post_api_v1_users2fa_send_email_code_request (optional)
     ...
     * @throws \RocketChatAuthenticationApi\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return \RocketChatAuthenticationApi\Model\PostApiV1Users2faEnableEmail200Response|\RocketChatAuthenticationApi\Model\PostApiV1Users2faSendEmailCode400Response
     */
    ...
    {
        list($response) = $this->postApiV1Users2faSendEmailCodeWithHttpInfo($post_api_v1_users2fa_send_email_code_request, $contentType);
        return $response;
    }
     ...
     * Request a new Email Code
     *
     * @param  \RocketChatAuthenticationApi\Model\PostApiV1Users2faSendEmailCodeRequest $post_api_v1_users2fa_send_email_code_request (optional)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['postApiV1Users2faSendEmailCode'] to see the possible values for this operation
     *
     * @throws \RocketChatAuthenticationApi\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array of \RocketChatAuthenticationApi\Model\PostApiV1Users2faEnableEmail200Response|\RocketChatAuthenticationApi\Model\PostApiV1Users2faSendEmailCode400Response, HTTP status code, HTTP response headers (array of strings)
     */
    public function postApiV1Users2faSendEmailCodeWithHttpInfo($post_api_v1_users2fa_send_email_code_request = null, string $contentType = self::contentTypes['postApiV1Users2faSendEmailCode'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                ...
                case 400:
                    if ('\RocketChatAuthenticationApi\Model\PostApiV1Users2faSendEmailCode400Response' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\RocketChatAuthenticationApi\Model\PostApiV1Users2faSendEmailCode400Response' !== 'string') {
                            try {
                                $content = json_decode($content, false, 512, JSON_THROW_ON_ERROR);
                            } catch (\JsonException $exception) {
                                throw new ApiException(
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\RocketChatAuthenticationApi\Model\PostApiV1Users2faSendEmailCode400Response', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
            }
            ...
            switch ($e->getCode()) {
                ...
                case 400:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\RocketChatAuthenticationApi\Model\PostApiV1Users2faSendEmailCode400Response',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function postApiV1Users2faSendEmailCodeAsync($post_api_v1_users2fa_send_email_code_request = null, string $contentType = self::contentTypes['postApiV1Users2faSendEmailCode'][0])
    {
        return $this->postApiV1Users2faSendEmailCodeAsyncWithHttpInfo($post_api_v1_users2fa_send_email_code_request, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function postApiV1Users2faSendEmailCodeRequest($post_api_v1_users2fa_send_email_code_request = null, string $contentType = self::contentTypes['postApiV1Users2faSendEmailCode'][0])
    {
