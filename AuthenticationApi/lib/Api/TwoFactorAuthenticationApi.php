...
class TwoFactorAuthenticationApi
{
     ...
     *
     * @param  \WebMI\RocketChatApiClient\AuthenticationApi\Model\PostApiV1Users2faSendEmailCodeRequest|null $post_api_v1_users2fa_send_email_code_request post_api_v1_users2fa_send_email_code_request (optional)
     ...
     * Request a new Email Code
     *
     * @param  \WebMI\RocketChatApiClient\AuthenticationApi\Model\PostApiV1Users2faSendEmailCodeRequest|null $post_api_v1_users2fa_send_email_code_request (optional)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['postApiV1Users2faSendEmailCode'] to see the possible values for this operation
     *
     * @throws \WebMI\RocketChatApiClient\AuthenticationApi\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
