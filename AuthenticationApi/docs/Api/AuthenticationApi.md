# RocketChatAuthenticationApi\AuthenticationApi
...
```php
getApiV1Me($x_user_id, $x_auth_token): \RocketChatAuthenticationApi\Model\GetApiV1Me200Response
```
...
[**\RocketChatAuthenticationApi\Model\GetApiV1Me200Response**](../Model/GetApiV1Me200Response.md)
...
```php
postApiV1Login($post_api_v1_login_request): \RocketChatAuthenticationApi\Model\PostApiV1Login200Response
```
...
$post_api_v1_login_request = {"user":"test@rocket.test","password":"vanvica32"}; // \RocketChatAuthenticationApi\Model\PostApiV1LoginRequest | 
...
| Name | Type | Description  | Notes |
| ------------- | ------------- | ------------- | ------------- |
| **post_api_v1_login_request** | [**\RocketChatAuthenticationApi\Model\PostApiV1LoginRequest**](../Model/PostApiV1LoginRequest.md)|  | [optional] |

### Return type

[**\RocketChatAuthenticationApi\Model\PostApiV1Login200Response**](../Model/PostApiV1Login200Response.md)
...
```php
postApiV1LoginFacebook($post_api_v1_login_facebook_request): \RocketChatAuthenticationApi\Model\PostApiV1Login200Response
```
...
$post_api_v1_login_facebook_request = {"serviceName":"facebook","accessToken":"hash","secret":"hash","expiresIn":200}; // \RocketChatAuthenticationApi\Model\PostApiV1LoginFacebookRequest | 
...
| Name | Type | Description  | Notes |
| ------------- | ------------- | ------------- | ------------- |
| **post_api_v1_login_facebook_request** | [**\RocketChatAuthenticationApi\Model\PostApiV1LoginFacebookRequest**](../Model/PostApiV1LoginFacebookRequest.md)|  | [optional] |
...
```php
postApiV1LoginGoogle($post_api_v1_login_google_request): \RocketChatAuthenticationApi\Model\PostApiV1LoginGoogle200Response
```
...
$post_api_v1_login_google_request = {"serviceName":"google","accessToken":"hash","idToken":"hash","expiresIn":200,"scope":"profile"}; // \RocketChatAuthenticationApi\Model\PostApiV1LoginGoogleRequest | 
...
| Name | Type | Description  | Notes |
| ------------- | ------------- | ------------- | ------------- |
| **post_api_v1_login_google_request** | [**\RocketChatAuthenticationApi\Model\PostApiV1LoginGoogleRequest**](../Model/PostApiV1LoginGoogleRequest.md)|  | [optional] |

### Return type

[**\RocketChatAuthenticationApi\Model\PostApiV1LoginGoogle200Response**](../Model/PostApiV1LoginGoogle200Response.md)
...
```php
postApiV1LoginTwitter($post_api_v1_login_twitter_request): \RocketChatAuthenticationApi\Model\PostApiV1Login200Response
```
...
$post_api_v1_login_twitter_request = {"serviceName":"twitter","accessToken":"hash","accessTokenSecret":"hash","appSecret":"hash","appId":"hash","expiresIn":200}; // \RocketChatAuthenticationApi\Model\PostApiV1LoginTwitterRequest | 
...
| Name | Type | Description  | Notes |
| ------------- | ------------- | ------------- | ------------- |
| **post_api_v1_login_twitter_request** | [**\RocketChatAuthenticationApi\Model\PostApiV1LoginTwitterRequest**](../Model/PostApiV1LoginTwitterRequest.md)|  | [optional] |
...
```php
postApiV1Logout($x_auth_token, $x_user_id): \RocketChatAuthenticationApi\Model\PostApiV1Logout200Response
```
...
[**\RocketChatAuthenticationApi\Model\PostApiV1Logout200Response**](../Model/PostApiV1Logout200Response.md)
